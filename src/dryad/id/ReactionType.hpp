...
namespace id {
  ...
  class ReactionType {
    ...
    static inline std::vector< Entry > entries{
      ...
      Entry{       1515, 515, InteractionType::Atomic , "2e-e+[electron]", { "pair-production-electron", "2e-e+", "2e-,e+" }, { { ParticleID::electron(), 2 }, { ParticleID::positron(), 1 } } },
      Entry{       1517, 517, InteractionType::Atomic , "e-e+[nuclear]"  , { "pair-production-nuclear", "e-e+", "e-,e+" }  , { { ParticleID::electron(), 1 }, { ParticleID::positron(), 1 } } },
