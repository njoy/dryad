...
//        CHECK_THAT( 2., WithinRel( chunk.cosines()[2] ) );
//        CHECK_THAT( 3., WithinRel( chunk.cosines()[3] ) );
//        CHECK_THAT( 4., WithinRel( chunk.cosines()[4] ) );
...
//        CHECK_THAT( 2., WithinRel( result.cosines()[2] ) );
//        CHECK_THAT( 3., WithinRel( result.cosines()[3] ) );
//        CHECK_THAT( 4., WithinRel( result.cosines()[4] ) );
...
//    WHEN( "the data is given explicitly" ) {
//
//      const std::vector< double > cosines = { 1., 2., 2., 3., 4. };
...
//        TabulatedAngularDistribution nonzerothreshold( { 3., 4. }, { 1., 2. } );
...
//        CHECK_THAT( 2., WithinRel( chunk.cosines()[2] ) );
//        CHECK_THAT( 3., WithinRel( chunk.cosines()[3] ) );
//        CHECK_THAT( 3., WithinRel( chunk.cosines()[4] ) );
//        CHECK_THAT( 4., WithinRel( chunk.cosines()[5] ) );
//        CHECK_THAT( 4., WithinRel( chunk.values()[0] ) );
//        CHECK_THAT( 3., WithinRel( chunk.values()[1] ) );
//        CHECK_THAT( 4., WithinRel( chunk.values()[2] ) );
//        CHECK_THAT( 3., WithinRel( chunk.values()[3] ) );
...
//        CHECK_THAT( 2., WithinRel( result.cosines()[2] ) );
//        CHECK_THAT( 3., WithinRel( result.cosines()[3] ) );
//        CHECK_THAT( 3., WithinRel( result.cosines()[4] ) );
//        CHECK_THAT( 4., WithinRel( result.cosines()[5] ) );
//        CHECK_THAT( 4., WithinRel( result.values()[0] ) );
//        CHECK_THAT( 3., WithinRel( result.values()[1] ) );
//        CHECK_THAT( 4., WithinRel( result.values()[2] ) );
//        CHECK_THAT( 3., WithinRel( result.values()[3] ) );
...
//        CHECK_THAT( 2., WithinRel( linear.cosines()[2] ) );
//        CHECK_THAT( 3., WithinRel( linear.cosines()[3] ) );
//        CHECK_THAT( 4., WithinRel( linear.cosines()[4] ) );
//
...
//    WHEN( "the data is given explicitly" ) {
//
//      const std::vector< double > cosines = { 1., 2., 3., 4. };
...
//        CHECK_THAT( 1.   , WithinRel( linear.cosines()[0] ) );
//        CHECK_THAT( 2.   , WithinRel( linear.cosines()[1] ) );
//        CHECK_THAT( 2.125, WithinRel( linear.cosines()[2] ) );
//        CHECK_THAT( 2.25 , WithinRel( linear.cosines()[3] ) );
//        CHECK_THAT( 2.375, WithinRel( linear.cosines()[4] ) );
//        CHECK_THAT( 2.5  , WithinRel( linear.cosines()[5] ) );
//        CHECK_THAT( 2.625, WithinRel( linear.cosines()[6] ) );
//        CHECK_THAT( 2.75 , WithinRel( linear.cosines()[7] ) );
//        CHECK_THAT( 2.875, WithinRel( linear.cosines()[8] ) );
//        CHECK_THAT( 3.   , WithinRel( linear.cosines()[9] ) );
//        CHECK_THAT( 3.125, WithinRel( linear.cosines()[10] ) );
//        CHECK_THAT( 3.25 , WithinRel( linear.cosines()[11] ) );
//        CHECK_THAT( 3.375, WithinRel( linear.cosines()[12] ) );
//        CHECK_THAT( 3.5  , WithinRel( linear.cosines()[13] ) );
//        CHECK_THAT( 3.625, WithinRel( linear.cosines()[14] ) );
//        CHECK_THAT( 3.75 , WithinRel( linear.cosines()[15] ) );
//        CHECK_THAT( 3.875, WithinRel( linear.cosines()[16] ) );
//        CHECK_THAT( 4.   , WithinRel( linear.cosines()[17] ) );
//
//        CHECK_THAT( 4.              , WithinRel( linear.values()[0] ) );
//        CHECK_THAT( 3.              , WithinRel( linear.values()[1] ) );
...
//        CHECK_THAT( 2.   , WithinRel( linear.cosines()[1] ) );
//        CHECK_THAT( 2.   , WithinRel( linear.cosines()[2] ) );
//        CHECK_THAT( 2.125, WithinRel( linear.cosines()[3] ) );
//        CHECK_THAT( 2.25 , WithinRel( linear.cosines()[4] ) );
//        CHECK_THAT( 2.5  , WithinRel( linear.cosines()[5] ) );
//        CHECK_THAT( 2.75 , WithinRel( linear.cosines()[6] ) );
//        CHECK_THAT( 3.   , WithinRel( linear.cosines()[7] ) );
//        CHECK_THAT( 3.25 , WithinRel( linear.cosines()[8] ) );
//        CHECK_THAT( 3.5  , WithinRel( linear.cosines()[9] ) );
//        CHECK_THAT( 3.75 , WithinRel( linear.cosines()[10] ) );
//        CHECK_THAT( 4.   , WithinRel( linear.cosines()[11] ) );
//
//        CHECK_THAT( 4.              , WithinRel( linear.values()[0] ) );
//        CHECK_THAT( 3.              , WithinRel( linear.values()[1] ) );
//        CHECK_THAT( 4.              , WithinRel( linear.values()[2] ) );
...
//        CHECK_THAT( 2., WithinRel( chunk.cosines()[1] ) );
//        CHECK_THAT( 3., WithinRel( chunk.cosines()[2] ) );
//        CHECK_THAT( 4., WithinRel( chunk.cosines()[3] ) ); // <-- last point removed
//        CHECK_THAT( 4., WithinRel( chunk.values()[0] ) );
//        CHECK_THAT( 3., WithinRel( chunk.values()[1] ) );
//        CHECK_THAT( 2., WithinRel( chunk.values()[2] ) );
