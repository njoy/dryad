...
void verifyElectronTotalReaction( const Reaction& );
void verifyElectronTotalIonisationReaction( const Reaction& );
void verifyElectronElasticReaction( const Reaction& );
void verifyElectronTotalElasticReaction( const Reaction& );
void verifyElectronBremsstrahlungReaction( const Reaction& );
void verifyElectronExcitationReaction( const Reaction& );
void verifyElectronSubshellIonisationReaction( const Reaction& );
