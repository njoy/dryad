...
namespace endf {
  ...
  class ReactionInformation {
    ...
    inline static const std::unordered_set< int > derived_ = {
      ...
      201, 202, 203, 204, 205, 206, 207, 208, 209, 210, // production
      211, 212, 213, 214, 215, 216, 217, 218,
      251, 252, 253,                                    // mubar, etc.
      301, 302, 303, 304, 305, 306, 307, 308, 309, 310, // kerma mt numbers
    ...
    inline static const std::map< int, std::vector< int > > partials_ = {
      ...
      {  16, { 875, 876, 877, 878, 879, 880, 881, 882, 883, 884,
               885, 886, 887, 888, 889, 890, 891 } },
      {  18, {  19,  20,  21,  38 } },
      {  27, {  18, 102, 103, 104, 107, 108, 109, 110, 111, 112,
               113, 114, 115, 116, 117, 155, 182, 191, 192, 193,
               197 } },
  ...
  public:
    ...
    -> std::enable_if_t< ( std::is_same_v< Material, ENDFtk::tree::Material > ||
      ...
      if ( mf == 3 && mt == 1 ) {
        ...
        for ( auto number : partials_.at( mt ) ) {
