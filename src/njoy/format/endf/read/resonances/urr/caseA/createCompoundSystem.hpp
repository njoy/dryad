#ifndef NJOY_FORMAT_ENDF_READ_RESONANCES_URR_CASEA_CREATECOMPOUNDSYSTEM
#define NJOY_FORMAT_ENDF_READ_RESONANCES_URR_CASEA_CREATECOMPOUNDSYSTEM
...
#include "njoy/format/endf/read/resonances/urr/caseA/createSpinGroups.hpp"
...
namespace caseA {
  ...
  /**
   *  @brief Create the unresolved compound system for energy-independent
   *         unresolved resonance parameters (Case A)
   *
  ...
  inline auto createCompoundSystem( const dryad::id::ParticleID& projectile,
                                    ...
                                    const ENDFtk::section::Type< 2, 151 >::UnresolvedEnergyIndependent& endf ) {

    auto groups = caseA::createSpinGroups( projectile, target, naps, nro, lower, upper, endf );
