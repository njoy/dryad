#ifndef NJOY_FORMAT_ACE_WRITE_ELECTROATOMIC_CREATEACEIONISATIONDISTRIBUTIONBLOCKS
#define NJOY_FORMAT_ACE_WRITE_ELECTROATOMIC_CREATEACEIONISATIONDISTRIBUTIONBLOCKS
