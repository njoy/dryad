#ifndef NJOY_FORMAT_ACE_WRITE_ELECTROATOMIC_CREATEPRINCIPALCROSSSECTIONBLOCK
#define NJOY_FORMAT_ACE_WRITE_ELECTROATOMIC_CREATEPRINCIPALCROSSSECTIONBLOCK
