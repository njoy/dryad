#ifndef NJOY_FORMAT_ACE_WRITE_ELECTROATOMIC_CREATEELASTICANGULARDISTRIBUTIONBLOCK
#define NJOY_FORMAT_ACE_WRITE_ELECTROATOMIC_CREATEELASTICANGULARDISTRIBUTIONBLOCK
