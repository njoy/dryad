#ifndef NJOY_FORMAT_ACE_WRITE_PHOTOATOMIC_CREATEINCOHERENTSCATTERINGFUNCTIONBLOCK
#define NJOY_FORMAT_ACE_WRITE_PHOTOATOMIC_CREATEINCOHERENTSCATTERINGFUNCTIONBLOCK
