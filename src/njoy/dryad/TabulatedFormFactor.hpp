...
namespace dryad {
  ...
  public:
    ...
    #include "njoy/dryad/TabulatedFormFactor/src/ctor.hpp"
     ...
     */
    TabulatedFormFactor linearise( double tolerance = constants::linearisation::tolerance ) const {
      ...
      return TabulatedFormFactor( std::move( table ) );
    }
