#ifndef NJOY_DRYAD_ATOMIC_NONRADIATIVETRANSITIONDATA
#define NJOY_DRYAD_ATOMIC_NONRADIATIVETRANSITIONDATA
...
namespace atomic {
  ...
  public:
     ...
     *         emitted electron originated
     *
     *  @param[in] emittingShell   the identifier of the subshell from which the
     *                             emitted electron originated
     */
