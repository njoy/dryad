...
namespace dryad {
  ...
  public:
    ...
    #include "njoy/dryad/TabulatedAverageCosine/src/ctor.hpp"
    ...
    /**
     *  @brief Return a linearised average cosine table
     *
     *  @param[in] tolerance   the linearisation tolerance (default: 0.1 %)
     */
    TabulatedAverageCosine linearise( double tolerance = constants::linearisation::tolerance ) const {
      ...
      return TabulatedAverageCosine( std::move( table ) );
    }
