...
class Test_dryad_TabulatedAngularDistributions( unittest.TestCase ) :
    ...
    def test_component( self ) :
        ...
        def verify_chunk( self, chunk ) :
            ...
            self.assertIsNone( chunk.distributions[0].cdf )
            self.assertIsNone( chunk.distributions[1].cdf )
            self.assertIsNone( chunk.distributions[2].cdf )
            self.assertIsNone( chunk.distributions[3].cdf )
