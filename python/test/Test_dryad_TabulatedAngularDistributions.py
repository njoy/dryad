...
class Test_dryad_TabulatedAngularDistribution( unittest.TestCase ) :
    ...
    def test_component( self ) :
        ...
        def verify_chunk( self, chunk ) :
            ...
            self.assertEqual( 2, len( chunk.distributions[0].cosines ) )
            self.assertEqual( 2, len( chunk.distributions[0].values ) )
            self.assertEqual( 3, len( chunk.distributions[1].cosines ) )
            self.assertEqual( 3, len( chunk.distributions[1].values ) )
            self.assertEqual( 3, len( chunk.distributions[2].cosines ) )
            self.assertEqual( 3, len( chunk.distributions[2].values ) )
            self.assertEqual( 2, len( chunk.distributions[3].cosines ) )
            self.assertEqual( 2, len( chunk.distributions[3].values ) )
            self.assertAlmostEqual( -1.  , chunk.distributions[0].cosines[0] )
            self.assertAlmostEqual(  1.  , chunk.distributions[0].cosines[1] )
            self.assertAlmostEqual(  0.5 , chunk.distributions[0].values[0] )
            self.assertAlmostEqual(  0.5 , chunk.distributions[0].values[1] )
            self.assertAlmostEqual( -1.  , chunk.distributions[1].cosines[0] )
            self.assertAlmostEqual(  0.  , chunk.distributions[1].cosines[1] )
            self.assertAlmostEqual(  1.  , chunk.distributions[1].cosines[2] )
            ...
            self.assertAlmostEqual( -1.  , chunk.distributions[2].cosines[0] )
            self.assertAlmostEqual(  0.  , chunk.distributions[2].cosines[1] )
            self.assertAlmostEqual(  1.  , chunk.distributions[2].cosines[2] )
            ...
            self.assertAlmostEqual(  1.  , chunk.distributions[3].cosines[1] )
