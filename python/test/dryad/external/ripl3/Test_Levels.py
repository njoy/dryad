...
class Test_Levels( unittest.TestCase ) :
    ...
    def test_predefined_particles( self ) :
        ...
        if os.getenv( 'NJOY_DATAPATH' ) != None :

            data = Levels.level( ParticleID( 'H1' ) )
            ...
            data = Levels.level( ParticleID( 'He4' ) )
            ...
            data = Levels.level( ParticleID( 'Li6' ) )
            ...
            data = Levels.level( ParticleID( 'Be9' ) )
            ...
            data = Levels.level( ParticleID( 'B10' ) )
            ...
            data = Levels.level( ParticleID( 'C12' ) )
            ...
            data = Levels.level( ParticleID( 'N14' ) )
            ...
            data = Levels.level( ParticleID( 'O16' ) )
