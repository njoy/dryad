...
class Test_MultigroupCrossSection( unittest.TestCase ) :
    """Unit test for the MultigroupCrossSection class."""
    ...
    def test_component( self ) :
        ...
        def verify_chunk( self, chunk ) :
            ...
            result = MultigroupCrossSection( [ 1., 5. ], [ 0. ] )
            other = MultigroupCrossSection( [ 1., 2., 3., 4., 5. ], [ 1., 2., 3., 4. ] );
            different = MultigroupCrossSection( [ 1., 2., 3., 4. ], [ 1., 2., 3. ] );
        ...
        chunk = MultigroupCrossSection( boundaries = [ 1., 2., 3., 4., 5. ],
                                        values = [ 4., 3., 2., 1. ] )
    ...
    def test_comparison( self ) :
        ...
        left = MultigroupCrossSection( [ 1., 2., 3., 4., 5. ], [ 4., 3., 2., 1. ] )
        equal = MultigroupCrossSection( [ 1., 2., 3., 4., 5. ], [ 4., 3., 2., 1. ] )
        different = MultigroupCrossSection( [ 1., 4. ], [ 4. ] )
    ...
    def test_failures( self ) :
        ...
        with self.assertRaises( Exception ) :
            ...
            chunk = MultigroupCrossSection( boundaries = [ 1. ], values = [] )

        # the boundaries or values do not have the current number of values
        with self.assertRaises( Exception ) :

            chunk = MultigroupCrossSection( boundaries = [ 1., 2., 3., 4. ],
                                            values = [ 4., 3. ] )

        # the boundaries are not sorted
        with self.assertRaises( Exception ) :

            chunk = MultigroupCrossSection( boundaries = [ 1., 3., 2., 4. ],
                                            values = [ 4., 3., 2. ] )

        # the boundaries are not unique
        with self.assertRaises( Exception ) :

            chunk = MultigroupCrossSection( boundaries = [ 1., 3., 3., 4. ],
                                            values = [ 4., 3., 2. ] )
