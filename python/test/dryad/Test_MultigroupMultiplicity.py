...
class Test_MultigroupMultiplicity( unittest.TestCase ) :
    """Unit test for the MultigroupMultiplicity class."""
    ...
    def test_component( self ) :
        ...
        def verify_chunk( self, chunk ) :
            ...
            result = MultigroupMultiplicity( [ 1., 5. ], [ 0. ] )
            other = MultigroupMultiplicity( [ 1., 2., 3., 4., 5. ], [ 1., 2., 3., 4. ] );
            different = MultigroupMultiplicity( [ 1., 2., 3., 4. ], [ 1., 2., 3. ] );
        ...
        chunk = MultigroupMultiplicity( boundaries = [ 1., 2., 3., 4., 5. ],
                                        values = [ 4., 3., 2., 1. ] )
    ...
    def test_comparison( self ) :
        ...
        left = MultigroupMultiplicity( [ 1., 2., 3., 4., 5. ], [ 4., 3., 2., 1. ] )
        equal = MultigroupMultiplicity( [ 1., 2., 3., 4., 5. ], [ 4., 3., 2., 1. ] )
        different = MultigroupMultiplicity( [ 1., 4. ], [ 4. ] )
    ...
    def test_failures( self ) :
        ...
        with self.assertRaises( Exception ) :
            ...
            chunk = MultigroupMultiplicity( boundaries = [ 1. ], values = [] )

        # the boundaries or values do not have the current number of values
        with self.assertRaises( Exception ) :

            chunk = MultigroupMultiplicity( boundaries = [ 1., 2., 3., 4. ],
                                            values = [ 4., 3. ] )

        # the boundaries are not sorted
        with self.assertRaises( Exception ) :

            chunk = MultigroupMultiplicity( boundaries = [ 1., 3., 2., 4. ],
                                            values = [ 4., 3., 2. ] )

        # the boundaries are not unique
        with self.assertRaises( Exception ) :

            chunk = MultigroupMultiplicity( boundaries = [ 1., 3., 3., 4. ],
                                            values = [ 4., 3., 2. ] )
