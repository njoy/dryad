...
class Test_ProductMultiplicityCovarianceMatrix( unittest.TestCase ) :
    ...
    def test_matrix( self ) :
        ...
        self.assertAlmostEqual(  7.93360907096512e-06, chunk.eigenvalues[0] )
        self.assertAlmostEqual(  2.77607998044769e-06, chunk.eigenvalues[1] )
        self.assertAlmostEqual(  8.72998692347036e-07, chunk.eigenvalues[2] )
        self.assertAlmostEqual(  5.09348096171567e-07, chunk.eigenvalues[3] )
        self.assertAlmostEqual(  1.08751047007600e-07, chunk.eigenvalues[4] )
        self.assertAlmostEqual(  3.31256655183549e-09, chunk.eigenvalues[5] )
        self.assertAlmostEqual(  3.43367202411662e-10, chunk.eigenvalues[6] )
        self.assertAlmostEqual( -2.39076849693257e-07, chunk.eigenvalues[7] )

        self.assertAlmostEqual(  1.074034990154796e-01, chunk.eigenvectors[0][0] )
        self.assertAlmostEqual(  5.031741433412550e-02, chunk.eigenvectors[0][1] )
        self.assertAlmostEqual(  6.760345784347225e-01, chunk.eigenvectors[0][2] )
        self.assertAlmostEqual(  1.915401875474548e-04, chunk.eigenvectors[0][3] )
        self.assertAlmostEqual(  1.372508574710749e-01, chunk.eigenvectors[0][4] )
        self.assertAlmostEqual(  1.393826996793074e-01, chunk.eigenvectors[0][5] )
        self.assertAlmostEqual(  7.004601426407556e-01, chunk.eigenvectors[0][6] )
        self.assertAlmostEqual( -3.346821750524192e-04, chunk.eigenvectors[0][7] )
        self.assertAlmostEqual( -2.571527009424175e-01, chunk.eigenvectors[1][0] )
        self.assertAlmostEqual( -5.332339693289101e-01, chunk.eigenvectors[1][1] )
        self.assertAlmostEqual( -4.136479111214138e-01, chunk.eigenvectors[1][2] )
        self.assertAlmostEqual(  1.106338368001530e-03, chunk.eigenvectors[1][3] )
        self.assertAlmostEqual( -1.004221706751696e-01, chunk.eigenvectors[1][4] )
        self.assertAlmostEqual( -3.764142026504751e-01, chunk.eigenvectors[1][5] )
        self.assertAlmostEqual(  5.715373399614007e-01, chunk.eigenvectors[1][6] )
        self.assertAlmostEqual(  1.004341476548398e-03, chunk.eigenvectors[1][7] )
        self.assertAlmostEqual(  1.371275274983361e-01, chunk.eigenvectors[2][0] )
        self.assertAlmostEqual( -8.140382248203513e-01, chunk.eigenvectors[2][1] )
        self.assertAlmostEqual(  2.691481835902044e-01, chunk.eigenvectors[2][2] )
        self.assertAlmostEqual( -3.231353088691460e-03, chunk.eigenvectors[2][3] )
        self.assertAlmostEqual(  3.273381875688864e-01, chunk.eigenvectors[2][4] )
        self.assertAlmostEqual(  1.854210583626488e-01, chunk.eigenvectors[2][5] )
        self.assertAlmostEqual( -3.233486103311739e-01, chunk.eigenvectors[2][6] )
        self.assertAlmostEqual( -1.020603999800658e-03, chunk.eigenvectors[2][7] )
        self.assertAlmostEqual( -4.574278897433420e-01, chunk.eigenvectors[3][0] )
        self.assertAlmostEqual( -3.768700535852441e-02, chunk.eigenvectors[3][1] )
        self.assertAlmostEqual( -2.313850741112828e-01, chunk.eigenvectors[3][2] )
        self.assertAlmostEqual(  9.976800706566397e-03, chunk.eigenvectors[3][3] )
        self.assertAlmostEqual( -5.343662614796370e-02, chunk.eigenvectors[3][4] )
        self.assertAlmostEqual(  8.447798233267908e-01, chunk.eigenvectors[3][5] )
        self.assertAlmostEqual(  1.385291026888882e-01, chunk.eigenvectors[3][6] )
        self.assertAlmostEqual( -1.446040223355744e-03, chunk.eigenvectors[3][7] )
        self.assertAlmostEqual( -5.439389015604769e-01, chunk.eigenvectors[4][0] )
        self.assertAlmostEqual(  1.996774457251580e-01, chunk.eigenvectors[4][1] )
        self.assertAlmostEqual(  1.639440644799666e-02, chunk.eigenvectors[4][2] )
        self.assertAlmostEqual( -5.814555639788057e-03, chunk.eigenvectors[4][3] )
        self.assertAlmostEqual(  7.818950572395391e-01, chunk.eigenvectors[4][4] )
        self.assertAlmostEqual( -2.224672713971068e-01, chunk.eigenvectors[4][5] )
        self.assertAlmostEqual( -5.569982161307497e-02, chunk.eigenvectors[4][6] )
        self.assertAlmostEqual(  1.663102992474408e-03, chunk.eigenvectors[4][7] )
        self.assertAlmostEqual( -1.752926246655574e-04, chunk.eigenvectors[5][0] )
        self.assertAlmostEqual(  8.279317505192949e-04, chunk.eigenvectors[5][1] )
        self.assertAlmostEqual( -1.518618778550783e-03, chunk.eigenvectors[5][2] )
        self.assertAlmostEqual( -1.096637382643716e-01, chunk.eigenvectors[5][3] )
        self.assertAlmostEqual(  7.862304135582416e-04, chunk.eigenvectors[5][4] )
        self.assertAlmostEqual( -9.998834737042516e-04, chunk.eigenvectors[5][5] )
        self.assertAlmostEqual(  1.033041611015811e-03, chunk.eigenvectors[5][6] )
        self.assertAlmostEqual( -9.939658731607474e-01, chunk.eigenvectors[5][7] )
        self.assertAlmostEqual(  1.322444642228740e-02, chunk.eigenvectors[6][0] )
        self.assertAlmostEqual(  1.263506076818510e-03, chunk.eigenvectors[6][1] )
        self.assertAlmostEqual( -5.277719337954416e-03, chunk.eigenvectors[6][2] )
        self.assertAlmostEqual(  9.937414417323501e-01, chunk.eigenvectors[6][3] )
        self.assertAlmostEqual(  1.515135480819192e-02, chunk.eigenvectors[6][4] )
        self.assertAlmostEqual( -5.315067279801203e-03, chunk.eigenvectors[6][5] )
        self.assertAlmostEqual(  7.398811740866554e-04, chunk.eigenvectors[6][6] )
        self.assertAlmostEqual( -1.096140926827119e-01, chunk.eigenvectors[6][7] )
        self.assertAlmostEqual(  6.310691708068932e-01, chunk.eigenvectors[7][0] )
        self.assertAlmostEqual(  9.580076031528753e-02, chunk.eigenvectors[7][1] )
        self.assertAlmostEqual( -4.955743335231361e-01, chunk.eigenvectors[7][2] )
        self.assertAlmostEqual( -1.751466725221130e-02, chunk.eigenvectors[7][3] )
        self.assertAlmostEqual(  4.994814966132097e-01, chunk.eigenvectors[7][4] )
        self.assertAlmostEqual(  2.032977022465391e-01, chunk.eigenvectors[7][5] )
        self.assertAlmostEqual(  2.363301436122759e-01, chunk.eigenvectors[7][6] )
        self.assertAlmostEqual(  3.094250598081331e-03, chunk.eigenvectors[7][7] )
        ...
        self.assertAlmostEqual(  1.074034990154797e-01, chunk.eigenvectors[0][0] )
        self.assertAlmostEqual(  5.031741433412508e-02, chunk.eigenvectors[0][1] )
        self.assertAlmostEqual(  6.760345784347230e-01, chunk.eigenvectors[0][2] )
        self.assertAlmostEqual(  1.915401875474596e-04, chunk.eigenvectors[0][3] )
        self.assertAlmostEqual(  1.372508574710752e-01, chunk.eigenvectors[0][4] )
        self.assertAlmostEqual(  1.393826996793076e-01, chunk.eigenvectors[0][5] )
        self.assertAlmostEqual(  7.004601426407554e-01, chunk.eigenvectors[0][6] )
        self.assertAlmostEqual( -3.346821750524192e-04, chunk.eigenvectors[0][7] )
        self.assertAlmostEqual( -2.571527009424179e-01, chunk.eigenvectors[1][0] )
        self.assertAlmostEqual( -5.332339693289121e-01, chunk.eigenvectors[1][1] )
        self.assertAlmostEqual( -4.136479111214130e-01, chunk.eigenvectors[1][2] )
        self.assertAlmostEqual(  1.106338368001554e-03, chunk.eigenvectors[1][3] )
        self.assertAlmostEqual( -1.004221706751696e-01, chunk.eigenvectors[1][4] )
        self.assertAlmostEqual( -3.764142026504758e-01, chunk.eigenvectors[1][5] )
        self.assertAlmostEqual(  5.715373399614003e-01, chunk.eigenvectors[1][6] )
        self.assertAlmostEqual(  1.004341476548397e-03, chunk.eigenvectors[1][7] )
        self.assertAlmostEqual(  1.371275274983367e-01, chunk.eigenvectors[2][0] )
        self.assertAlmostEqual( -8.140382248203507e-01, chunk.eigenvectors[2][1] )
        self.assertAlmostEqual(  2.691481835902048e-01, chunk.eigenvectors[2][2] )
        self.assertAlmostEqual( -3.231353088691554e-03, chunk.eigenvectors[2][3] )
        self.assertAlmostEqual(  3.273381875688868e-01, chunk.eigenvectors[2][4] )
        self.assertAlmostEqual(  1.854210583626489e-01, chunk.eigenvectors[2][5] )
        self.assertAlmostEqual( -3.233486103311748e-01, chunk.eigenvectors[2][6] )
        self.assertAlmostEqual( -1.020603999800658e-03, chunk.eigenvectors[2][7] )
        self.assertAlmostEqual( -4.574278897433420e-01, chunk.eigenvectors[3][0] )
        self.assertAlmostEqual( -3.768700535852364e-02, chunk.eigenvectors[3][1] )
        self.assertAlmostEqual( -2.313850741112833e-01, chunk.eigenvectors[3][2] )
        self.assertAlmostEqual(  9.976800706566235e-03, chunk.eigenvectors[3][3] )
        self.assertAlmostEqual( -5.343662614796388e-02, chunk.eigenvectors[3][4] )
        self.assertAlmostEqual(  8.447798233267909e-01, chunk.eigenvectors[3][5] )
        self.assertAlmostEqual(  1.385291026888886e-01, chunk.eigenvectors[3][6] )
        self.assertAlmostEqual( -1.446040223355744e-03, chunk.eigenvectors[3][7] )
        self.assertAlmostEqual( -5.439389015604781e-01, chunk.eigenvectors[4][0] )
        self.assertAlmostEqual(  1.996774457251584e-01, chunk.eigenvectors[4][1] )
        self.assertAlmostEqual(  1.639440644799672e-02, chunk.eigenvectors[4][2] )
        self.assertAlmostEqual( -5.814555639788589e-03, chunk.eigenvectors[4][3] )
        self.assertAlmostEqual(  7.818950572395386e-01, chunk.eigenvectors[4][4] )
        self.assertAlmostEqual( -2.224672713971069e-01, chunk.eigenvectors[4][5] )
        self.assertAlmostEqual( -5.569982161307516e-02, chunk.eigenvectors[4][6] )
        self.assertAlmostEqual(  1.663102992474412e-03, chunk.eigenvectors[4][7] )
        self.assertAlmostEqual( -1.752926246654827e-04, chunk.eigenvectors[5][0] )
        self.assertAlmostEqual(  8.279317505192994e-04, chunk.eigenvectors[5][1] )
        self.assertAlmostEqual( -1.518618778550807e-03, chunk.eigenvectors[5][2] )
        self.assertAlmostEqual( -1.096637382643695e-01, chunk.eigenvectors[5][3] )
        self.assertAlmostEqual(  7.862304135582435e-04, chunk.eigenvectors[5][4] )
        self.assertAlmostEqual( -9.998834737042694e-04, chunk.eigenvectors[5][5] )
        self.assertAlmostEqual(  1.033041611015826e-03, chunk.eigenvectors[5][6] )
        self.assertAlmostEqual( -9.939658731607477e-01, chunk.eigenvectors[5][7] )
        self.assertAlmostEqual(  1.322444642228684e-02, chunk.eigenvectors[6][0] )
        self.assertAlmostEqual(  1.263506076818620e-03, chunk.eigenvectors[6][1] )
        self.assertAlmostEqual( -5.277719337954276e-03, chunk.eigenvectors[6][2] )
        self.assertAlmostEqual(  9.937414417323504e-01, chunk.eigenvectors[6][3] )
        self.assertAlmostEqual(  1.515135480819228e-02, chunk.eigenvectors[6][4] )
        self.assertAlmostEqual( -5.315067279801292e-03, chunk.eigenvectors[6][5] )
        self.assertAlmostEqual(  7.398811740865364e-04, chunk.eigenvectors[6][6] )
        self.assertAlmostEqual( -1.096140926827097e-01, chunk.eigenvectors[6][7] )
        self.assertAlmostEqual(  6.310691708068932e-01, chunk.eigenvectors[7][0] )
        self.assertAlmostEqual(  9.580076031528753e-02, chunk.eigenvectors[7][1] )
        self.assertAlmostEqual( -4.955743335231361e-01, chunk.eigenvectors[7][2] )
        self.assertAlmostEqual( -1.751466725221130e-02, chunk.eigenvectors[7][3] )
