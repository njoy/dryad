...
class Test_CrossSectionCovarianceData( unittest.TestCase ) :
    ...
    def test_component( self ) :
        ...
        def verify_chunk( self, chunk ) :
            ...
            self.assertEqual( capture, chunk.reaction_identifiers[0] )
            self.assertEqual( elastic, chunk.reaction_identifiers[1] )
            ...
            self.assertEqual( elastic, matrix.column_metadata.reaction_identifiers[0] )
