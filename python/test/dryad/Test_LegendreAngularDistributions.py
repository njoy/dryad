...
class Test_LegendreAngularDistributions( unittest.TestCase ) :
    ...
    def test_component( self ) :
        ...
        chunk = LegendreAngularDistributions( grid = [ 1., 2., 2., 2., 3., 4. ],
                                              distributions = [ LegendreAngularDistribution( [ 1. ] ),
                                                                LegendreAngularDistribution( [ 1., 0.02 ] ),
                                                                LegendreAngularDistribution( [ 1., 0.05 ] ),
                                                                LegendreAngularDistribution( [ 1., 0.01 ] ),
                                                                LegendreAngularDistribution( [ 1., 0.2 ] ),
                                                                LegendreAngularDistribution( [ 1., 0.8 ] ) ],
        ...
        chunk = LegendreAngularDistributions( grid = [ 1., 1., 2., 3., 4. ],
                                              distributions = [ LegendreAngularDistribution( [ 1., 0.01 ] ),
        ...
        chunk = LegendreAngularDistributions( grid = [ 1., 2., 3., 4., 4. ],
                                              distributions = [ LegendreAngularDistribution( [ 1. ] ),
                                                                LegendreAngularDistribution( [ 1., 0.02 ] ),
                                                                LegendreAngularDistribution( [ 1., 0.2 ] ),
                                                                LegendreAngularDistribution( [ 1., 0.8 ] ),
