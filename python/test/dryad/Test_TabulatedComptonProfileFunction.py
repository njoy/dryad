...
class Test_TabulatedComptonProfileFunction( unittest.TestCase ) :
    ...
    def test_component( self ) :
        ...
        def verify_chunk1( self, chunk ) :
            ...
            self.assertAlmostEqual( 4., chunk.upper_momentum_limit )
            ...
            self.assertAlmostEqual( 3., chunk.momentum[2] )
            self.assertAlmostEqual( 4., chunk.momentum[3] )
            ...
            self.assertAlmostEqual( 0.0, chunk( momentum = 0. ) )
            self.assertAlmostEqual( 0.0, chunk( momentum = 5. ) )

            # verify evaluation - values of x inside the x grid (lin-lin piece)
            self.assertAlmostEqual( 3.5, chunk( momentum = 1.5 ) )
            self.assertAlmostEqual( 2.5, chunk( momentum = 2.5 ) )
            self.assertAlmostEqual( 1.5, chunk( momentum = 3.5 ) )

            # verify arithmetic operators
            same = TabulatedComptonProfileFunction( [ 1., 4. ], [ 0., 3. ] )
            threshold = TabulatedComptonProfileFunction( [ 2., 4. ], [ 0., 2. ] )
            nonzerothreshold = TabulatedComptonProfileFunction( [ 2., 4. ], [ 1., 3. ] )
            small = TabulatedComptonProfileFunction( [ 1., 3. ], [ 0., 2. ] )
            ...
            self.assertAlmostEqual(  2., result.momentum[1] )
            self.assertAlmostEqual(  3., result.momentum[2] )
            self.assertAlmostEqual(  4., result.momentum[3] )
            ...
            self.assertAlmostEqual( 1. , chunk.momentum[0] )
            self.assertAlmostEqual( 2. , chunk.momentum[1] )
            self.assertAlmostEqual( 2. , chunk.momentum[2] )
            self.assertAlmostEqual( 3. , chunk.momentum[3] )
            self.assertAlmostEqual( 4. , chunk.momentum[4] )
            self.assertAlmostEqual( 4.0, chunk.values[0] )
            self.assertAlmostEqual( 3.0, chunk.values[1] )
            self.assertAlmostEqual( 4.0, chunk.values[2] )
            self.assertAlmostEqual( 4.0, chunk.values[3] )
            ...
            self.assertAlmostEqual( 1. , result.momentum[0] )
            self.assertAlmostEqual( 2. , result.momentum[1] )
            self.assertAlmostEqual( 2. , result.momentum[2] )
            self.assertAlmostEqual( 3. , result.momentum[3] )
            self.assertAlmostEqual( 4. , result.momentum[4] )
            self.assertAlmostEqual( 4.0, result.values[0] )
            self.assertAlmostEqual( 3.0, result.values[1] )
            self.assertAlmostEqual( 4.0, result.values[2] )
            self.assertAlmostEqual( 4.0, result.values[3] )
            ...
            self.assertAlmostEqual( 2., linear.momentum[1] )
            self.assertAlmostEqual( 3., linear.momentum[2] )
            self.assertAlmostEqual( 4., linear.momentum[3] )
        ...
        def verify_chunk2( self, chunk ) :
            ...
            # verify evaluation - values of x in the x grid
            self.assertAlmostEqual( 4., chunk( momentum = 1. ) )
            self.assertAlmostEqual( 4., chunk( momentum = 2. ) )
            self.assertAlmostEqual( 3., chunk( momentum = 3. ) )
            self.assertAlmostEqual( 2., chunk( momentum = 4. ) )
            ...
            self.assertAlmostEqual( 3.5, chunk( momentum = 1.5 ) )
            self.assertAlmostEqual( 3.5, chunk( momentum = 2.5 ) )
            self.assertAlmostEqual( 2.5, chunk( momentum = 3.5 ) )

            # verify arithmetic operators
            same = TabulatedComptonProfileFunction( [ 1., 4. ], [ 0., 3. ] )
            threshold = TabulatedComptonProfileFunction( [ 2., 4. ], [ 0., 2. ] )
            nonzerothreshold = TabulatedComptonProfileFunction( [ 3., 4. ], [ 1., 2. ] )
            small = TabulatedComptonProfileFunction( [ 1., 3. ], [ 0., 2. ] )
            ...
            self.assertAlmostEqual( 2., chunk.momentum[2] )
            self.assertAlmostEqual( 3., chunk.momentum[3] )
            self.assertAlmostEqual( 3., chunk.momentum[4] )
            self.assertAlmostEqual( 4., chunk.momentum[5] )
            self.assertAlmostEqual( 4., chunk.values[0] )
            self.assertAlmostEqual( 3., chunk.values[1] )
            self.assertAlmostEqual( 4., chunk.values[2] )
            self.assertAlmostEqual( 3., chunk.values[3] )
            ...
            self.assertAlmostEqual( 2., result.momentum[2] )
            self.assertAlmostEqual( 3., result.momentum[3] )
            self.assertAlmostEqual( 3., result.momentum[4] )
            self.assertAlmostEqual( 4., result.momentum[5] )
            self.assertAlmostEqual( 4., result.values[0] )
            self.assertAlmostEqual( 3., result.values[1] )
            self.assertAlmostEqual( 4., result.values[2] )
            self.assertAlmostEqual( 3., result.values[3] )
            ...
            self.assertAlmostEqual( 1., linear.momentum[0] )
            self.assertAlmostEqual( 2., linear.momentum[1] )
            self.assertAlmostEqual( 2., linear.momentum[2] )
            self.assertAlmostEqual( 3., linear.momentum[3] )
            self.assertAlmostEqual( 4., linear.momentum[4] )
        ...
        def verify_chunk3( self, chunk ) :
            ...
            # verify evaluation - values of x inside the x grid (lin-lin piece)
            self.assertAlmostEqual( 2.44966028678679, chunk( momentum = 2.5 ) )
            self.assertAlmostEqual( 1.46416306545103, chunk( momentum = 3.5 ) )
            ...
            self.assertEqual( 18, len( linear.momentum ) )
            ...
            self.assertAlmostEqual( 1.   , linear.momentum[0] )
            self.assertAlmostEqual( 2.   , linear.momentum[1] )
            self.assertAlmostEqual( 2.125, linear.momentum[2] )
            self.assertAlmostEqual( 2.25 , linear.momentum[3] )
            self.assertAlmostEqual( 2.375, linear.momentum[4] )
            self.assertAlmostEqual( 2.5  , linear.momentum[5] )
            self.assertAlmostEqual( 2.625, linear.momentum[6] )
            self.assertAlmostEqual( 2.75 , linear.momentum[7] )
            self.assertAlmostEqual( 2.875, linear.momentum[8] )
            self.assertAlmostEqual( 3.   , linear.momentum[9] )
            self.assertAlmostEqual( 3.125, linear.momentum[10] )
            self.assertAlmostEqual( 3.25 , linear.momentum[11] )
            self.assertAlmostEqual( 3.375, linear.momentum[12] )
            self.assertAlmostEqual( 3.5  , linear.momentum[13] )
            self.assertAlmostEqual( 3.625, linear.momentum[14] )
            self.assertAlmostEqual( 3.75 , linear.momentum[15] )
            self.assertAlmostEqual( 3.875, linear.momentum[16] )
            self.assertAlmostEqual( 4.   , linear.momentum[17] )
        ...
        def verify_chunk4( self, chunk ) :
            ...
            # verify evaluation - values of x inside the x grid (lin-lin piece)
            self.assertAlmostEqual( 3.44966028678679, chunk( momentum = 2.5 ) )
            self.assertAlmostEqual( 2.46416306545103, chunk( momentum = 3.5 ) )
            ...
            self.assertEqual( 12, len( linear.momentum ) )
            ...
            self.assertAlmostEqual( 2.   , linear.momentum[1] )
            self.assertAlmostEqual( 2.   , linear.momentum[2] )
            self.assertAlmostEqual( 2.125, linear.momentum[3] )
            self.assertAlmostEqual( 2.25 , linear.momentum[4] )
            self.assertAlmostEqual( 2.5  , linear.momentum[5] )
            self.assertAlmostEqual( 2.75 , linear.momentum[6] )
            self.assertAlmostEqual( 3.   , linear.momentum[7] )
            self.assertAlmostEqual( 3.25 , linear.momentum[8] )
            self.assertAlmostEqual( 3.5  , linear.momentum[9] )
            self.assertAlmostEqual( 3.75 , linear.momentum[10] )
            self.assertAlmostEqual( 4.   , linear.momentum[11] )
        ...
        def verify_chunk6( self, chunk ) :
            ...
            self.assertAlmostEqual( 2., chunk.momentum[1] )
            self.assertAlmostEqual( 3., chunk.momentum[2] )
            self.assertAlmostEqual( 4., chunk.momentum[3] )      # <-- last point removed
            self.assertAlmostEqual( 4., chunk.values[0] )
            self.assertAlmostEqual( 3., chunk.values[1] )
            self.assertAlmostEqual( 2., chunk.values[2] )
        ...
        chunk = TabulatedComptonProfileFunction( momentum = [ 1., 2., 3., 4. ],
                                        values = [ 4., 3., 2., 1. ],
        ...
        chunk = TabulatedComptonProfileFunction( momentum = [ 1., 2., 2., 3., 4. ],
                                        values = [ 4., 3., 4., 3., 2. ],
                                        interpolant = InterpolationType.LinearLinear )
        ...
        chunk = TabulatedComptonProfileFunction( momentum = [ 1., 2., 2., 2., 3., 4. ],
                                        values =  [ 4., 3., 2., 4., 3., 2. ],
        ...
        chunk = TabulatedComptonProfileFunction( momentum = [ 1., 1., 2., 3., 4. ], # <-- jump at beginning
                                        values =  [ 1., 4., 3., 2., 1. ],
        ...
        chunk = TabulatedComptonProfileFunction( momentum = [ 1., 2., 3., 4., 4. ], # <-- jump at end
                                        values =  [ 4., 3., 2., 1., 4. ],
    ...
    def test_comparison( self ) :
        ...
        left = TabulatedComptonProfileFunction( [ 1., 2., 3., 4. ], [ 4., 3., 2., 1. ] )
        equal = TabulatedComptonProfileFunction( [ 1., 2., 3., 4. ], [ 4., 3., 2., 1. ] )
        different = TabulatedComptonProfileFunction( [ 1., 4. ], [ 4., 1. ] )
    ...
    def test_failures( self ) :
        ...
        with self.assertRaises( Exception ) :
            ...
            chunk = TabulatedComptonProfileFunction( momentum = [], values = [] )

        with self.assertRaises( Exception ) :

            chunk = TabulatedComptonProfileFunction( momentum = [ 1. ], values = [ 4. ] )
        ...
        with self.assertRaises( Exception ) :
            ...
            chunk = TabulatedComptonProfileFunction( momentum = [ 1., 3., 2., 4. ],
                                            values = [ 4., 3., 2., 1. ] )
