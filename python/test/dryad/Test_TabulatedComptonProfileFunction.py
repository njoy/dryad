...
class Test_TabulatedComptonProfileFunction( unittest.TestCase ) :
    ...
    def test_component( self ) :
        ...
        def verify_chunk1( self, chunk ) :
            ...
            # verify content
            self.assertAlmostEqual( -1., chunk.lower_momentum_limit )
            self.assertAlmostEqual(  1., chunk.upper_momentum_limit )
            ...
            self.assertAlmostEqual( -1.  , chunk.momentum[0] )
            self.assertAlmostEqual(  0.  , chunk.momentum[1] )
            self.assertAlmostEqual(  0.5 , chunk.momentum[2] )
            self.assertAlmostEqual(  1.  , chunk.momentum[3] )
            ...
            self.assertAlmostEqual( 0.  , chunk( momentum = -1. ) )
            self.assertAlmostEqual( 0.5 , chunk( momentum =  0. ) )
            self.assertAlmostEqual( 0.75, chunk( momentum =  0.5 ) )
            ...
            self.assertAlmostEqual( 0.25 , chunk( momentum = -0.5 ) )
            ...
            self.assertEqual( 4, len( result.momentum ) )
            self.assertEqual( 4, len( result.values ) )
            self.assertEqual( 1, len( result.boundaries ) )
            self.assertEqual( 1, len( result.interpolants ) )
            self.assertAlmostEqual( -1.  , result.momentum[0] )
            self.assertAlmostEqual(  0.  , result.momentum[1] )
            self.assertAlmostEqual(  0.5 , result.momentum[2] )
            self.assertAlmostEqual(  1.  , result.momentum[3] )
            ...
            self.assertAlmostEqual( -1.  , chunk.momentum[0] )
            self.assertAlmostEqual(  0.  , chunk.momentum[1] )
            self.assertAlmostEqual(  0.  , chunk.momentum[2] )
            self.assertAlmostEqual(  0.5 , chunk.momentum[3] )
            ...
            self.assertAlmostEqual( -1.  , result.momentum[0] )
            self.assertAlmostEqual(  0.  , result.momentum[1] )
            self.assertAlmostEqual(  0.  , result.momentum[2] )
            self.assertAlmostEqual(  0.5 , result.momentum[3] )
            self.assertAlmostEqual(  1.  , result.momentum[4] )
            self.assertAlmostEqual(  0.  , result.values[0] )
            self.assertAlmostEqual(  0.5 , result.values[1] )
            self.assertAlmostEqual(  1.5 , result.values[2] )
            ...
            self.assertEqual( 4, len( linear.momentum ) )
            ...
            self.assertAlmostEqual( -1.  , linear.momentum[0] )
            self.assertAlmostEqual(  0.  , linear.momentum[1] )
            self.assertAlmostEqual(  0.5 , linear.momentum[2] )
            self.assertAlmostEqual(  1.  , linear.momentum[3] )
        ...
        def verify_chunk2( self, chunk ) :
            ...
            # verify evaluation - values of x in the x grid
            self.assertAlmostEqual( 4., chunk( momentum = -1. ) )
            self.assertAlmostEqual( 4., chunk( momentum = 0. ) )
            self.assertAlmostEqual( 3., chunk( momentum = 0.5 ) )
            self.assertAlmostEqual( 2., chunk( momentum = 1. ) )

            # verify evaluation - values of x outside the x grid
            self.assertAlmostEqual( 0.0, chunk( momentum = -2. ) )
            self.assertAlmostEqual( 0.0, chunk( momentum = 2. ) )

            # verify evaluation - values of x inside the x grid
            self.assertAlmostEqual( 3.5, chunk( momentum = -0.5 ) )
            self.assertAlmostEqual( 3.5, chunk( momentum = 0.25 ) )
            ...
            chunk += nonzerothreshold
            self.assertEqual( 6, len( chunk.momentum ) )
            ...
            self.assertAlmostEqual(  0. , chunk.momentum[2] )
            self.assertAlmostEqual(  0.5, chunk.momentum[3] )
            self.assertAlmostEqual(  0.5, chunk.momentum[4] )
            self.assertAlmostEqual(  1. , chunk.momentum[5] )
            self.assertAlmostEqual(  4. , chunk.values[0] )
            self.assertAlmostEqual(  3. , chunk.values[1] )
            self.assertAlmostEqual(  4. , chunk.values[2] )
            self.assertAlmostEqual(  3. , chunk.values[3] )
            ...
            result = chunk + nonzerothreshold
            self.assertEqual( 6, len( result.momentum ) )
            ...
            self.assertAlmostEqual(  0. , result.momentum[2] )
            self.assertAlmostEqual(  0.5, result.momentum[3] )
            self.assertAlmostEqual(  0.5, result.momentum[4] )
            self.assertAlmostEqual(  1. , result.momentum[5] )
            self.assertAlmostEqual(  4. , result.values[0] )
            self.assertAlmostEqual(  3. , result.values[1] )
            self.assertAlmostEqual(  4. , result.values[2] )
            self.assertAlmostEqual(  3. , result.values[3] )
            ...
            self.assertEqual( 5, len( linear.momentum ) )
            ...
            self.assertAlmostEqual( -1. , linear.momentum[0] )
            self.assertAlmostEqual(  0. , linear.momentum[1] )
            self.assertAlmostEqual(  0. , linear.momentum[2] )
            self.assertAlmostEqual(  0.5, linear.momentum[3] )
            self.assertAlmostEqual(  1. , linear.momentum[4] )
        ...
        def verify_chunk3( self, chunk ) :
            ...
            # verify evaluation - values of x inside the x grid
            self.assertAlmostEqual( 0.25, chunk( momentum = -0.5 ) )
            self.assertAlmostEqual( 0.61237243569579, chunk( momentum = 0.25 ) )
            ...
            self.assertEqual( 14, len( linear.momentum ) )
            ...
            self.assertAlmostEqual( -1.    , linear.momentum[0] )
            self.assertAlmostEqual(  0.    , linear.momentum[1] )
            self.assertAlmostEqual(  0.0625, linear.momentum[2] )
            self.assertAlmostEqual(  0.125 , linear.momentum[3] )
            self.assertAlmostEqual(  0.1875, linear.momentum[4] )
            self.assertAlmostEqual(  0.25  , linear.momentum[5] )
            self.assertAlmostEqual(  0.3125, linear.momentum[6] )
            self.assertAlmostEqual(  0.375 , linear.momentum[7] )
            self.assertAlmostEqual(  0.4375, linear.momentum[8] )
            self.assertAlmostEqual(  0.5   , linear.momentum[9] )
            self.assertAlmostEqual(  0.625 , linear.momentum[10] )
            self.assertAlmostEqual(  0.75  , linear.momentum[11] )
            self.assertAlmostEqual(  0.875 , linear.momentum[12] )
            self.assertAlmostEqual(  1.    , linear.momentum[13] )
        ...
        def verify_chunk4( self, chunk ) :
            ...
            self.assertAlmostEqual( 0.  , chunk( momentum = -1. ) )
            self.assertAlmostEqual( 1.  , chunk( momentum = 0. ) )
            self.assertAlmostEqual( 1.25, chunk( momentum = 0.5 ) )
            self.assertAlmostEqual( 1.5 , chunk( momentum = 1. ) )
            ...
            # verify evaluation - values of x inside the x grid
            self.assertAlmostEqual( 0.25, chunk( momentum = -0.5 ) )
            self.assertAlmostEqual( 1.11803398874989, chunk( momentum = 0.25 ) )
            ...
            self.assertEqual( 11, len( linear.momentum ) )
            ...
            self.assertAlmostEqual(  0.   , linear.momentum[2] )
            self.assertAlmostEqual(  0.125, linear.momentum[3] )
            self.assertAlmostEqual(  0.25 , linear.momentum[4] )
            self.assertAlmostEqual(  0.375, linear.momentum[5] )
            self.assertAlmostEqual(  0.5  , linear.momentum[6] )
            self.assertAlmostEqual(  0.625, linear.momentum[7] )
            self.assertAlmostEqual(  0.75 , linear.momentum[8] )
            self.assertAlmostEqual(  0.875, linear.momentum[9] )
            self.assertAlmostEqual(  1.   , linear.momentum[10] )
        ...
        def verify_chunk6( self, chunk ) :
            ...
            self.assertAlmostEqual(  0.  , chunk.momentum[1] )
            self.assertAlmostEqual(  0.5 , chunk.momentum[2] )
            self.assertAlmostEqual(  1.  , chunk.momentum[3] )      # <-- last point removed
            self.assertAlmostEqual(  0.  , chunk.values[0] )
            self.assertAlmostEqual(  0.5 , chunk.values[1] )
            self.assertAlmostEqual(  0.75, chunk.values[2] )
