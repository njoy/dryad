...
class Test_TabulatedDebyeWallerIntegral( unittest.TestCase ) :
    """Unit test for the TabulatedDebyeWallerIntegral class."""
    ...
    def test_component( self ) :
        ...
        def verify_chunk1( self, chunk ) :
            ...
            # verify content
            self.assertAlmostEqual( 1., chunk.lower_temperature_limit )
            self.assertAlmostEqual( 4., chunk.upper_temperature_limit )
            ...
            self.assertAlmostEqual( 4., chunk( temperature = 1. ) )
            self.assertAlmostEqual( 3., chunk( temperature = 2. ) )
            self.assertAlmostEqual( 2., chunk( temperature = 3. ) )
            self.assertAlmostEqual( 1., chunk( temperature = 4. ) )

            # verify evaluation - values of x outside the x grid
            self.assertAlmostEqual( 0.0, chunk( temperature = 0. ) )
            self.assertAlmostEqual( 0.0, chunk( temperature = 5. ) )

            # verify evaluation - values of x inside the x grid (lin-lin piece)
            self.assertAlmostEqual( 3.5, chunk( temperature = 1.5 ) )
            self.assertAlmostEqual( 2.5, chunk( temperature = 2.5 ) )
            self.assertAlmostEqual( 1.5, chunk( temperature = 3.5 ) )

            # verify arithmetic operators
            same = TabulatedDebyeWallerIntegral( [ 1., 4. ], [ 0., 3. ] )
            threshold = TabulatedDebyeWallerIntegral( [ 2., 4. ], [ 0., 2. ] )
            nonzerothreshold = TabulatedDebyeWallerIntegral( [ 2., 4. ], [ 1., 3. ] )
            small = TabulatedDebyeWallerIntegral( [ 1., 3. ], [ 0., 2. ] )

            result = -chunk
            self.assertEqual( 4, result.number_points )
            self.assertEqual( 1, result.number_regions )
            self.assertEqual( 4, len( result.temperatures ) )
            self.assertEqual( 4, len( result.values ) )
            self.assertEqual( 1, len( result.boundaries ) )
            self.assertEqual( 1, len( result.interpolants ) )
            self.assertAlmostEqual(  1., result.temperatures[0] )
            self.assertAlmostEqual(  2., result.temperatures[1] )
            self.assertAlmostEqual(  3., result.temperatures[2] )
            self.assertAlmostEqual(  4., result.temperatures[3] )
            ...
            self.assertEqual( 5, len( chunk.temperatures ) )
            self.assertEqual( 5, len( chunk.values ) )
            self.assertEqual( 2, len( chunk.boundaries ) )
            self.assertEqual( 2, len( chunk.interpolants ) )
            self.assertAlmostEqual( 1. , chunk.temperatures[0] )
            self.assertAlmostEqual( 2. , chunk.temperatures[1] )
            self.assertAlmostEqual( 2. , chunk.temperatures[2] )
            self.assertAlmostEqual( 3. , chunk.temperatures[3] )
            self.assertAlmostEqual( 4. , chunk.temperatures[4] )
            self.assertAlmostEqual( 4.0, chunk.values[0] )
            self.assertAlmostEqual( 3.0, chunk.values[1] )
            self.assertAlmostEqual( 4.0, chunk.values[2] )
            self.assertAlmostEqual( 4.0, chunk.values[3] )
            ...
            self.assertEqual( 5, len( result.temperatures ) )
            self.assertEqual( 5, len( result.values ) )
            self.assertEqual( 2, len( result.boundaries ) )
            self.assertEqual( 2, len( result.interpolants ) )
            self.assertAlmostEqual( 1. , result.temperatures[0] )
            self.assertAlmostEqual( 2. , result.temperatures[1] )
            self.assertAlmostEqual( 2. , result.temperatures[2] )
            self.assertAlmostEqual( 3. , result.temperatures[3] )
            self.assertAlmostEqual( 4. , result.temperatures[4] )
            self.assertAlmostEqual( 4.0, result.values[0] )
            self.assertAlmostEqual( 3.0, result.values[1] )
            self.assertAlmostEqual( 4.0, result.values[2] )
            self.assertAlmostEqual( 4.0, result.values[3] )
            ...
            self.assertEqual( 4, len( linear.temperatures ) )
            ...
            self.assertAlmostEqual( 1., linear.temperatures[0] )
            self.assertAlmostEqual( 2., linear.temperatures[1] )
            self.assertAlmostEqual( 3., linear.temperatures[2] )
            self.assertAlmostEqual( 4., linear.temperatures[3] )
        ...
        def verify_chunk2( self, chunk ) :
            ...
            # verify evaluation - values of x in the x grid
            self.assertAlmostEqual( 4., chunk( temperature = 1. ) )
            self.assertAlmostEqual( 4., chunk( temperature = 2. ) )
            self.assertAlmostEqual( 3., chunk( temperature = 3. ) )
            self.assertAlmostEqual( 2., chunk( temperature = 4. ) )
            ...
            self.assertAlmostEqual( 3.5, chunk( temperature = 1.5 ) )
            self.assertAlmostEqual( 3.5, chunk( temperature = 2.5 ) )
            self.assertAlmostEqual( 2.5, chunk( temperature = 3.5 ) )

            # verify arithmetic operators
            same = TabulatedDebyeWallerIntegral( [ 1., 4. ], [ 0., 3. ] )
            threshold = TabulatedDebyeWallerIntegral( [ 2., 4. ], [ 0., 2. ] )
            nonzerothreshold = TabulatedDebyeWallerIntegral( [ 3., 4. ], [ 1., 2. ] )
            small = TabulatedDebyeWallerIntegral( [ 1., 3. ], [ 0., 2. ] )
            ...
            chunk += nonzerothreshold
            self.assertEqual( 6, len( chunk.temperatures ) )
            ...
            self.assertAlmostEqual( 2., chunk.temperatures[2] )
            self.assertAlmostEqual( 3., chunk.temperatures[3] )
            self.assertAlmostEqual( 3., chunk.temperatures[4] )
            self.assertAlmostEqual( 4., chunk.temperatures[5] )
            self.assertAlmostEqual( 4., chunk.values[0] )
            self.assertAlmostEqual( 3., chunk.values[1] )
            self.assertAlmostEqual( 4., chunk.values[2] )
            self.assertAlmostEqual( 3., chunk.values[3] )
            ...
            result = chunk + nonzerothreshold
            self.assertEqual( 6, len( result.temperatures ) )
            ...
            self.assertAlmostEqual( 2., result.temperatures[2] )
            self.assertAlmostEqual( 3., result.temperatures[3] )
            self.assertAlmostEqual( 3., result.temperatures[4] )
            self.assertAlmostEqual( 4., result.temperatures[5] )
            self.assertAlmostEqual( 4., result.values[0] )
            self.assertAlmostEqual( 3., result.values[1] )
            self.assertAlmostEqual( 4., result.values[2] )
            self.assertAlmostEqual( 3., result.values[3] )
            ...
            self.assertEqual( 5, len( linear.temperatures ) )
            ...
            self.assertAlmostEqual( 1., linear.temperatures[0] )
            self.assertAlmostEqual( 2., linear.temperatures[1] )
            self.assertAlmostEqual( 2., linear.temperatures[2] )
            self.assertAlmostEqual( 3., linear.temperatures[3] )
            self.assertAlmostEqual( 4., linear.temperatures[4] )
        ...
        def verify_chunk3( self, chunk ) :
            ...
            # verify evaluation - values of x inside the x grid (lin-lin piece)
            self.assertAlmostEqual( 2.44966028678679, chunk( temperature = 2.5 ) )
            self.assertAlmostEqual( 1.46416306545103, chunk( temperature = 3.5 ) )
            ...
            temp = TabulatedDebyeWallerIntegral( [ 1., 4. ], [ 4., 1. ] )
            ...
            self.assertEqual( 18, len( linear.temperatures ) )
            ...
            self.assertAlmostEqual( 1.   , linear.temperatures[0] )
            self.assertAlmostEqual( 2.   , linear.temperatures[1] )
            self.assertAlmostEqual( 2.125, linear.temperatures[2] )
            self.assertAlmostEqual( 2.25 , linear.temperatures[3] )
            self.assertAlmostEqual( 2.375, linear.temperatures[4] )
            self.assertAlmostEqual( 2.5  , linear.temperatures[5] )
            self.assertAlmostEqual( 2.625, linear.temperatures[6] )
            self.assertAlmostEqual( 2.75 , linear.temperatures[7] )
            self.assertAlmostEqual( 2.875, linear.temperatures[8] )
            self.assertAlmostEqual( 3.   , linear.temperatures[9] )
            self.assertAlmostEqual( 3.125, linear.temperatures[10] )
            self.assertAlmostEqual( 3.25 , linear.temperatures[11] )
            self.assertAlmostEqual( 3.375, linear.temperatures[12] )
            self.assertAlmostEqual( 3.5  , linear.temperatures[13] )
            self.assertAlmostEqual( 3.625, linear.temperatures[14] )
            self.assertAlmostEqual( 3.75 , linear.temperatures[15] )
            self.assertAlmostEqual( 3.875, linear.temperatures[16] )
            self.assertAlmostEqual( 4.   , linear.temperatures[17] )
        ...
        def verify_chunk4( self, chunk ) :
            ...
            # verify evaluation - values of x inside the x grid (lin-lin piece)
            self.assertAlmostEqual( 3.44966028678679, chunk( temperature = 2.5 ) )
            self.assertAlmostEqual( 2.46416306545103, chunk( temperature = 3.5 ) )
            ...
            self.assertEqual( 12, len( linear.temperatures ) )
            ...
            self.assertAlmostEqual( 2.   , linear.temperatures[1] )
            self.assertAlmostEqual( 2.   , linear.temperatures[2] )
            self.assertAlmostEqual( 2.125, linear.temperatures[3] )
            self.assertAlmostEqual( 2.25 , linear.temperatures[4] )
            self.assertAlmostEqual( 2.5  , linear.temperatures[5] )
            self.assertAlmostEqual( 2.75 , linear.temperatures[6] )
            self.assertAlmostEqual( 3.   , linear.temperatures[7] )
            self.assertAlmostEqual( 3.25 , linear.temperatures[8] )
            self.assertAlmostEqual( 3.5  , linear.temperatures[9] )
            self.assertAlmostEqual( 3.75 , linear.temperatures[10] )
            self.assertAlmostEqual( 4.   , linear.temperatures[11] )
        ...
        def verify_chunk6( self, chunk ) :
            ...
            self.assertAlmostEqual( 2., chunk.temperatures[1] )
            self.assertAlmostEqual( 3., chunk.temperatures[2] )
            self.assertAlmostEqual( 4., chunk.temperatures[3] )      # <-- last point removed
            self.assertAlmostEqual( 4., chunk.values[0] )
            self.assertAlmostEqual( 3., chunk.values[1] )
            self.assertAlmostEqual( 2., chunk.values[2] )
        ...
        chunk = TabulatedDebyeWallerIntegral( temperatures = [ 1., 2., 3., 4. ],
                                     values = [ 4., 3., 2., 1. ],
        ...
        chunk = TabulatedDebyeWallerIntegral( temperatures = [ 1., 2., 2., 3., 4. ],
                                     values = [ 4., 3., 4., 3., 2. ],
                                     interpolant = InterpolationType.LinearLinear )
        ...
        chunk = TabulatedDebyeWallerIntegral( temperatures = [ 1., 2., 3., 4., 4. ], # <-- jump at end
    ...
    def test_comparison( self ) :
        ...
        left = TabulatedDebyeWallerIntegral( [ 1., 2., 3., 4. ], [ 4., 3., 2., 1. ] )
        equal = TabulatedDebyeWallerIntegral( [ 1., 2., 3., 4. ], [ 4., 3., 2., 1. ] )
        different = TabulatedDebyeWallerIntegral( [ 1., 4. ], [ 4., 1. ] )
    ...
    def test_failures( self ) :
        ...
        with self.assertRaises( Exception ) :
            ...
            chunk = TabulatedDebyeWallerIntegral( temperatures = [], values = [] )

        with self.assertRaises( Exception ) :

            chunk = TabulatedDebyeWallerIntegral( temperatures = [ 1. ], values = [ 4. ] )
        ...
        with self.assertRaises( Exception ) :
            ...
            chunk = TabulatedDebyeWallerIntegral( temperatures = [ 1., 3., 2., 4. ],
                                         values = [ 4., 3., 2., 1. ] )

        # the x grid contains a triple x value
        with self.assertRaises( Exception ) :

            chunk = TabulatedDebyeWallerIntegral( temperatures = [ 1., 2., 2., 2., 3., 4. ],
                                         values = [ 4., 3., 3., 3., 2., 1. ] )

        # the x grid has a jump at the beginning
        with self.assertRaises( Exception ) :

            chunk = TabulatedDebyeWallerIntegral( temperatures = [ 1., 1., 3., 4. ],
                                         values = [ 4., 3., 1., 4. ] )

        # the x grid has a jump at the end
        with self.assertRaises( Exception ) :

            chunk = TabulatedDebyeWallerIntegral( temperatures = [ 1., 2., 4., 4. ],
                                         values = [ 4., 3., 1., 4. ] )
