...
class Test_TabulatedScatteringKernelFunction( unittest.TestCase ) :
    ...
    def test_component( self ) :
        ...
        def verify_chunk1( self, chunk ) :
            ...
            # verify content
            self.assertAlmostEqual( 1., chunk.lower_momentum_transfer_limit )
            ...
            self.assertEqual( 4, len( chunk.momentum_transfers ) )
            self.assertEqual( 4, len( chunk.values ) )
            self.assertEqual( 1, len( chunk.boundaries ) )
            self.assertEqual( 1, len( chunk.interpolants ) )
            self.assertAlmostEqual( 1., chunk.momentum_transfers[0] )
            self.assertAlmostEqual( 2., chunk.momentum_transfers[1] )
            self.assertAlmostEqual( 3., chunk.momentum_transfers[2] )
            self.assertAlmostEqual( 4., chunk.momentum_transfers[3] )
            ...
            self.assertAlmostEqual( 4., chunk( momentum_transfer = 1. ) )
            self.assertAlmostEqual( 3., chunk( momentum_transfer = 2. ) )
            self.assertAlmostEqual( 2., chunk( momentum_transfer = 3. ) )
            self.assertAlmostEqual( 1., chunk( momentum_transfer = 4. ) )

            # verify evaluation - values of x outside the x grid
            self.assertAlmostEqual( 0.0, chunk( momentum_transfer = 0. ) )
            self.assertAlmostEqual( 0.0, chunk( momentum_transfer = 5. ) )

            # verify evaluation - values of x inside the x grid (lin-lin piece)
            self.assertAlmostEqual( 3.5, chunk( momentum_transfer = 1.5 ) )
            self.assertAlmostEqual( 2.5, chunk( momentum_transfer = 2.5 ) )
            ...
            self.assertEqual( 4, len( result.momentum_transfers ) )
            self.assertEqual( 4, len( result.values ) )
            self.assertEqual( 1, len( result.boundaries ) )
            self.assertEqual( 1, len( result.interpolants ) )
            self.assertAlmostEqual(  1., result.momentum_transfers[0] )
            self.assertAlmostEqual(  2., result.momentum_transfers[1] )
            self.assertAlmostEqual(  3., result.momentum_transfers[2] )
            self.assertAlmostEqual(  4., result.momentum_transfers[3] )
            ...
            self.assertEqual( 5, len( chunk.momentum_transfers ) )
            self.assertEqual( 5, len( chunk.values ) )
            self.assertEqual( 2, len( chunk.boundaries ) )
            self.assertEqual( 2, len( chunk.interpolants ) )
            self.assertAlmostEqual( 1. , chunk.momentum_transfers[0] )
            self.assertAlmostEqual( 2. , chunk.momentum_transfers[1] )
            self.assertAlmostEqual( 2. , chunk.momentum_transfers[2] )
            self.assertAlmostEqual( 3. , chunk.momentum_transfers[3] )
            self.assertAlmostEqual( 4. , chunk.momentum_transfers[4] )
            self.assertAlmostEqual( 4.0, chunk.values[0] )
            self.assertAlmostEqual( 3.0, chunk.values[1] )
            self.assertAlmostEqual( 4.0, chunk.values[2] )
            self.assertAlmostEqual( 4.0, chunk.values[3] )
            ...
            self.assertAlmostEqual( 1. , result.momentum_transfers[0] )
            self.assertAlmostEqual( 2. , result.momentum_transfers[1] )
            self.assertAlmostEqual( 2. , result.momentum_transfers[2] )
            self.assertAlmostEqual( 3. , result.momentum_transfers[3] )
            self.assertAlmostEqual( 4. , result.momentum_transfers[4] )
            self.assertAlmostEqual( 4.0, result.values[0] )
            self.assertAlmostEqual( 3.0, result.values[1] )
            self.assertAlmostEqual( 4.0, result.values[2] )
            self.assertAlmostEqual( 4.0, result.values[3] )
            ...
            self.assertEqual( 4, len( linear.momentum_transfers ) )
            ...
            self.assertAlmostEqual( 1., linear.momentum_transfers[0] )
            self.assertAlmostEqual( 2., linear.momentum_transfers[1] )
            self.assertAlmostEqual( 3., linear.momentum_transfers[2] )
            self.assertAlmostEqual( 4., linear.momentum_transfers[3] )
        ...
        def verify_chunk2( self, chunk ) :
            ...
            # verify evaluation - values of x in the x grid
            self.assertAlmostEqual( 4., chunk( momentum_transfer = 1. ) )
            self.assertAlmostEqual( 4., chunk( momentum_transfer = 2. ) )
            self.assertAlmostEqual( 3., chunk( momentum_transfer = 3. ) )
            self.assertAlmostEqual( 2., chunk( momentum_transfer = 4. ) )
            ...
            self.assertAlmostEqual( 3.5, chunk( momentum_transfer = 1.5 ) )
            self.assertAlmostEqual( 3.5, chunk( momentum_transfer = 2.5 ) )
            ...
            chunk += nonzerothreshold
            self.assertEqual( 6, len( chunk.momentum_transfers ) )
            ...
            self.assertAlmostEqual( 2., chunk.momentum_transfers[2] )
            self.assertAlmostEqual( 3., chunk.momentum_transfers[3] )
            self.assertAlmostEqual( 3., chunk.momentum_transfers[4] )
            self.assertAlmostEqual( 4., chunk.momentum_transfers[5] )
            self.assertAlmostEqual( 4., chunk.values[0] )
            self.assertAlmostEqual( 3., chunk.values[1] )
            self.assertAlmostEqual( 4., chunk.values[2] )
            self.assertAlmostEqual( 3., chunk.values[3] )
            ...
            result = chunk + nonzerothreshold
            self.assertEqual( 6, len( result.momentum_transfers ) )
            ...
            self.assertAlmostEqual( 2., result.momentum_transfers[2] )
            self.assertAlmostEqual( 3., result.momentum_transfers[3] )
            self.assertAlmostEqual( 3., result.momentum_transfers[4] )
            self.assertAlmostEqual( 4., result.momentum_transfers[5] )
            self.assertAlmostEqual( 4., result.values[0] )
            self.assertAlmostEqual( 3., result.values[1] )
            self.assertAlmostEqual( 4., result.values[2] )
            self.assertAlmostEqual( 3., result.values[3] )
            ...
            self.assertEqual( 5, len( linear.momentum_transfers ) )
            ...
            self.assertAlmostEqual( 1., linear.momentum_transfers[0] )
            self.assertAlmostEqual( 2., linear.momentum_transfers[1] )
            self.assertAlmostEqual( 2., linear.momentum_transfers[2] )
            self.assertAlmostEqual( 3., linear.momentum_transfers[3] )
            self.assertAlmostEqual( 4., linear.momentum_transfers[4] )
        ...
        def verify_chunk3( self, chunk ) :
            ...
            # verify evaluation - values of x inside the x grid (lin-lin piece)
            self.assertAlmostEqual( 2.44966028678679, chunk( momentum_transfer = 2.5 ) )
            self.assertAlmostEqual( 1.46416306545103, chunk( momentum_transfer = 3.5 ) )
            ...
            self.assertEqual( 18, len( linear.momentum_transfers ) )
            ...
            self.assertAlmostEqual( 1.   , linear.momentum_transfers[0] )
            self.assertAlmostEqual( 2.   , linear.momentum_transfers[1] )
            self.assertAlmostEqual( 2.125, linear.momentum_transfers[2] )
            self.assertAlmostEqual( 2.25 , linear.momentum_transfers[3] )
            self.assertAlmostEqual( 2.375, linear.momentum_transfers[4] )
            self.assertAlmostEqual( 2.5  , linear.momentum_transfers[5] )
            self.assertAlmostEqual( 2.625, linear.momentum_transfers[6] )
            self.assertAlmostEqual( 2.75 , linear.momentum_transfers[7] )
            self.assertAlmostEqual( 2.875, linear.momentum_transfers[8] )
            self.assertAlmostEqual( 3.   , linear.momentum_transfers[9] )
            self.assertAlmostEqual( 3.125, linear.momentum_transfers[10] )
            self.assertAlmostEqual( 3.25 , linear.momentum_transfers[11] )
            self.assertAlmostEqual( 3.375, linear.momentum_transfers[12] )
            self.assertAlmostEqual( 3.5  , linear.momentum_transfers[13] )
            self.assertAlmostEqual( 3.625, linear.momentum_transfers[14] )
            self.assertAlmostEqual( 3.75 , linear.momentum_transfers[15] )
            self.assertAlmostEqual( 3.875, linear.momentum_transfers[16] )
            self.assertAlmostEqual( 4.   , linear.momentum_transfers[17] )
        ...
        def verify_chunk4( self, chunk ) :
            ...
            # verify evaluation - values of x inside the x grid (lin-lin piece)
            self.assertAlmostEqual( 3.44966028678679, chunk( momentum_transfer = 2.5 ) )
            self.assertAlmostEqual( 2.46416306545103, chunk( momentum_transfer = 3.5 ) )
            ...
            self.assertEqual( 12, len( linear.momentum_transfers ) )
            ...
            self.assertAlmostEqual( 2.   , linear.momentum_transfers[1] )
            self.assertAlmostEqual( 2.   , linear.momentum_transfers[2] )
            self.assertAlmostEqual( 2.125, linear.momentum_transfers[3] )
            self.assertAlmostEqual( 2.25 , linear.momentum_transfers[4] )
            self.assertAlmostEqual( 2.5  , linear.momentum_transfers[5] )
            self.assertAlmostEqual( 2.75 , linear.momentum_transfers[6] )
            self.assertAlmostEqual( 3.   , linear.momentum_transfers[7] )
            self.assertAlmostEqual( 3.25 , linear.momentum_transfers[8] )
            self.assertAlmostEqual( 3.5  , linear.momentum_transfers[9] )
            self.assertAlmostEqual( 3.75 , linear.momentum_transfers[10] )
            self.assertAlmostEqual( 4.   , linear.momentum_transfers[11] )
        ...
        def verify_chunk6( self, chunk ) :
            ...
            self.assertAlmostEqual( 2., chunk.momentum_transfers[1] )
            self.assertAlmostEqual( 3., chunk.momentum_transfers[2] )
            self.assertAlmostEqual( 4., chunk.momentum_transfers[3] )      # <-- last point removed
            self.assertAlmostEqual( 4., chunk.values[0] )
            self.assertAlmostEqual( 3., chunk.values[1] )
            self.assertAlmostEqual( 2., chunk.values[2] )
