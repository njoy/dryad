...
def verify_chunk( self, chunk ) :
    ...
    self.assertAlmostEqual(  296, incoherent.debye_waller_integral.lower_temperature_limit )
    self.assertAlmostEqual( 1200, incoherent.debye_waller_integral.upper_temperature_limit )
    self.assertEqual( 8, incoherent.debye_waller_integral.number_points )
    self.assertEqual( 1, incoherent.debye_waller_integral.number_regions )
    ...
    self.assertEqual( 1, len( incoherent.debye_waller_integral.boundaries ) )
    self.assertEqual( 1, len( incoherent.debye_waller_integral.interpolants ) )
    ...
    self.assertEqual( 7, incoherent.debye_waller_integral.boundaries[0] )
    self.assertEqual( InterpolationType.LinearLinear, incoherent.debye_waller_integral.interpolants[0] )
    self.assertEqual( True, incoherent.debye_waller_integral.is_linearised )
