...
class Test_TabulatedAverageEnergy( unittest.TestCase ) :
    ...
    def test_component( self ) :
        ...
        chunk = TabulatedAverageEnergy( energies = [ 1., 1., 2., 3., 4. ], # <-- jump at beginning
                                        values =  [ 1., 4., 3., 2., 1. ],
    ...
    def test_comparison( self ) :
        ...
        left = TabulatedAverageEnergy( [ 1., 2., 3., 4. ], [ 4., 3., 2., 1. ] )
        equal = TabulatedAverageEnergy( [ 1., 2., 3., 4. ], [ 4., 3., 2., 1. ] )
        different = TabulatedAverageEnergy( [ 1., 4. ], [ 4., 1. ] )
