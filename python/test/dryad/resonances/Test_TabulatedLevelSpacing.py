...
class Test_dryad_TabulatedLevelSpacing( unittest.TestCase ) :
    """Unit test for the TabulatedLevelSpacing class."""
    ...
    def test_component( self ) :
        ...
        def verify_chunk1( self, chunk ) :
            ...
            same = TabulatedLevelSpacing( [ 1., 4. ], [ 0., 3. ] )
            threshold = TabulatedLevelSpacing( [ 2., 4. ], [ 0., 2. ] )
            nonzerothreshold = TabulatedLevelSpacing( [ 2., 4. ], [ 1., 3. ] )
            small = TabulatedLevelSpacing( [ 1., 3. ], [ 0., 2. ] )
        ...
        def verify_chunk2( self, chunk ) :
            ...
            same = TabulatedLevelSpacing( [ 1., 4. ], [ 0., 3. ] )
            threshold = TabulatedLevelSpacing( [ 2., 4. ], [ 0., 2. ] )
            nonzerothreshold = TabulatedLevelSpacing( [ 3., 4. ], [ 1., 2. ] )
            small = TabulatedLevelSpacing( [ 1., 3. ], [ 0., 2. ] )
        ...
        def verify_chunk3( self, chunk ) :
            ...
            temp = TabulatedLevelSpacing( [ 1., 4. ], [ 4., 1. ] )
        ...
        chunk = TabulatedLevelSpacing( energies = [ 1., 2., 3., 4. ],
                                 values = [ 4., 3., 2., 1. ],
        ...
        chunk = TabulatedLevelSpacing( energies = [ 1., 2., 2., 3., 4. ],
                                 values = [ 4., 3., 4., 3., 2. ],
                                 interpolant = InterpolationType.LinearLinear )
        ...
        chunk = TabulatedLevelSpacing( energies = [ 1., 2., 2., 2., 3., 4. ],
                                 values =  [ 4., 3., 2., 4., 3., 2. ],
        ...
        chunk = TabulatedLevelSpacing( energies = [ 1., 1., 2., 3., 4. ], # <-- jump at beginning
                                 values =  [ 1., 4., 3., 2., 1. ],
        ...
        chunk = TabulatedLevelSpacing( energies = [ 1., 2., 3., 4., 4. ], # <-- jump at end
                                 values =  [ 4., 3., 2., 1., 4. ],
    ...
    def test_comparison( self ) :
        ...
        left = TabulatedLevelSpacing( [ 1., 2., 3., 4. ], [ 4., 3., 2., 1. ] )
        equal = TabulatedLevelSpacing( [ 1., 2., 3., 4. ], [ 4., 3., 2., 1. ] )
        different = TabulatedLevelSpacing( [ 1., 4. ], [ 4., 1. ] )
    ...
    def test_failures( self ) :
        ...
        with self.assertRaises( Exception ) :
            ...
            chunk = TabulatedLevelSpacing( energies = [], values = [] )

        with self.assertRaises( Exception ) :

            chunk = TabulatedLevelSpacing( energies = [ 1. ], values = [ 4. ] )
        ...
        with self.assertRaises( Exception ) :
            ...
            chunk = TabulatedLevelSpacing( energies = [ 1., 3., 2., 4. ],
                                           values = [ 4., 3., 2., 1. ] )
