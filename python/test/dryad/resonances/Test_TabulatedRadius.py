...
class Test_dryad_TabulatedRadius( unittest.TestCase ) :
    """Unit test for the TabulatedRadius class."""
    ...
    def test_component( self ) :
        ...
        def verify_chunk1( self, chunk ) :
            ...
            same = TabulatedRadius( [ 1., 4. ], [ 0., 3. ] )
            threshold = TabulatedRadius( [ 2., 4. ], [ 0., 2. ] )
            nonzerothreshold = TabulatedRadius( [ 2., 4. ], [ 1., 3. ] )
            small = TabulatedRadius( [ 1., 3. ], [ 0., 2. ] )
        ...
        def verify_chunk2( self, chunk ) :
            ...
            same = TabulatedRadius( [ 1., 4. ], [ 0., 3. ] )
            threshold = TabulatedRadius( [ 2., 4. ], [ 0., 2. ] )
            nonzerothreshold = TabulatedRadius( [ 3., 4. ], [ 1., 2. ] )
            small = TabulatedRadius( [ 1., 3. ], [ 0., 2. ] )
        ...
        chunk = TabulatedRadius( energies = [ 1., 2., 3., 4. ],
                                       values = [ 4., 3., 2., 1. ],
        ...
        chunk = TabulatedRadius( energies = [ 1., 2., 2., 3., 4. ],
                                       values = [ 4., 3., 4., 3., 2. ],
                                       interpolant = InterpolationType.LinearLinear )
        ...
        chunk = TabulatedRadius( energies = [ 1., 2., 3., 4., 4. ], # <-- jump at end
    ...
    def test_comparison( self ) :
        ...
        left = TabulatedRadius( [ 1., 2., 3., 4. ], [ 4., 3., 2., 1. ] )
        equal = TabulatedRadius( [ 1., 2., 3., 4. ], [ 4., 3., 2., 1. ] )
        different = TabulatedRadius( [ 1., 4. ], [ 4., 1. ] )
    ...
    def test_failures( self ) :
        ...
        with self.assertRaises( Exception ) :
            ...
            chunk = TabulatedRadius( energies = [], values = [] )

        with self.assertRaises( Exception ) :

            chunk = TabulatedRadius( energies = [ 1. ], values = [ 4. ] )
        ...
        with self.assertRaises( Exception ) :
            ...
            chunk = TabulatedRadius( energies = [ 1., 3., 2., 4. ],
                                           values = [ 4., 3., 2., 1. ] )

        # the x grid contains a triple x value
        with self.assertRaises( Exception ) :

            chunk = TabulatedRadius( energies = [ 1., 2., 2., 2., 3., 4. ],
                                           values = [ 4., 3., 3., 3., 2., 1. ] )

        # the x grid has a jump at the beginning
        with self.assertRaises( Exception ) :

            chunk = TabulatedRadius( energies = [ 1., 1., 3., 4. ],
                                           values = [ 4., 3., 1., 4. ] )

        # the x grid has a jump at the end
        with self.assertRaises( Exception ) :

            chunk = TabulatedRadius( energies = [ 1., 2., 4., 4. ],
                                           values = [ 4., 3., 1., 4. ] )
