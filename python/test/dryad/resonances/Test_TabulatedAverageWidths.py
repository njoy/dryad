...
class Test_dryad_TabulatedAverageWidths( unittest.TestCase ) :
    """Unit test for the TabulatedAverageWidths class."""
    ...
    def test_component( self ) :
        ...
        def verify_chunk1( self, chunk ) :
            ...
            same = TabulatedAverageWidths( [ 1., 4. ], [ 0., 3. ] )
            threshold = TabulatedAverageWidths( [ 2., 4. ], [ 0., 2. ] )
            nonzerothreshold = TabulatedAverageWidths( [ 2., 4. ], [ 1., 3. ] )
            small = TabulatedAverageWidths( [ 1., 3. ], [ 0., 2. ] )
        ...
        def verify_chunk2( self, chunk ) :
            ...
            same = TabulatedAverageWidths( [ 1., 4. ], [ 0., 3. ] )
            threshold = TabulatedAverageWidths( [ 2., 4. ], [ 0., 2. ] )
            nonzerothreshold = TabulatedAverageWidths( [ 3., 4. ], [ 1., 2. ] )
            small = TabulatedAverageWidths( [ 1., 3. ], [ 0., 2. ] )
        ...
        def verify_chunk3( self, chunk ) :
            ...
            temp = TabulatedAverageWidths( [ 1., 4. ], [ 4., 1. ] )
        ...
        chunk = TabulatedAverageWidths( dof = 1,
                                 energies = [ 1., 2., 3., 4. ],
                                 values = [ 4., 3., 2., 1. ],
        ...
        chunk = TabulatedAverageWidths( dof = 1,
                                 energies = [ 1., 1., 2., 3., 4. ], # <-- jump at beginning
                                 values =  [ 1., 4., 3., 2., 1. ],
        ...
        chunk = TabulatedAverageWidths( dof = 1,
                                 energies = [ 1., 2., 3., 4., 4. ], # <-- jump at end
                                 values =  [ 4., 3., 2., 1., 4. ],
    ...
    def test_comparison( self ) :
        ...
        left = TabulatedAverageWidths( [ 1., 2., 3., 4. ], [ 4., 3., 2., 1. ] )
        equal = TabulatedAverageWidths( [ 1., 2., 3., 4. ], [ 4., 3., 2., 1. ] )
        different = TabulatedAverageWidths( [ 1., 4. ], [ 4., 1. ] )
    ...
    def test_dof_comparison( self ) :
        
        left = TabulatedAverageWidths( dof = 1, energies = [ 1., 2., 3., 4. ], values = [ 4., 3., 2., 1. ] )
        different_dof = TabulatedAverageWidths( dof = 2, energies = [ 1., 2., 3., 4. ], values = [ 4., 3., 2., 1. ] )

        self.assertEqual( False, ( left == different_dof ) )
        self.assertEqual( True, ( left != different_dof ) )
    ...
    def test_failures( self ) :
        ...
        with self.assertRaises( Exception ) :
            ...
            chunk = TabulatedAverageWidths( dof = 1, energies = [], values = [] )

        with self.assertRaises( Exception ) :

            chunk = TabulatedAverageWidths( dof = 1, energies = [ 1. ], values = [ 4. ] )

        # the x and y grid do not have the same number of points
        with self.assertRaises( Exception ) :

            chunk = TabulatedAverageWidths( dof = 1, energies = [ 1., 2., 3., 4. ],
                                           values = [ 4., 3., 2. ] )
        ...
        with self.assertRaises( Exception ) :
            ...
            chunk = TabulatedAverageWidths( dof = 1, energies = [ 1., 3., 2., 4. ],
                                           values = [ 4., 3., 2., 1. ] )
