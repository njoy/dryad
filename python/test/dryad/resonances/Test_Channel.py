...
class Test_Channel( unittest.TestCase ) :
    ...
    def test_component( self ) :
        ...
        self.assertIsNone( capture.background )
        ...
        self.assertEqual( False, capture.has_penetrability )
        self.assertEqual( False, capture.has_shift_factor )
        self.assertEqual( False, capture.has_phase_shift )
        self.assertEqual( False, capture.has_phase_shift_difference )
        ...
        self.assertIsNone( elastic.background )
        ...
        self.assertEqual( True, elastic.has_penetrability )
        self.assertEqual( True, elastic.has_shift_factor )
        self.assertEqual( True, elastic.has_phase_shift )
        self.assertEqual( False, elastic.has_phase_shift_difference )
        ...
        self.assertIsNone( inelastic.background )
        ...
        self.assertEqual( True, inelastic.has_penetrability )
        self.assertEqual( True, inelastic.has_shift_factor )
        self.assertEqual( True, inelastic.has_phase_shift )
        self.assertEqual( False, inelastic.has_phase_shift_difference )
        ...
        self.assertIsNone( proton.background )
        ...
        self.assertEqual( True, proton.has_penetrability )
        self.assertEqual( True, proton.has_shift_factor )
        self.assertEqual( True, proton.has_phase_shift )
        self.assertEqual( True, proton.has_phase_shift_difference )
