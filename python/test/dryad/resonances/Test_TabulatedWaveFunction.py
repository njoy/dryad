...
class Test_dryad_TabulatedWaveFunction( unittest.TestCase ) :
    ...
    def test_component( self ) :
        ...
        def verify_chunk1( self, chunk ) :
            ...
            # verify content
            self.assertAlmostEqual( 1., chunk.lower_ratio_limit )
            self.assertAlmostEqual( 4., chunk.upper_ratio_limit )
            self.assertEqual( 4, chunk.number_points )
            self.assertEqual( 1, chunk.number_regions )
            self.assertEqual( 4, len( chunk.ratios ) )
            self.assertEqual( 4, len( chunk.values ) )
            self.assertEqual( 1, len( chunk.boundaries ) )
            self.assertEqual( 1, len( chunk.interpolants ) )
            self.assertAlmostEqual( 1., chunk.ratios[0] )
            self.assertAlmostEqual( 2., chunk.ratios[1] )
            self.assertAlmostEqual( 3., chunk.ratios[2] )
            self.assertAlmostEqual( 4., chunk.ratios[3] )
            ...
            self.assertAlmostEqual( 4., chunk( ratio = 1. ) )
            self.assertAlmostEqual( 3., chunk( ratio = 2. ) )
            self.assertAlmostEqual( 2., chunk( ratio = 3. ) )
            self.assertAlmostEqual( 1., chunk( ratio = 4. ) )

            # verify evaluation - values of x outside the x grid
            self.assertAlmostEqual( 0.0, chunk( ratio = 0. ) )
            self.assertAlmostEqual( 0.0, chunk( ratio = 5. ) )

            # verify evaluation - values of x inside the x grid (lin-lin piece)
            self.assertAlmostEqual( 3.5, chunk( ratio = 1.5 ) )
            self.assertAlmostEqual( 2.5, chunk( ratio = 2.5 ) )
            self.assertAlmostEqual( 1.5, chunk( ratio = 3.5 ) )

            # verify arithmetic operators
            same = TabulatedWaveFunction( [ 1., 4. ], [ 0., 3. ] )
            threshold = TabulatedWaveFunction( [ 2., 4. ], [ 0., 2. ] )
            nonzerothreshold = TabulatedWaveFunction( [ 2., 4. ], [ 1., 3. ] )
            small = TabulatedWaveFunction( [ 1., 3. ], [ 0., 2. ] )

            result = -chunk
            self.assertEqual( 4, result.number_points )
            self.assertEqual( 1, result.number_regions )
            self.assertEqual( 4, len( result.ratios ) )
            self.assertEqual( 4, len( result.values ) )
            self.assertEqual( 1, len( result.boundaries ) )
            self.assertEqual( 1, len( result.interpolants ) )
            self.assertAlmostEqual(  1., result.ratios[0] )
            self.assertAlmostEqual(  2., result.ratios[1] )
            self.assertAlmostEqual(  3., result.ratios[2] )
            self.assertAlmostEqual(  4., result.ratios[3] )
            ...
            self.assertEqual( 5, len( chunk.ratios ) )
            self.assertEqual( 5, len( chunk.values ) )
            self.assertEqual( 2, len( chunk.boundaries ) )
            self.assertEqual( 2, len( chunk.interpolants ) )
            self.assertAlmostEqual( 1. , chunk.ratios[0] )
            self.assertAlmostEqual( 2. , chunk.ratios[1] )
            self.assertAlmostEqual( 2. , chunk.ratios[2] )
            self.assertAlmostEqual( 3. , chunk.ratios[3] )
            self.assertAlmostEqual( 4. , chunk.ratios[4] )
            self.assertAlmostEqual( 4.0, chunk.values[0] )
            self.assertAlmostEqual( 3.0, chunk.values[1] )
            self.assertAlmostEqual( 4.0, chunk.values[2] )
            self.assertAlmostEqual( 4.0, chunk.values[3] )
            ...
            self.assertEqual( 5, len( result.ratios ) )
            self.assertEqual( 5, len( result.values ) )
            self.assertEqual( 2, len( result.boundaries ) )
            self.assertEqual( 2, len( result.interpolants ) )
            self.assertAlmostEqual( 1. , result.ratios[0] )
            self.assertAlmostEqual( 2. , result.ratios[1] )
            self.assertAlmostEqual( 2. , result.ratios[2] )
            self.assertAlmostEqual( 3. , result.ratios[3] )
            self.assertAlmostEqual( 4. , result.ratios[4] )
            self.assertAlmostEqual( 4.0, result.values[0] )
            self.assertAlmostEqual( 3.0, result.values[1] )
            self.assertAlmostEqual( 4.0, result.values[2] )
            self.assertAlmostEqual( 4.0, result.values[3] )
            ...
            self.assertEqual( 4, len( linear.ratios ) )
            ...
            self.assertAlmostEqual( 1., linear.ratios[0] )
            self.assertAlmostEqual( 2., linear.ratios[1] )
            self.assertAlmostEqual( 3., linear.ratios[2] )
            self.assertAlmostEqual( 4., linear.ratios[3] )
        ...
        def verify_chunk2( self, chunk ) :
            ...
            # verify evaluation - values of x in the x grid
            self.assertAlmostEqual( 4., chunk( ratio = 1. ) )
            self.assertAlmostEqual( 4., chunk( ratio = 2. ) )
            self.assertAlmostEqual( 3., chunk( ratio = 3. ) )
            self.assertAlmostEqual( 2., chunk( ratio = 4. ) )
            ...
            self.assertAlmostEqual( 3.5, chunk( ratio = 1.5 ) )
            self.assertAlmostEqual( 3.5, chunk( ratio = 2.5 ) )
            self.assertAlmostEqual( 2.5, chunk( ratio = 3.5 ) )

            # verify arithmetic operators
            same = TabulatedWaveFunction( [ 1., 4. ], [ 0., 3. ] )
            threshold = TabulatedWaveFunction( [ 2., 4. ], [ 0., 2. ] )
            nonzerothreshold = TabulatedWaveFunction( [ 3., 4. ], [ 1., 2. ] )
            small = TabulatedWaveFunction( [ 1., 3. ], [ 0., 2. ] )
            ...
            chunk += nonzerothreshold
            self.assertEqual( 6, len( chunk.ratios ) )
            ...
            self.assertAlmostEqual( 2., chunk.ratios[2] )
            self.assertAlmostEqual( 3., chunk.ratios[3] )
            self.assertAlmostEqual( 3., chunk.ratios[4] )
            self.assertAlmostEqual( 4., chunk.ratios[5] )
            self.assertAlmostEqual( 4., chunk.values[0] )
            self.assertAlmostEqual( 3., chunk.values[1] )
            self.assertAlmostEqual( 4., chunk.values[2] )
            self.assertAlmostEqual( 3., chunk.values[3] )
            ...
            result = chunk + nonzerothreshold
            self.assertEqual( 6, len( result.ratios ) )
            ...
            self.assertAlmostEqual( 2., result.ratios[2] )
            self.assertAlmostEqual( 3., result.ratios[3] )
            self.assertAlmostEqual( 3., result.ratios[4] )
            self.assertAlmostEqual( 4., result.ratios[5] )
            self.assertAlmostEqual( 4., result.values[0] )
            self.assertAlmostEqual( 3., result.values[1] )
            self.assertAlmostEqual( 4., result.values[2] )
            self.assertAlmostEqual( 3., result.values[3] )
            ...
            self.assertEqual( 5, len( linear.ratios ) )
            ...
            self.assertAlmostEqual( 1., linear.ratios[0] )
            self.assertAlmostEqual( 2., linear.ratios[1] )
            self.assertAlmostEqual( 2., linear.ratios[2] )
            self.assertAlmostEqual( 3., linear.ratios[3] )
            self.assertAlmostEqual( 4., linear.ratios[4] )
        ...
        def verify_chunk3( self, chunk ) :
            ...
            # verify evaluation - values of x inside the x grid (lin-lin piece)
            self.assertAlmostEqual( 2.44966028678679, chunk( ratio = 2.5 ) )
            self.assertAlmostEqual( 1.46416306545103, chunk( ratio = 3.5 ) )
            ...
            temp = TabulatedWaveFunction( [ 1., 4. ], [ 4., 1. ] )
            ...
            self.assertEqual( 18, len( linear.ratios ) )
            ...
            self.assertAlmostEqual( 1.   , linear.ratios[0] )
            self.assertAlmostEqual( 2.   , linear.ratios[1] )
            self.assertAlmostEqual( 2.125, linear.ratios[2] )
            self.assertAlmostEqual( 2.25 , linear.ratios[3] )
            self.assertAlmostEqual( 2.375, linear.ratios[4] )
            self.assertAlmostEqual( 2.5  , linear.ratios[5] )
            self.assertAlmostEqual( 2.625, linear.ratios[6] )
            self.assertAlmostEqual( 2.75 , linear.ratios[7] )
            self.assertAlmostEqual( 2.875, linear.ratios[8] )
            self.assertAlmostEqual( 3.   , linear.ratios[9] )
            self.assertAlmostEqual( 3.125, linear.ratios[10] )
            self.assertAlmostEqual( 3.25 , linear.ratios[11] )
            self.assertAlmostEqual( 3.375, linear.ratios[12] )
            self.assertAlmostEqual( 3.5  , linear.ratios[13] )
            self.assertAlmostEqual( 3.625, linear.ratios[14] )
            self.assertAlmostEqual( 3.75 , linear.ratios[15] )
            self.assertAlmostEqual( 3.875, linear.ratios[16] )
            self.assertAlmostEqual( 4.   , linear.ratios[17] )
        ...
        def verify_chunk4( self, chunk ) :
            ...
            # verify evaluation - values of x inside the x grid (lin-lin piece)
            self.assertAlmostEqual( 3.44966028678679, chunk( ratio = 2.5 ) )
            self.assertAlmostEqual( 2.46416306545103, chunk( ratio = 3.5 ) )
            ...
            self.assertEqual( 12, len( linear.ratios ) )
            ...
            self.assertAlmostEqual( 2.   , linear.ratios[1] )
            self.assertAlmostEqual( 2.   , linear.ratios[2] )
            self.assertAlmostEqual( 2.125, linear.ratios[3] )
            self.assertAlmostEqual( 2.25 , linear.ratios[4] )
            self.assertAlmostEqual( 2.5  , linear.ratios[5] )
            self.assertAlmostEqual( 2.75 , linear.ratios[6] )
            self.assertAlmostEqual( 3.   , linear.ratios[7] )
            self.assertAlmostEqual( 3.25 , linear.ratios[8] )
            self.assertAlmostEqual( 3.5  , linear.ratios[9] )
            self.assertAlmostEqual( 3.75 , linear.ratios[10] )
            self.assertAlmostEqual( 4.   , linear.ratios[11] )
        ...
        def verify_chunk6( self, chunk ) :
            ...
            self.assertAlmostEqual( 2., chunk.ratios[1] )
            self.assertAlmostEqual( 3., chunk.ratios[2] )
            self.assertAlmostEqual( 4., chunk.ratios[3] )      # <-- last point removed
            self.assertAlmostEqual( 4., chunk.values[0] )
            self.assertAlmostEqual( 3., chunk.values[1] )
            self.assertAlmostEqual( 2., chunk.values[2] )
        ...
        chunk = TabulatedWaveFunction( ratios = [ 1., 2., 3., 4. ],
                                       values = [ 4., 3., 2., 1. ],
    ...
    def test_comparison( self ) :
        ...
        left = TabulatedWaveFunction( [ 1., 2., 3., 4. ], [ 4., 3., 2., 1. ] )
        equal = TabulatedWaveFunction( [ 1., 2., 3., 4. ], [ 4., 3., 2., 1. ] )
        different = TabulatedWaveFunction( [ 1., 4. ], [ 4., 1. ] )
    ...
    def test_failures( self ) :
        ...
        with self.assertRaises( Exception ) :
            ...
            chunk = TabulatedWaveFunction( ratios = [], values = [] )

        with self.assertRaises( Exception ) :

            chunk = TabulatedWaveFunction( ratios = [ 1. ], values = [ 4. ] )
