...
# local imports
from njoy.reconr import calculate_summation_cross_sections
...
class Test_calculate_summation_cross_sections( unittest.TestCase ) :
    """Unit test for the calculate_summation_cross_sections function."""

    def test_component( self ) :

        chunk = make_projectile_target()
        calculate_summation_cross_sections( chunk )
