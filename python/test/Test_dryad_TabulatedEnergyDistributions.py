...
class Test_dryad_TabulatedEnergyDistribution( unittest.TestCase ) :
    ...
    def test_component( self ) :
        ...
        def verify_chunk( self, chunk ) :
            ...
            self.assertEqual( 2, len( chunk.distributions[0].energies ) )
            self.assertEqual( 2, len( chunk.distributions[0].values ) )
            self.assertEqual( 3, len( chunk.distributions[1].energies ) )
            self.assertEqual( 3, len( chunk.distributions[1].values ) )
            self.assertEqual( 3, len( chunk.distributions[2].energies ) )
            self.assertEqual( 3, len( chunk.distributions[2].values ) )
            self.assertEqual( 2, len( chunk.distributions[3].energies ) )
            self.assertEqual( 2, len( chunk.distributions[3].values ) )
            self.assertAlmostEqual( 0.  , chunk.distributions[0].energies[0] )
            self.assertAlmostEqual( 4.  , chunk.distributions[0].energies[1] )
            self.assertAlmostEqual( 0.5 , chunk.distributions[0].values[0] )
            self.assertAlmostEqual( 0.5 , chunk.distributions[0].values[1] )
            self.assertAlmostEqual( 0.  , chunk.distributions[1].energies[0] )
            self.assertAlmostEqual( 1.  , chunk.distributions[1].energies[1] )
            self.assertAlmostEqual( 4.  , chunk.distributions[1].energies[2] )
            self.assertAlmostEqual( 0.49, chunk.distributions[1].values[0] )
            self.assertAlmostEqual( 0.5 , chunk.distributions[1].values[1] )
            self.assertAlmostEqual( 0.51, chunk.distributions[1].values[2] )
            self.assertAlmostEqual( 0.  , chunk.distributions[2].energies[0] )
            self.assertAlmostEqual( 2.  , chunk.distributions[2].energies[1] )
            self.assertAlmostEqual( 4.  , chunk.distributions[2].energies[2] )
            self.assertAlmostEqual( 0.4 , chunk.distributions[2].values[0] )
            self.assertAlmostEqual( 0.5 , chunk.distributions[2].values[1] )
            self.assertAlmostEqual( 0.6 , chunk.distributions[2].values[2] )
            self.assertAlmostEqual( 0.  , chunk.distributions[3].energies[0] )
            self.assertAlmostEqual( 4.  , chunk.distributions[3].energies[1] )
            self.assertAlmostEqual( 0.1 , chunk.distributions[3].values[0] )
            self.assertAlmostEqual( 0.9 , chunk.distributions[3].values[1] )
