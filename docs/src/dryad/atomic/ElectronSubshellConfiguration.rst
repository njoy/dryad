...
.. autosummary::
    ...
    ElectronSubshellConfiguration.binding_energy
    ElectronSubshellConfiguration.population
    ElectronSubshellConfiguration.radiative_transitions
    ElectronSubshellConfiguration.non_radiative_transitions
