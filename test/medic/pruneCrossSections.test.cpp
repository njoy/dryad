...
void verifyChunk( const ProjectileTarget& chunk ) {
  ...
  CHECK_THAT(    4., WithinRel( reaction.crossSection().energies()[0] ) );
  ...
  CHECK_THAT(  4., WithinRel( reaction.crossSection().energies()[0] ) );
  CHECK_THAT( 20., WithinRel( reaction.crossSection().energies()[1] ) );
  CHECK_THAT( 2.00001 / 19. * 3., WithinRel( reaction.crossSection().values()[0] ) );
  ...
  CHECK_THAT(  4., WithinRel( reaction.crossSection().energies()[0] ) );
  CHECK_THAT( 20., WithinRel( reaction.crossSection().energies()[1] ) );
  CHECK_THAT( 3. / 19., WithinRel( reaction.crossSection().values()[0] ) );
