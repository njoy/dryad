...
SCENARIO( "Channel" ) {
  ...
  GIVEN( "valid data for a Channel" ) {
    ...
    id::ChannelID protonEmissionID( "n,Cl35->p,S35{0,1,1+}" );
    ...
    id::ReactionID protonEmissionRID( "n,Cl35->p,S35" );
    ...
    ChannelQuantumNumbers protonEmissionNumbers( 0, 1, 1, +1 );
    ...
    Particle s36( id::ParticleID( "S35" ), 34.9690307578, 1.5, +1 );
    ...
    double captureQ = 0.0;
    double protonEmissionQ = 6.150729e+5;
    ...
    std::optional< double > protonEmissionBoundary = std::nullopt;

    // channel radii
    ChannelRadii elasticRadii( 4.822220, 3.667980 );
    ChannelRadii inelasticRadii( 4.822220, 3.667980 );
    ChannelRadii captureRadii( 0. );
    ChannelRadii protonEmissionRadii( 4.822220, 3.667980 );

    THEN( "a Channel can be constructed from numbers" ) {
