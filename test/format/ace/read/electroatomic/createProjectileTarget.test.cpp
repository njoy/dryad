  ...
  GIVEN( "instances of PhotoatomicTable" ) {
    ...
    WHEN( "an eprdata12 formatted table is given" ) {
      ...
      THEN( "a ProjectileTarget can be derived" ) {
        ...
        ProjectileTarget H0 = ace::read::electroatomic::createProjectileTarget( table, false );
        ...
        electroatomic::eprdata12::h::verifyParticleDatabase( H0.particleData().value() );
...
//        CHECK( false == H0.hasReaction( id::ReactionID( "some unknown reaction" ) ) );
    ...
    WHEN( "an eprdata14 formatted table is given" ) {
      ...
      THEN( "a ProjectileTarget can be derived" ) {
        ...
        CHECK( std::nullopt != H0.particleData() );
        electroatomic::eprdata14::h::verifyParticleDatabase( H0.particleData().value() );
