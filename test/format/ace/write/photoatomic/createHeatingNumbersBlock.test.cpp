  ...
  GIVEN( "instances of ProjectileTarget and AtomicRelaxation with z < 12" ) {
    ...
    WHEN( "correct data is given" ) {
      ...
      THEN( "the ace block can be generated" ) {
        ...
        CHECK_THAT( 5.66951513548201e-14, WithinRel( block.heating()[0], 5e-9 ) );
        ...
        CHECK_THAT( 9.99907803034981e+04, WithinRel( block.heating()[2020], 5e-11 ) );
      } // THEN
    } // WHEN
  } // GIVEN
  ...
  GIVEN( "instances of ProjectileTarget and AtomicRelaxation with z >= 12 and z < 31" ) {
    ...
    WHEN( "correct data is given" ) {
      ...
      THEN( "the ace block can be generated" ) {
        ...
        CHECK_THAT( 7.59986547084122e-14, WithinRel( block.heating()[0], 5e-9 ) );
        ...
        CHECK_THAT( 9.99981976231828e+04, WithinRel( block.heating()[7313], 1e-12 ) );
      } // THEN
    } // WHEN
  } // GIVEN
  ...
  GIVEN( "instances of ProjectileTarget and AtomicRelaxation with z >= 31 and z < 36" ) {
    ...
    WHEN( "correct data is given" ) {
      ...
      THEN( "the ace block can be generated" ) {
        ...
        CHECK_THAT( 2.78376701970445e-14, WithinRel( block.heating()[0], 5e-9 ) );
        ...
        CHECK_THAT( 9.99982594042480e+04, WithinRel( block.heating()[8512], 1e-12 ) );
      } // THEN
    } // WHEN
  } // GIVEN
  ...
  GIVEN( "instances of ProjectileTarget and AtomicRelaxation with z >= 37" ) {
    ...
    WHEN( "correct data is given" ) {
      ...
      THEN( "the ace block can be generated" ) {
        ...
        CHECK_THAT( 6.18306127716396e-14, WithinRel( block.heating()[0], 5e-9 ) );
        ...
        CHECK_THAT( 9.99986706059987e+04, WithinRel( block.heating()[12395], 1e-12 ) );
      } // THEN
    } // WHEN
  } // GIVEN
} // SCENARIO
