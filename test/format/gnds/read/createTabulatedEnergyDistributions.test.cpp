...
SCENARIO( "createTabulatedEnergyDistributions" ) {
  ...
  GIVEN( "GNDS tabulated angular data" ) {
    ...
    WHEN( "a single two body data node is given" ) {
      ...
      THEN( "it can be converted" ) {
        ...
        auto chunk1 = gnds::read::createTabulatedEnergyDistributions( xys2d, false );
        auto chunk2 = gnds::read::createTabulatedEnergyDistributions( xys2d, true );
