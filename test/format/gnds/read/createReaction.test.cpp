  ...
  GIVEN( "GNDS data - incident neutrons - stable target" ) {
    ...
    WHEN( "a single GNDS reaction data node is given" ) {
      ...
      THEN( "a Reaction can be created" ) {
        ...
        Reaction total1 = gnds::read::createReaction( projectile, target, suite, node, false );
        Reaction total2 = gnds::read::createReaction( projectile, target, suite, node, true );
        ...
        Reaction elastic1 = gnds::read::createReaction( projectile, target, suite, node, false );
        Reaction elastic2 = gnds::read::createReaction( projectile, target, suite, node, true );
        ...
        Reaction capture1 = gnds::read::createReaction( projectile, target, suite, node, false );
        Reaction capture2 = gnds::read::createReaction( projectile, target, suite, node, true );
  ...
  GIVEN( "GNDS data - incident neutrons - metastable target" ) {
    ...
    WHEN( "a single GNDS reaction data node is given" ) {
      ...
      THEN( "a Reaction can be created" ) {
        ...
        Reaction inelastic01 = gnds::read::createReaction( projectile, target, suite, node, false );
        Reaction inelastic02 = gnds::read::createReaction( projectile, target, suite, node, true );
        ...
        Reaction inelastic1 = gnds::read::createReaction( projectile, target, suite, node, false );
        Reaction inelastic2 = gnds::read::createReaction( projectile, target, suite, node, true );
  ...
  GIVEN( "GNDS data - electro-atomic" ) {
    ...
    WHEN( "a single GNDS reaction data node is given" ) {
      ...
      THEN( "a Reaction can be created" ) {
        ...
        Reaction ionisation1 = gnds::read::createReaction( projectile, target, suite, node, false );
        Reaction ionisation2 = gnds::read::createReaction( projectile, target, suite, node, true );
        ...
        Reaction telastic1 = gnds::read::createReaction( projectile, target, suite, node, false );
        Reaction telastic2 = gnds::read::createReaction( projectile, target, suite, node, true );
        electron::h0::verifyTotalElasticReaction( telastic1 );
        electron::h0::verifyTotalElasticReaction( telastic1 );

        node = reactions.find_child_by_attribute( "reaction", "ENDF_MT", "527" );
        Reaction bremsstrahlung1 = gnds::read::createReaction( projectile, target, suite, node, false );
        Reaction bremsstrahlung2 = gnds::read::createReaction( projectile, target, suite, node, true );
        ...
        Reaction excitation1 = gnds::read::createReaction( projectile, target, suite, node, false );
        Reaction excitation2 = gnds::read::createReaction( projectile, target, suite, node, true );
        ...
        Reaction subionisation1 = gnds::read::createReaction( projectile, target, suite, node, false );
        Reaction subionisation2 = gnds::read::createReaction( projectile, target, suite, node, true );
  ...
  GIVEN( "GNDS data - photo-atomic" ) {
    ...
    WHEN( "a single GNDS reaction data node is given" ) {
      ...
      THEN( "a Reaction can be created" ) {
        ...
        Reaction coherent1 = gnds::read::createReaction( projectile, target, suite, node, false );
        Reaction coherent2 = gnds::read::createReaction( projectile, target, suite, node, true );
        ...
        Reaction incoherent1 = gnds::read::createReaction( projectile, target, suite, node, false );
        Reaction incoherent2 = gnds::read::createReaction( projectile, target, suite, node, true );
        ...
        Reaction epairproduction1 = gnds::read::createReaction( projectile, target, suite, node, false );
        Reaction epairproduction2 = gnds::read::createReaction( projectile, target, suite, node, true );
        ...
        Reaction tpairproduction1 = gnds::read::createReaction( projectile, target, suite, node, false );
        Reaction tpairproduction2 = gnds::read::createReaction( projectile, target, suite, node, true );
        ...
        Reaction npairproduction1 = gnds::read::createReaction( projectile, target, suite, node, false );
        Reaction npairproduction2 = gnds::read::createReaction( projectile, target, suite, node, true );
        ...
        node = sums.find_child_by_attribute( "crossSectionSum", "ENDF_MT", "522" );
        Reaction tionisation1 = gnds::read::createReaction( projectile, target, suite, node, false );
        Reaction tionisation2 = gnds::read::createReaction( projectile, target, suite, node, true );
