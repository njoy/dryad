...
namespace zrinzrh {
  ...
  void verifyDocumentation( const Documentation& documentation ) {
    ...
    CHECK( description == documentation.description().value() );
  }
  ...
  void verifyIncoherentInelastic( const std::optional< njoy::dryad::thermal::IncoherentInelasticScattering >& inelastic ) {
    ...
    CHECK_THAT( 6.33787160831, WithinRel( inelastic->boundCrossSection() ) );
    CHECK_THAT( 91.2196203199 / 1.00866491574, WithinRel( inelastic->atomicWeightRatio() ) );
