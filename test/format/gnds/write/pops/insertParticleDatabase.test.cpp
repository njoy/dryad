  ...
  GIVEN( "a parent node and a particle database" ) {
    ...
    THEN( "a particle database can be inserted for typical nuclear interactions" ) {
      ...
      std::vector< id::ParticleID > identifiers = {
        ...
        id::ParticleID( "H2[all]" ),  id::ParticleID( "Li6[continuum]" ),
...
std::string chunkNuclear() {
  ...
  return "<PoPs name=\"particles\" version=\"1.0\" format=\"2.1\">\n"
         ...
         "                <mass>\n"
         "                  <double label=\"eval\" value=\"2.013553212544\" unit=\"amu\">\n"
         "                    <uncertainty>\n"
         "                      <standard>\n"
         "                        <double value=\"1.5e-11\" />\n"
         "                      </standard>\n"
         ...
         "                <mass>\n"
         "                  <double label=\"eval\" value=\"3.01550071597\" unit=\"amu\">\n"
         "                    <uncertainty>\n"
         "                      <standard>\n"
         "                        <double value=\"1e-10\" />\n"
         "                      </standard>\n"
         ...
         "                <mass>\n"
         "                  <double label=\"eval\" value=\"3.014932246932\" unit=\"amu\">\n"
         "                    <uncertainty>\n"
         "                      <standard>\n"
         "                        <double value=\"7.4e-11\" />\n"
         "                      </standard>\n"
         "                    </uncertainty>\n"
         "                  </double>\n"
         "                </mass>\n"
         ...
         "                <mass>\n"
         "                  <double label=\"eval\" value=\"4.001506179129\" unit=\"amu\">\n"
         "                    <uncertainty>\n"
         "                      <standard>\n"
         "                        <double value=\"6.2e-11\" />\n"
         "                      </standard>\n"
         "                    </uncertainty>\n"
         "                  </double>\n"
         "                </mass>\n"
