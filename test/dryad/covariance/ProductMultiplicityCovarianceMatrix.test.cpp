...
SCENARIO( "CovarianceMatrix" ) {
  ...
  GIVEN( "valid covariance data for product multiplicities" ) {
    ...
    THEN( "a CovarianceMatrix can be constructed and members can be tested" ) {
      ...
      CHECK_THAT(  1.074034990154796e-01, WithinRel( chunk.eigenvectors().value()[0](0) ) );
      CHECK_THAT(  5.031741433412550e-02, WithinRel( chunk.eigenvectors().value()[0](1) ) );
      CHECK_THAT(  6.760345784347225e-01, WithinRel( chunk.eigenvectors().value()[0](2) ) );
      CHECK_THAT(  1.915401875474548e-04, WithinRel( chunk.eigenvectors().value()[0](3) ) );
      CHECK_THAT(  1.372508574710749e-01, WithinRel( chunk.eigenvectors().value()[0](4) ) );
      CHECK_THAT(  1.393826996793074e-01, WithinRel( chunk.eigenvectors().value()[0](5) ) );
      CHECK_THAT(  7.004601426407556e-01, WithinRel( chunk.eigenvectors().value()[0](6) ) );
      CHECK_THAT( -3.346821750524192e-04, WithinRel( chunk.eigenvectors().value()[0](7) ) );
      CHECK_THAT( -2.571527009424175e-01, WithinRel( chunk.eigenvectors().value()[1](0) ) );
      CHECK_THAT( -5.332339693289101e-01, WithinRel( chunk.eigenvectors().value()[1](1) ) );
      CHECK_THAT( -4.136479111214138e-01, WithinRel( chunk.eigenvectors().value()[1](2) ) );
      CHECK_THAT(  1.106338368001530e-03, WithinRel( chunk.eigenvectors().value()[1](3) ) );
      CHECK_THAT( -1.004221706751696e-01, WithinRel( chunk.eigenvectors().value()[1](4) ) );
      CHECK_THAT( -3.764142026504751e-01, WithinRel( chunk.eigenvectors().value()[1](5) ) );
      CHECK_THAT(  5.715373399614007e-01, WithinRel( chunk.eigenvectors().value()[1](6) ) );
      CHECK_THAT(  1.004341476548398e-03, WithinRel( chunk.eigenvectors().value()[1](7) ) );
      CHECK_THAT(  1.371275274983361e-01, WithinRel( chunk.eigenvectors().value()[2](0) ) );
      CHECK_THAT( -8.140382248203513e-01, WithinRel( chunk.eigenvectors().value()[2](1) ) );
      CHECK_THAT(  2.691481835902044e-01, WithinRel( chunk.eigenvectors().value()[2](2) ) );
      CHECK_THAT( -3.231353088691460e-03, WithinRel( chunk.eigenvectors().value()[2](3) ) );
      CHECK_THAT(  3.273381875688864e-01, WithinRel( chunk.eigenvectors().value()[2](4) ) );
      CHECK_THAT(  1.854210583626488e-01, WithinRel( chunk.eigenvectors().value()[2](5) ) );
      CHECK_THAT( -3.233486103311739e-01, WithinRel( chunk.eigenvectors().value()[2](6) ) );
      ...
      CHECK_THAT( -3.768700535852441e-02, WithinRel( chunk.eigenvectors().value()[3](1) ) );
      CHECK_THAT( -2.313850741112828e-01, WithinRel( chunk.eigenvectors().value()[3](2) ) );
      CHECK_THAT(  9.976800706566397e-03, WithinRel( chunk.eigenvectors().value()[3](3) ) );
      CHECK_THAT( -5.343662614796370e-02, WithinRel( chunk.eigenvectors().value()[3](4) ) );
      CHECK_THAT(  8.447798233267908e-01, WithinRel( chunk.eigenvectors().value()[3](5) ) );
      CHECK_THAT(  1.385291026888882e-01, WithinRel( chunk.eigenvectors().value()[3](6) ) );
      CHECK_THAT( -1.446040223355744e-03, WithinRel( chunk.eigenvectors().value()[3](7) ) );
      CHECK_THAT( -5.439389015604769e-01, WithinRel( chunk.eigenvectors().value()[4](0) ) );
      CHECK_THAT(  1.996774457251580e-01, WithinRel( chunk.eigenvectors().value()[4](1) ) );
      CHECK_THAT(  1.639440644799666e-02, WithinRel( chunk.eigenvectors().value()[4](2) ) );
      CHECK_THAT( -5.814555639788057e-03, WithinRel( chunk.eigenvectors().value()[4](3) ) );
      CHECK_THAT(  7.818950572395391e-01, WithinRel( chunk.eigenvectors().value()[4](4) ) );
      CHECK_THAT( -2.224672713971068e-01, WithinRel( chunk.eigenvectors().value()[4](5) ) );
      CHECK_THAT( -5.569982161307497e-02, WithinRel( chunk.eigenvectors().value()[4](6) ) );
      CHECK_THAT(  1.663102992474408e-03, WithinRel( chunk.eigenvectors().value()[4](7) ) );
      CHECK_THAT( -1.752926246655574e-04, WithinRel( chunk.eigenvectors().value()[5](0) ) );
      CHECK_THAT(  8.279317505192949e-04, WithinRel( chunk.eigenvectors().value()[5](1) ) );
      CHECK_THAT( -1.518618778550783e-03, WithinRel( chunk.eigenvectors().value()[5](2) ) );
      CHECK_THAT( -1.096637382643716e-01, WithinRel( chunk.eigenvectors().value()[5](3) ) );
      CHECK_THAT(  7.862304135582416e-04, WithinRel( chunk.eigenvectors().value()[5](4) ) );
      CHECK_THAT( -9.998834737042516e-04, WithinRel( chunk.eigenvectors().value()[5](5) ) );
      CHECK_THAT(  1.033041611015811e-03, WithinRel( chunk.eigenvectors().value()[5](6) ) );
      CHECK_THAT( -9.939658731607474e-01, WithinRel( chunk.eigenvectors().value()[5](7) ) );
      CHECK_THAT(  1.322444642228740e-02, WithinRel( chunk.eigenvectors().value()[6](0) ) );
      CHECK_THAT(  1.263506076818510e-03, WithinRel( chunk.eigenvectors().value()[6](1) ) );
      CHECK_THAT( -5.277719337954416e-03, WithinRel( chunk.eigenvectors().value()[6](2) ) );
      CHECK_THAT(  9.937414417323501e-01, WithinRel( chunk.eigenvectors().value()[6](3) ) );
      CHECK_THAT(  1.515135480819192e-02, WithinRel( chunk.eigenvectors().value()[6](4) ) );
      CHECK_THAT( -5.315067279801203e-03, WithinRel( chunk.eigenvectors().value()[6](5) ) );
      CHECK_THAT(  7.398811740866554e-04, WithinRel( chunk.eigenvectors().value()[6](6) ) );
      CHECK_THAT( -1.096140926827119e-01, WithinRel( chunk.eigenvectors().value()[6](7) ) );
      CHECK_THAT(  6.310691708068932e-01, WithinRel( chunk.eigenvectors().value()[7](0) ) );
      CHECK_THAT(  9.580076031528753e-02, WithinRel( chunk.eigenvectors().value()[7](1) ) );
      CHECK_THAT( -4.955743335231361e-01, WithinRel( chunk.eigenvectors().value()[7](2) ) );
      CHECK_THAT( -1.751466725221130e-02, WithinRel( chunk.eigenvectors().value()[7](3) ) );
      CHECK_THAT(  4.994814966132097e-01, WithinRel( chunk.eigenvectors().value()[7](4) ) );
      CHECK_THAT(  2.032977022465391e-01, WithinRel( chunk.eigenvectors().value()[7](5) ) );
      CHECK_THAT(  2.363301436122759e-01, WithinRel( chunk.eigenvectors().value()[7](6) ) );
      CHECK_THAT(  3.094250598081331e-03, WithinRel( chunk.eigenvectors().value()[7](7) ) );
    } // THEN
  } // GIVEN
