...
SCENARIO( "TabulatedDebyeWallerIntegral" ) {
  ...
  GIVEN( "linearised data without boundaries and no jumps" ) {
    ...
    WHEN( "the data is given explicitly" ) {
      ...
      TabulatedDebyeWallerIntegral chunk( std::move( temperatures ), std::move( values ) );

      THEN( "a TabulatedDebyeWallerIntegral can be constructed and members can be tested" ) {

        CHECK_THAT( 1., WithinRel( chunk.lowerTemperatureLimit() ) );
        CHECK_THAT( 4., WithinRel( chunk.upperTemperatureLimit() ) );
      ...
      THEN( "a TabulatedDebyeWallerIntegral can be evaluated" ) {
      ...
      THEN( "arithmetic operations can be performed" ) {
        ...
        TabulatedDebyeWallerIntegral result( { 1., 4. }, { 0., 0. } );
        TabulatedDebyeWallerIntegral same( { 1., 4. }, { 0., 3. } );
        TabulatedDebyeWallerIntegral threshold( { 2., 4. }, { 0., 2. } );
        TabulatedDebyeWallerIntegral nonzerothreshold( { 2., 4. }, { 1., 3. } );
        TabulatedDebyeWallerIntegral small( { 1., 3. }, { 0., 2. } );
        ...
        CHECK( 4 == result.temperatures().size() );
        CHECK( 4 == result.values().size() );
        CHECK( 1 == result.boundaries().size() );
        CHECK( 1 == result.interpolants().size() );
        CHECK_THAT(  1., WithinRel( result.temperatures()[0] ) );
        CHECK_THAT(  2., WithinRel( result.temperatures()[1] ) );
        CHECK_THAT(  3., WithinRel( result.temperatures()[2] ) );
        CHECK_THAT(  4., WithinRel( result.temperatures()[3] ) );
        ...
        CHECK( 5 == result.temperatures().size() );
        CHECK( 5 == result.values().size() );
        CHECK( 2 == result.boundaries().size() );
        CHECK( 2 == result.interpolants().size() );
        CHECK_THAT( 1., WithinRel( result.temperatures()[0] ) );
        CHECK_THAT( 2., WithinRel( result.temperatures()[1] ) );
        CHECK_THAT( 2., WithinRel( result.temperatures()[2] ) );
        CHECK_THAT( 3., WithinRel( result.temperatures()[3] ) );
        CHECK_THAT( 4., WithinRel( result.temperatures()[4] ) );
        CHECK_THAT( 4., WithinRel( result.values()[0] ) );
        CHECK_THAT( 3., WithinRel( result.values()[1] ) );
        CHECK_THAT( 4., WithinRel( result.values()[2] ) );
      ...
      THEN( "a TabulatedDebyeWallerIntegral can be linearised" ) {

        TabulatedDebyeWallerIntegral linear = chunk.linearise();

        CHECK( 4 == linear.numberPoints() );
        CHECK( 1 == linear.numberRegions() );

        CHECK( 4 == linear.temperatures().size() );
        ...
        CHECK_THAT( 1., WithinRel( linear.temperatures()[0] ) );
        CHECK_THAT( 2., WithinRel( linear.temperatures()[1] ) );
        CHECK_THAT( 3., WithinRel( linear.temperatures()[2] ) );
        CHECK_THAT( 4., WithinRel( linear.temperatures()[3] ) );
  ...
  GIVEN( "linearised data without boundaries and a jump" ) {
    ...
    WHEN( "the data is given explicitly" ) {
      ...
      THEN( "arithmetic operations can be performed" ) {
        ...
        TabulatedDebyeWallerIntegral same( { 1., 4. }, { 0., 3. } );
        TabulatedDebyeWallerIntegral threshold( { 2., 4. }, { 0., 2. } );
        TabulatedDebyeWallerIntegral nonzerothreshold( { 3., 4. }, { 1., 2. } );
        TabulatedDebyeWallerIntegral small( { 1., 3. }, { 0., 2. } );
        ...
        CHECK( 6 == chunk.temperatures().size() );
        ...
        CHECK_THAT( 2., WithinRel( chunk.temperatures()[2] ) );
        CHECK_THAT( 3., WithinRel( chunk.temperatures()[3] ) );
        CHECK_THAT( 3., WithinRel( chunk.temperatures()[4] ) );
        CHECK_THAT( 4., WithinRel( chunk.temperatures()[5] ) );
        CHECK_THAT( 4., WithinRel( chunk.values()[0] ) );
        CHECK_THAT( 3., WithinRel( chunk.values()[1] ) );
        CHECK_THAT( 4., WithinRel( chunk.values()[2] ) );
        CHECK_THAT( 3., WithinRel( chunk.values()[3] ) );
        ...
        CHECK( 6 == result.temperatures().size() );
        ...
        CHECK_THAT( 2., WithinRel( result.temperatures()[2] ) );
        CHECK_THAT( 3., WithinRel( result.temperatures()[3] ) );
        CHECK_THAT( 3., WithinRel( result.temperatures()[4] ) );
        CHECK_THAT( 4., WithinRel( result.temperatures()[5] ) );
        CHECK_THAT( 4., WithinRel( result.values()[0] ) );
        CHECK_THAT( 3., WithinRel( result.values()[1] ) );
        CHECK_THAT( 4., WithinRel( result.values()[2] ) );
        CHECK_THAT( 3., WithinRel( result.values()[3] ) );
      ...
      THEN( "a TabulatedDebyeWallerIntegral can be linearised" ) {
        ...
        CHECK( 5 == linear.temperatures().size() );
        ...
        CHECK_THAT( 1., WithinRel( linear.temperatures()[0] ) );
        CHECK_THAT( 2., WithinRel( linear.temperatures()[1] ) );
        CHECK_THAT( 2., WithinRel( linear.temperatures()[2] ) );
        CHECK_THAT( 3., WithinRel( linear.temperatures()[3] ) );
        CHECK_THAT( 4., WithinRel( linear.temperatures()[4] ) );
  ...
  GIVEN( "non-linearised data with multiple regions without a jump" ) {
    ...
    WHEN( "the data is given explicitly" ) {
      ...
      TabulatedDebyeWallerIntegral chunk( std::move( temperatures ),
                                   std::move( values ),
                                   std::move( boundaries ),
      ...
      THEN( "some arithmetic operations cannot be performed" ) {
        ...
        TabulatedDebyeWallerIntegral result( { 1., 4. }, { 0., 0. } );
        TabulatedDebyeWallerIntegral right( { 1., 4. }, { 0., 0. } );
      ...
      THEN( "a TabulatedDebyeWallerIntegral can be linearised" ) {
        ...
        CHECK( 18 == linear.temperatures().size() );
        ...
        CHECK_THAT( 1.   , WithinRel( linear.temperatures()[0] ) );
        CHECK_THAT( 2.   , WithinRel( linear.temperatures()[1] ) );
        CHECK_THAT( 2.125, WithinRel( linear.temperatures()[2] ) );
        CHECK_THAT( 2.25 , WithinRel( linear.temperatures()[3] ) );
        CHECK_THAT( 2.375, WithinRel( linear.temperatures()[4] ) );
        CHECK_THAT( 2.5  , WithinRel( linear.temperatures()[5] ) );
        CHECK_THAT( 2.625, WithinRel( linear.temperatures()[6] ) );
        CHECK_THAT( 2.75 , WithinRel( linear.temperatures()[7] ) );
        CHECK_THAT( 2.875, WithinRel( linear.temperatures()[8] ) );
        CHECK_THAT( 3.   , WithinRel( linear.temperatures()[9] ) );
        CHECK_THAT( 3.125, WithinRel( linear.temperatures()[10] ) );
        CHECK_THAT( 3.25 , WithinRel( linear.temperatures()[11] ) );
        CHECK_THAT( 3.375, WithinRel( linear.temperatures()[12] ) );
        CHECK_THAT( 3.5  , WithinRel( linear.temperatures()[13] ) );
        CHECK_THAT( 3.625, WithinRel( linear.temperatures()[14] ) );
        CHECK_THAT( 3.75 , WithinRel( linear.temperatures()[15] ) );
        CHECK_THAT( 3.875, WithinRel( linear.temperatures()[16] ) );
        CHECK_THAT( 4.   , WithinRel( linear.temperatures()[17] ) );
  ...
  GIVEN( "non-linearised data with multiple regions with a jump" ) {
    ...
    WHEN( "the data is given explicitly" ) {
      ...
      THEN( "a TabulatedDebyeWallerIntegral can be linearised" ) {
        ...
        CHECK( 12 == linear.temperatures().size() );
        ...
        CHECK_THAT( 2.   , WithinRel( linear.temperatures()[1] ) );
        CHECK_THAT( 2.   , WithinRel( linear.temperatures()[2] ) );
        CHECK_THAT( 2.125, WithinRel( linear.temperatures()[3] ) );
        CHECK_THAT( 2.25 , WithinRel( linear.temperatures()[4] ) );
        CHECK_THAT( 2.5  , WithinRel( linear.temperatures()[5] ) );
        CHECK_THAT( 2.75 , WithinRel( linear.temperatures()[6] ) );
        CHECK_THAT( 3.   , WithinRel( linear.temperatures()[7] ) );
        CHECK_THAT( 3.25 , WithinRel( linear.temperatures()[8] ) );
        CHECK_THAT( 3.5  , WithinRel( linear.temperatures()[9] ) );
        CHECK_THAT( 3.75 , WithinRel( linear.temperatures()[10] ) );
        CHECK_THAT( 4.   , WithinRel( linear.temperatures()[11] ) );
  ...
  GIVEN( "non-linearised data with multiple regions with a jump at the end that goes to zero" ) {
    ...
    WHEN( "the data is given explicitly" ) {
      ...
      THEN( "an TabulatedDebyeWallerIntegral can be constructed and members can be tested" ) {
        ...
        CHECK_THAT( 2., WithinRel( chunk.temperatures()[1] ) );
        CHECK_THAT( 3., WithinRel( chunk.temperatures()[2] ) );
        CHECK_THAT( 4., WithinRel( chunk.temperatures()[3] ) ); // <-- last point removed
        CHECK_THAT( 4., WithinRel( chunk.values()[0] ) );
        CHECK_THAT( 3., WithinRel( chunk.values()[1] ) );
        CHECK_THAT( 2., WithinRel( chunk.values()[2] ) );
  ...
  GIVEN( "comparison operators" ) {
    ...
    WHEN( "two instances of TabulatedDebyeWallerIntegral are given" ) {

      TabulatedDebyeWallerIntegral left( { 1., 2., 3., 4. }, { 4., 3., 2., 1. } );
      TabulatedDebyeWallerIntegral equal( { 1., 2., 3., 4. }, { 4., 3., 2., 1. } );
      TabulatedDebyeWallerIntegral different( { 1., 4. }, { 4., 1. } );
  ...
  GIVEN( "invalid data for an TabulatedDebyeWallerIntegral object" ) {
    ...
    WHEN( "there are not enough values in the x or y grid" ) {
      ...
      THEN( "an exception is thrown" ) {
        ...
        CHECK_THROWS( TabulatedDebyeWallerIntegral( empty, empty ) );
        CHECK_THROWS( TabulatedDebyeWallerIntegral( one, one ) );
      } // THEN
    } // WHEN
