  ...
  GIVEN( "linearised data without boundaries and no jumps" ) {
    ...
    WHEN( "the data is given explicitly" ) {
      ...
      THEN( "a TabulatedScatteringKernelFunction can be constructed and members can be tested" ) {
        ...
        CHECK( 4 == chunk.momentumTransfers().size() );
        CHECK( 4 == chunk.values().size() );
        CHECK( 1 == chunk.boundaries().size() );
        CHECK( 1 == chunk.interpolants().size() );
        CHECK_THAT( 1., WithinRel( chunk.momentumTransfers()[0] ) );
        CHECK_THAT( 2., WithinRel( chunk.momentumTransfers()[1] ) );
        CHECK_THAT( 3., WithinRel( chunk.momentumTransfers()[2] ) );
        CHECK_THAT( 4., WithinRel( chunk.momentumTransfers()[3] ) );
      ...
      THEN( "arithmetic operations can be performed" ) {
        ...
        CHECK( 4 == result.momentumTransfers().size() );
        CHECK( 4 == result.values().size() );
        CHECK( 1 == result.boundaries().size() );
        CHECK( 1 == result.interpolants().size() );
        CHECK_THAT(  1., WithinRel( result.momentumTransfers()[0] ) );
        CHECK_THAT(  2., WithinRel( result.momentumTransfers()[1] ) );
        CHECK_THAT(  3., WithinRel( result.momentumTransfers()[2] ) );
        CHECK_THAT(  4., WithinRel( result.momentumTransfers()[3] ) );
        ...
        CHECK_THAT( 1., WithinRel( chunk.momentumTransfers()[0] ) );
        CHECK_THAT( 2., WithinRel( chunk.momentumTransfers()[1] ) );
        CHECK_THAT( 2., WithinRel( chunk.momentumTransfers()[2] ) );
        CHECK_THAT( 3., WithinRel( chunk.momentumTransfers()[3] ) );
        CHECK_THAT( 4., WithinRel( chunk.momentumTransfers()[4] ) );
        CHECK_THAT( 4., WithinRel( chunk.values()[0] ) );
        CHECK_THAT( 3., WithinRel( chunk.values()[1] ) );
        CHECK_THAT( 4., WithinRel( chunk.values()[2] ) );
        ...
        CHECK( 5 == result.momentumTransfers().size() );
        CHECK( 5 == result.values().size() );
        CHECK( 2 == result.boundaries().size() );
        CHECK( 2 == result.interpolants().size() );
        CHECK_THAT( 1., WithinRel( result.momentumTransfers()[0] ) );
        CHECK_THAT( 2., WithinRel( result.momentumTransfers()[1] ) );
        CHECK_THAT( 2., WithinRel( result.momentumTransfers()[2] ) );
        CHECK_THAT( 3., WithinRel( result.momentumTransfers()[3] ) );
        CHECK_THAT( 4., WithinRel( result.momentumTransfers()[4] ) );
        CHECK_THAT( 4., WithinRel( result.values()[0] ) );
        CHECK_THAT( 3., WithinRel( result.values()[1] ) );
        CHECK_THAT( 4., WithinRel( result.values()[2] ) );
      ...
      THEN( "a TabulatedScatteringKernelFunction can be linearised" ) {
        ...
        CHECK( 4 == linear.momentumTransfers().size() );
        ...
        CHECK_THAT( 1., WithinRel( linear.momentumTransfers()[0] ) );
        CHECK_THAT( 2., WithinRel( linear.momentumTransfers()[1] ) );
        CHECK_THAT( 3., WithinRel( linear.momentumTransfers()[2] ) );
        CHECK_THAT( 4., WithinRel( linear.momentumTransfers()[3] ) );
  ...
  GIVEN( "linearised data without boundaries and a jump" ) {
    ...
    WHEN( "the data is given explicitly" ) {
      ...
      THEN( "arithmetic operations can be performed" ) {
        ...
        CHECK( 6 == chunk.momentumTransfers().size() );
        ...
        CHECK_THAT( 2., WithinRel( chunk.momentumTransfers()[2] ) );
        CHECK_THAT( 3., WithinRel( chunk.momentumTransfers()[3] ) );
        CHECK_THAT( 3., WithinRel( chunk.momentumTransfers()[4] ) );
        CHECK_THAT( 4., WithinRel( chunk.momentumTransfers()[5] ) );
        CHECK_THAT( 4., WithinRel( chunk.values()[0] ) );
        CHECK_THAT( 3., WithinRel( chunk.values()[1] ) );
        CHECK_THAT( 4., WithinRel( chunk.values()[2] ) );
        CHECK_THAT( 3., WithinRel( chunk.values()[3] ) );
        ...
        CHECK( 6 == result.momentumTransfers().size() );
        ...
        CHECK_THAT( 2., WithinRel( result.momentumTransfers()[2] ) );
        CHECK_THAT( 3., WithinRel( result.momentumTransfers()[3] ) );
        CHECK_THAT( 3., WithinRel( result.momentumTransfers()[4] ) );
        CHECK_THAT( 4., WithinRel( result.momentumTransfers()[5] ) );
        CHECK_THAT( 4., WithinRel( result.values()[0] ) );
        CHECK_THAT( 3., WithinRel( result.values()[1] ) );
        CHECK_THAT( 4., WithinRel( result.values()[2] ) );
        CHECK_THAT( 3., WithinRel( result.values()[3] ) );
      ...
      THEN( "a TabulatedScatteringKernelFunction can be linearised" ) {
        ...
        CHECK( 5 == linear.momentumTransfers().size() );
        ...
        CHECK_THAT( 1., WithinRel( linear.momentumTransfers()[0] ) );
        CHECK_THAT( 2., WithinRel( linear.momentumTransfers()[1] ) );
        CHECK_THAT( 2., WithinRel( linear.momentumTransfers()[2] ) );
        CHECK_THAT( 3., WithinRel( linear.momentumTransfers()[3] ) );
        CHECK_THAT( 4., WithinRel( linear.momentumTransfers()[4] ) );
  ...
  GIVEN( "non-linearised data with multiple regions without a jump" ) {
    ...
    WHEN( "the data is given explicitly" ) {
      ...
      THEN( "a TabulatedScatteringKernelFunction can be linearised" ) {
        ...
        CHECK( 18 == linear.momentumTransfers().size() );
        ...
        CHECK_THAT( 1.   , WithinRel( linear.momentumTransfers()[0] ) );
        CHECK_THAT( 2.   , WithinRel( linear.momentumTransfers()[1] ) );
        CHECK_THAT( 2.125, WithinRel( linear.momentumTransfers()[2] ) );
        CHECK_THAT( 2.25 , WithinRel( linear.momentumTransfers()[3] ) );
        CHECK_THAT( 2.375, WithinRel( linear.momentumTransfers()[4] ) );
        CHECK_THAT( 2.5  , WithinRel( linear.momentumTransfers()[5] ) );
        CHECK_THAT( 2.625, WithinRel( linear.momentumTransfers()[6] ) );
        CHECK_THAT( 2.75 , WithinRel( linear.momentumTransfers()[7] ) );
        CHECK_THAT( 2.875, WithinRel( linear.momentumTransfers()[8] ) );
        CHECK_THAT( 3.   , WithinRel( linear.momentumTransfers()[9] ) );
        CHECK_THAT( 3.125, WithinRel( linear.momentumTransfers()[10] ) );
        CHECK_THAT( 3.25 , WithinRel( linear.momentumTransfers()[11] ) );
        CHECK_THAT( 3.375, WithinRel( linear.momentumTransfers()[12] ) );
        CHECK_THAT( 3.5  , WithinRel( linear.momentumTransfers()[13] ) );
        CHECK_THAT( 3.625, WithinRel( linear.momentumTransfers()[14] ) );
        CHECK_THAT( 3.75 , WithinRel( linear.momentumTransfers()[15] ) );
        CHECK_THAT( 3.875, WithinRel( linear.momentumTransfers()[16] ) );
        CHECK_THAT( 4.   , WithinRel( linear.momentumTransfers()[17] ) );
  ...
  GIVEN( "non-linearised data with multiple regions with a jump" ) {
    ...
    WHEN( "the data is given explicitly" ) {
      ...
      THEN( "a TabulatedScatteringKernelFunction can be linearised" ) {
        ...
        CHECK( 12 == linear.momentumTransfers().size() );
        ...
        CHECK_THAT( 2.   , WithinRel( linear.momentumTransfers()[1] ) );
        CHECK_THAT( 2.   , WithinRel( linear.momentumTransfers()[2] ) );
        CHECK_THAT( 2.125, WithinRel( linear.momentumTransfers()[3] ) );
        CHECK_THAT( 2.25 , WithinRel( linear.momentumTransfers()[4] ) );
        CHECK_THAT( 2.5  , WithinRel( linear.momentumTransfers()[5] ) );
        CHECK_THAT( 2.75 , WithinRel( linear.momentumTransfers()[6] ) );
        CHECK_THAT( 3.   , WithinRel( linear.momentumTransfers()[7] ) );
        CHECK_THAT( 3.25 , WithinRel( linear.momentumTransfers()[8] ) );
        CHECK_THAT( 3.5  , WithinRel( linear.momentumTransfers()[9] ) );
        CHECK_THAT( 3.75 , WithinRel( linear.momentumTransfers()[10] ) );
        CHECK_THAT( 4.   , WithinRel( linear.momentumTransfers()[11] ) );
  ...
  GIVEN( "non-linearised data with multiple regions with a jump at the end" ) {
    ...
    WHEN( "the data is given explicitly" ) {
      ...
      THEN( "an TabulatedScatteringKernelFunction can be constructed and members can be tested" ) {
        ...
        CHECK_THAT( 2., WithinRel( chunk.momentumTransfers()[1] ) );
        CHECK_THAT( 3., WithinRel( chunk.momentumTransfers()[2] ) );
        CHECK_THAT( 4., WithinRel( chunk.momentumTransfers()[3] ) ); // <-- last point removed
        CHECK_THAT( 4., WithinRel( chunk.values()[0] ) );
        CHECK_THAT( 3., WithinRel( chunk.values()[1] ) );
        CHECK_THAT( 2., WithinRel( chunk.values()[2] ) );
  ...
  GIVEN( "non-linearised data with multiple regions with a jump at the beginning" ) {
    ...
    WHEN( "the data is given explicitly" ) {
      ...
      THEN( "an TabulatedScatteringKernelFunction can be constructed and members can be tested" ) {
        ...
        CHECK( 2 == chunk.boundaries().size() );
        CHECK( 2 == chunk.interpolants().size() );
        CHECK_THAT( 1., WithinRel( chunk.momentumTransfers()[0] ) ); // <-- first point removed
        CHECK_THAT( 2., WithinRel( chunk.momentumTransfers()[1] ) );
        CHECK_THAT( 3., WithinRel( chunk.momentumTransfers()[2] ) );
        CHECK_THAT( 4., WithinRel( chunk.momentumTransfers()[3] ) );
