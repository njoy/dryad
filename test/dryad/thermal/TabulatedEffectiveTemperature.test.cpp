...
SCENARIO( "TabulatedEffectiveTemperature" ) {
  ...
  GIVEN( "linearised data without boundaries and no jumps" ) {
    ...
    WHEN( "the data is given explicitly" ) {
      ...
      TabulatedEffectiveTemperature chunk( std::move( temperatures ), std::move( values ) );

      THEN( "a TabulatedEffectiveTemperature can be constructed and members can be tested" ) {

        CHECK_THAT( 1., WithinRel( chunk.lowerModeratorTemperatureLimit() ) );
        CHECK_THAT( 4., WithinRel( chunk.upperModeratorTemperatureLimit() ) );
        CHECK( 4 == chunk.numberPoints() );
        CHECK( 1 == chunk.numberRegions() );
        CHECK( 4 == chunk.moderatorTemperatures().size() );
        CHECK( 4 == chunk.values().size() );
        CHECK( 1 == chunk.boundaries().size() );
        CHECK( 1 == chunk.interpolants().size() );
        CHECK_THAT( 1., WithinRel( chunk.moderatorTemperatures()[0] ) );
        CHECK_THAT( 2., WithinRel( chunk.moderatorTemperatures()[1] ) );
        CHECK_THAT( 3., WithinRel( chunk.moderatorTemperatures()[2] ) );
        CHECK_THAT( 4., WithinRel( chunk.moderatorTemperatures()[3] ) );
      ...
      THEN( "a TabulatedEffectiveTemperature can be evaluated" ) {
      ...
      THEN( "arithmetic operations can be performed" ) {
        ...
        TabulatedEffectiveTemperature result( { 1., 4. }, { 0., 0. } );
        TabulatedEffectiveTemperature same( { 1., 4. }, { 0., 3. } );
        TabulatedEffectiveTemperature threshold( { 2., 4. }, { 0., 2. } );
        TabulatedEffectiveTemperature nonzerothreshold( { 2., 4. }, { 1., 3. } );
        TabulatedEffectiveTemperature small( { 1., 3. }, { 0., 2. } );
        ...
        CHECK( 4 == result.moderatorTemperatures().size() );
        CHECK( 4 == result.values().size() );
        CHECK( 1 == result.boundaries().size() );
        CHECK( 1 == result.interpolants().size() );
        CHECK_THAT(  1., WithinRel( result.moderatorTemperatures()[0] ) );
        CHECK_THAT(  2., WithinRel( result.moderatorTemperatures()[1] ) );
        CHECK_THAT(  3., WithinRel( result.moderatorTemperatures()[2] ) );
        CHECK_THAT(  4., WithinRel( result.moderatorTemperatures()[3] ) );
        ...
        CHECK( 5 == chunk.moderatorTemperatures().size() );
        CHECK( 5 == chunk.values().size() );
        CHECK( 2 == chunk.boundaries().size() );
        CHECK( 2 == chunk.interpolants().size() );
        CHECK_THAT( 1., WithinRel( chunk.moderatorTemperatures()[0] ) );
        CHECK_THAT( 2., WithinRel( chunk.moderatorTemperatures()[1] ) );
        CHECK_THAT( 2., WithinRel( chunk.moderatorTemperatures()[2] ) );
        CHECK_THAT( 3., WithinRel( chunk.moderatorTemperatures()[3] ) );
        CHECK_THAT( 4., WithinRel( chunk.moderatorTemperatures()[4] ) );
        CHECK_THAT( 4., WithinRel( chunk.values()[0] ) );
        CHECK_THAT( 3., WithinRel( chunk.values()[1] ) );
        CHECK_THAT( 4., WithinRel( chunk.values()[2] ) );
        ...
        CHECK( 5 == result.moderatorTemperatures().size() );
        CHECK( 5 == result.values().size() );
        CHECK( 2 == result.boundaries().size() );
        CHECK( 2 == result.interpolants().size() );
        CHECK_THAT( 1., WithinRel( result.moderatorTemperatures()[0] ) );
        CHECK_THAT( 2., WithinRel( result.moderatorTemperatures()[1] ) );
        CHECK_THAT( 2., WithinRel( result.moderatorTemperatures()[2] ) );
        CHECK_THAT( 3., WithinRel( result.moderatorTemperatures()[3] ) );
        CHECK_THAT( 4., WithinRel( result.moderatorTemperatures()[4] ) );
        CHECK_THAT( 4., WithinRel( result.values()[0] ) );
        CHECK_THAT( 3., WithinRel( result.values()[1] ) );
        CHECK_THAT( 4., WithinRel( result.values()[2] ) );
      ...
      THEN( "a TabulatedEffectiveTemperature can be linearised" ) {

        TabulatedEffectiveTemperature linear = chunk.linearise();

        CHECK( 4 == linear.numberPoints() );
        CHECK( 1 == linear.numberRegions() );

        CHECK( 4 == linear.moderatorTemperatures().size() );
        ...
        CHECK_THAT( 1., WithinRel( linear.moderatorTemperatures()[0] ) );
        CHECK_THAT( 2., WithinRel( linear.moderatorTemperatures()[1] ) );
        CHECK_THAT( 3., WithinRel( linear.moderatorTemperatures()[2] ) );
        CHECK_THAT( 4., WithinRel( linear.moderatorTemperatures()[3] ) );
  ...
  GIVEN( "linearised data without boundaries and a jump" ) {
    ...
    WHEN( "the data is given explicitly" ) {
      ...
      const std::vector< double > temperatures = { 1., 2., 2., 3., 4. };
      ...
      THEN( "arithmetic operations can be performed" ) {
        ...
        TabulatedEffectiveTemperature same( { 1., 4. }, { 0., 3. } );
        TabulatedEffectiveTemperature threshold( { 2., 4. }, { 0., 2. } );
        TabulatedEffectiveTemperature nonzerothreshold( { 3., 4. }, { 1., 2. } );
        TabulatedEffectiveTemperature small( { 1., 3. }, { 0., 2. } );
        ...
        CHECK( 6 == chunk.moderatorTemperatures().size() );
        ...
        CHECK_THAT( 2., WithinRel( chunk.moderatorTemperatures()[2] ) );
        CHECK_THAT( 3., WithinRel( chunk.moderatorTemperatures()[3] ) );
        CHECK_THAT( 3., WithinRel( chunk.moderatorTemperatures()[4] ) );
        CHECK_THAT( 4., WithinRel( chunk.moderatorTemperatures()[5] ) );
        CHECK_THAT( 4., WithinRel( chunk.values()[0] ) );
        CHECK_THAT( 3., WithinRel( chunk.values()[1] ) );
        CHECK_THAT( 4., WithinRel( chunk.values()[2] ) );
        CHECK_THAT( 3., WithinRel( chunk.values()[3] ) );
        ...
        CHECK( 6 == result.moderatorTemperatures().size() );
        ...
        CHECK_THAT( 2., WithinRel( result.moderatorTemperatures()[2] ) );
        CHECK_THAT( 3., WithinRel( result.moderatorTemperatures()[3] ) );
        CHECK_THAT( 3., WithinRel( result.moderatorTemperatures()[4] ) );
        CHECK_THAT( 4., WithinRel( result.moderatorTemperatures()[5] ) );
        CHECK_THAT( 4., WithinRel( result.values()[0] ) );
        CHECK_THAT( 3., WithinRel( result.values()[1] ) );
        CHECK_THAT( 4., WithinRel( result.values()[2] ) );
        CHECK_THAT( 3., WithinRel( result.values()[3] ) );
      ...
      THEN( "a TabulatedEffectiveTemperature can be linearised" ) {
        ...
        CHECK( 5 == linear.moderatorTemperatures().size() );
        ...
        CHECK_THAT( 1., WithinRel( linear.moderatorTemperatures()[0] ) );
        CHECK_THAT( 2., WithinRel( linear.moderatorTemperatures()[1] ) );
        CHECK_THAT( 2., WithinRel( linear.moderatorTemperatures()[2] ) );
        CHECK_THAT( 3., WithinRel( linear.moderatorTemperatures()[3] ) );
        CHECK_THAT( 4., WithinRel( linear.moderatorTemperatures()[4] ) );
  ...
  GIVEN( "non-linearised data with multiple regions without a jump" ) {
    ...
    WHEN( "the data is given explicitly" ) {
      ...
      TabulatedEffectiveTemperature chunk( std::move( temperatures ),
                                   std::move( values ),
                                   std::move( boundaries ),
      ...
      THEN( "some arithmetic operations cannot be performed" ) {
        ...
        TabulatedEffectiveTemperature result( { 1., 4. }, { 0., 0. } );
        TabulatedEffectiveTemperature right( { 1., 4. }, { 0., 0. } );
      ...
      THEN( "a TabulatedEffectiveTemperature can be linearised" ) {
        ...
        CHECK( 18 == linear.moderatorTemperatures().size() );
        ...
        CHECK_THAT( 1.   , WithinRel( linear.moderatorTemperatures()[0] ) );
        CHECK_THAT( 2.   , WithinRel( linear.moderatorTemperatures()[1] ) );
        CHECK_THAT( 2.125, WithinRel( linear.moderatorTemperatures()[2] ) );
        CHECK_THAT( 2.25 , WithinRel( linear.moderatorTemperatures()[3] ) );
        CHECK_THAT( 2.375, WithinRel( linear.moderatorTemperatures()[4] ) );
        CHECK_THAT( 2.5  , WithinRel( linear.moderatorTemperatures()[5] ) );
        CHECK_THAT( 2.625, WithinRel( linear.moderatorTemperatures()[6] ) );
        CHECK_THAT( 2.75 , WithinRel( linear.moderatorTemperatures()[7] ) );
        CHECK_THAT( 2.875, WithinRel( linear.moderatorTemperatures()[8] ) );
        CHECK_THAT( 3.   , WithinRel( linear.moderatorTemperatures()[9] ) );
        CHECK_THAT( 3.125, WithinRel( linear.moderatorTemperatures()[10] ) );
        CHECK_THAT( 3.25 , WithinRel( linear.moderatorTemperatures()[11] ) );
        CHECK_THAT( 3.375, WithinRel( linear.moderatorTemperatures()[12] ) );
        CHECK_THAT( 3.5  , WithinRel( linear.moderatorTemperatures()[13] ) );
        CHECK_THAT( 3.625, WithinRel( linear.moderatorTemperatures()[14] ) );
        CHECK_THAT( 3.75 , WithinRel( linear.moderatorTemperatures()[15] ) );
        CHECK_THAT( 3.875, WithinRel( linear.moderatorTemperatures()[16] ) );
        CHECK_THAT( 4.   , WithinRel( linear.moderatorTemperatures()[17] ) );
  ...
  GIVEN( "non-linearised data with multiple regions with a jump" ) {
    ...
    WHEN( "the data is given explicitly" ) {
      ...
      THEN( "a TabulatedEffectiveTemperature can be linearised" ) {
        ...
        CHECK( 12 == linear.moderatorTemperatures().size() );
        ...
        CHECK_THAT( 2.   , WithinRel( linear.moderatorTemperatures()[1] ) );
        CHECK_THAT( 2.   , WithinRel( linear.moderatorTemperatures()[2] ) );
        CHECK_THAT( 2.125, WithinRel( linear.moderatorTemperatures()[3] ) );
        CHECK_THAT( 2.25 , WithinRel( linear.moderatorTemperatures()[4] ) );
        CHECK_THAT( 2.5  , WithinRel( linear.moderatorTemperatures()[5] ) );
        CHECK_THAT( 2.75 , WithinRel( linear.moderatorTemperatures()[6] ) );
        CHECK_THAT( 3.   , WithinRel( linear.moderatorTemperatures()[7] ) );
        CHECK_THAT( 3.25 , WithinRel( linear.moderatorTemperatures()[8] ) );
        CHECK_THAT( 3.5  , WithinRel( linear.moderatorTemperatures()[9] ) );
        CHECK_THAT( 3.75 , WithinRel( linear.moderatorTemperatures()[10] ) );
        CHECK_THAT( 4.   , WithinRel( linear.moderatorTemperatures()[11] ) );
  ...
  GIVEN( "non-linearised data with multiple regions with a jump that consist of "
    ...
    WHEN( "the data is given explicitly" ) {
      ...
      TabulatedEffectiveTemperature chunk( std::move( x ), std::move( y ),
                                           std::move( boundaries ),
                                           std::move( interpolants ) );
  ...
  GIVEN( "non-linearised data with multiple regions with a jump and boundaries "
    ...
    //       the jump. As a result, the final data contained in this TabulatedEffectiveTemperature is the
  ...
  GIVEN( "non-linearised data with multiple regions with a jump at the end" ) {
    ...
    WHEN( "the data is given explicitly" ) {
      ...
      THEN( "an TabulatedEffectiveTemperature can be constructed and members can be tested" ) {
        ...
        CHECK_THAT( 2., WithinRel( chunk.moderatorTemperatures()[1] ) );
        CHECK_THAT( 3., WithinRel( chunk.moderatorTemperatures()[2] ) );
        CHECK_THAT( 4., WithinRel( chunk.moderatorTemperatures()[3] ) ); // <-- last point removed
        CHECK_THAT( 4., WithinRel( chunk.values()[0] ) );
        CHECK_THAT( 3., WithinRel( chunk.values()[1] ) );
        CHECK_THAT( 2., WithinRel( chunk.values()[2] ) );
  ...
  GIVEN( "non-linearised data with multiple regions with a jump at the beginning" ) {
    ...
    WHEN( "the data is given explicitly" ) {
      ...
      THEN( "an TabulatedEffectiveTemperature can be constructed and members can be tested" ) {
        ...
        CHECK( 2 == chunk.boundaries().size() );
        CHECK( 2 == chunk.interpolants().size() );
        CHECK_THAT( 1., WithinRel( chunk.moderatorTemperatures()[0] ) ); // <-- first point removed
        CHECK_THAT( 2., WithinRel( chunk.moderatorTemperatures()[1] ) );
        CHECK_THAT( 3., WithinRel( chunk.moderatorTemperatures()[2] ) );
        CHECK_THAT( 4., WithinRel( chunk.moderatorTemperatures()[3] ) );
  ...
  GIVEN( "comparison operators" ) {
    ...
    WHEN( "two instances of TabulatedEffectiveTemperature are given" ) {

      TabulatedEffectiveTemperature left( { 1., 2., 3., 4. }, { 4., 3., 2., 1. } );
      TabulatedEffectiveTemperature equal( { 1., 2., 3., 4. }, { 4., 3., 2., 1. } );
      TabulatedEffectiveTemperature different( { 1., 4. }, { 4., 1. } );
  ...
  GIVEN( "invalid data for an TabulatedEffectiveTemperature object" ) {
    ...
    WHEN( "there are not enough values in the x or y grid" ) {
      ...
      THEN( "an exception is thrown" ) {
        ...
        CHECK_THROWS( TabulatedEffectiveTemperature( empty, empty ) );
        CHECK_THROWS( TabulatedEffectiveTemperature( one, one ) );
      } // THEN
    } // WHEN
    ...
    WHEN( "the x and y grid do not have the same number of points" ) {
      ...
      THEN( "an exception is thrown" ) {
        ...
        CHECK_THROWS( TabulatedEffectiveTemperature( std::move( x ), std::move( y ) ) );
      } // THEN
    } // WHEN
