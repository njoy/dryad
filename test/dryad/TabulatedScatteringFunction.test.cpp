  ...
  GIVEN( "linearised data without boundaries and no jumps" ) {
    ...
    WHEN( "the data is given explicitly" ) {
      ...
      THEN( "a TabulatedScatteringFunction can be constructed and members can be tested" ) {
        ...
        CHECK_THAT( 1., WithinRel( chunk.lowerInverseLengthLimit() ) );
        CHECK_THAT( 4., WithinRel( chunk.upperInverseLengthLimit() ) );
      ...
      THEN( "a TabulatedScatteringFunction can be linearised" ) {
        ...
        CHECK( 4 == linear.inverseLengths().size() );
        ...
        CHECK_THAT( 1., WithinRel( linear.inverseLengths()[0] ) );
        CHECK_THAT( 2., WithinRel( linear.inverseLengths()[1] ) );
        CHECK_THAT( 3., WithinRel( linear.inverseLengths()[2] ) );
        CHECK_THAT( 4., WithinRel( linear.inverseLengths()[3] ) );
  ...
  GIVEN( "linearised data without boundaries and a jump" ) {
    ...
    WHEN( "the data is given explicitly" ) {
      ...
      THEN( "arithmetic operations can be performed" ) {
        ...
        CHECK( 6 == chunk.inverseLengths().size() );
        ...
        CHECK_THAT( 2., WithinRel( chunk.inverseLengths()[2] ) );
        CHECK_THAT( 3., WithinRel( chunk.inverseLengths()[3] ) );
        CHECK_THAT( 3., WithinRel( chunk.inverseLengths()[4] ) );
        CHECK_THAT( 4., WithinRel( chunk.inverseLengths()[5] ) );
        CHECK_THAT( 4., WithinRel( chunk.values()[0] ) );
        CHECK_THAT( 3., WithinRel( chunk.values()[1] ) );
        CHECK_THAT( 4., WithinRel( chunk.values()[2] ) );
        CHECK_THAT( 3., WithinRel( chunk.values()[3] ) );
        ...
        CHECK( 6 == result.inverseLengths().size() );
        ...
        CHECK_THAT( 2., WithinRel( result.inverseLengths()[2] ) );
        CHECK_THAT( 3., WithinRel( result.inverseLengths()[3] ) );
        CHECK_THAT( 3., WithinRel( result.inverseLengths()[4] ) );
        CHECK_THAT( 4., WithinRel( result.inverseLengths()[5] ) );
        CHECK_THAT( 4., WithinRel( result.values()[0] ) );
        CHECK_THAT( 3., WithinRel( result.values()[1] ) );
        CHECK_THAT( 4., WithinRel( result.values()[2] ) );
        CHECK_THAT( 3., WithinRel( result.values()[3] ) );
      ...
      THEN( "a TabulatedScatteringFunction can be linearised" ) {
        ...
        CHECK( 5 == linear.inverseLengths().size() );
        ...
        CHECK_THAT( 1., WithinRel( linear.inverseLengths()[0] ) );
        CHECK_THAT( 2., WithinRel( linear.inverseLengths()[1] ) );
        CHECK_THAT( 2., WithinRel( linear.inverseLengths()[2] ) );
        CHECK_THAT( 3., WithinRel( linear.inverseLengths()[3] ) );
        CHECK_THAT( 4., WithinRel( linear.inverseLengths()[4] ) );
  ...
  GIVEN( "non-linearised data with multiple regions without a jump" ) {
    ...
    WHEN( "the data is given explicitly" ) {
      ...
      THEN( "a TabulatedScatteringFunction can be linearised" ) {
        ...
        CHECK( 18 == linear.inverseLengths().size() );
        ...
        CHECK_THAT( 1.   , WithinRel( linear.inverseLengths()[0] ) );
        CHECK_THAT( 2.   , WithinRel( linear.inverseLengths()[1] ) );
        CHECK_THAT( 2.125, WithinRel( linear.inverseLengths()[2] ) );
        CHECK_THAT( 2.25 , WithinRel( linear.inverseLengths()[3] ) );
        CHECK_THAT( 2.375, WithinRel( linear.inverseLengths()[4] ) );
        CHECK_THAT( 2.5  , WithinRel( linear.inverseLengths()[5] ) );
        CHECK_THAT( 2.625, WithinRel( linear.inverseLengths()[6] ) );
        CHECK_THAT( 2.75 , WithinRel( linear.inverseLengths()[7] ) );
        CHECK_THAT( 2.875, WithinRel( linear.inverseLengths()[8] ) );
        CHECK_THAT( 3.   , WithinRel( linear.inverseLengths()[9] ) );
        CHECK_THAT( 3.125, WithinRel( linear.inverseLengths()[10] ) );
        CHECK_THAT( 3.25 , WithinRel( linear.inverseLengths()[11] ) );
        CHECK_THAT( 3.375, WithinRel( linear.inverseLengths()[12] ) );
        CHECK_THAT( 3.5  , WithinRel( linear.inverseLengths()[13] ) );
        CHECK_THAT( 3.625, WithinRel( linear.inverseLengths()[14] ) );
        CHECK_THAT( 3.75 , WithinRel( linear.inverseLengths()[15] ) );
        CHECK_THAT( 3.875, WithinRel( linear.inverseLengths()[16] ) );
        CHECK_THAT( 4.   , WithinRel( linear.inverseLengths()[17] ) );
  ...
  GIVEN( "non-linearised data with multiple regions with a jump" ) {
    ...
    WHEN( "the data is given explicitly" ) {
      ...
      THEN( "a TabulatedScatteringFunction can be linearised" ) {
        ...
        CHECK( 12 == linear.inverseLengths().size() );
        ...
        CHECK_THAT( 2.   , WithinRel( linear.inverseLengths()[1] ) );
        CHECK_THAT( 2.   , WithinRel( linear.inverseLengths()[2] ) );
        CHECK_THAT( 2.125, WithinRel( linear.inverseLengths()[3] ) );
        CHECK_THAT( 2.25 , WithinRel( linear.inverseLengths()[4] ) );
        CHECK_THAT( 2.5  , WithinRel( linear.inverseLengths()[5] ) );
        CHECK_THAT( 2.75 , WithinRel( linear.inverseLengths()[6] ) );
        CHECK_THAT( 3.   , WithinRel( linear.inverseLengths()[7] ) );
        CHECK_THAT( 3.25 , WithinRel( linear.inverseLengths()[8] ) );
        CHECK_THAT( 3.5  , WithinRel( linear.inverseLengths()[9] ) );
        CHECK_THAT( 3.75 , WithinRel( linear.inverseLengths()[10] ) );
        CHECK_THAT( 4.   , WithinRel( linear.inverseLengths()[11] ) );
  ...
  GIVEN( "non-linearised data with multiple regions with a jump at the end" ) {
    ...
    WHEN( "the data is given explicitly" ) {
      ...
      THEN( "an TabulatedScatteringFunction can be constructed and members can be tested" ) {
        ...
        CHECK_THAT( 2., WithinRel( chunk.inverseLengths()[1] ) );
        CHECK_THAT( 3., WithinRel( chunk.inverseLengths()[2] ) );
        CHECK_THAT( 4., WithinRel( chunk.inverseLengths()[3] ) ); // <-- last point removed
        CHECK_THAT( 4., WithinRel( chunk.values()[0] ) );
        CHECK_THAT( 3., WithinRel( chunk.values()[1] ) );
        CHECK_THAT( 2., WithinRel( chunk.values()[2] ) );
  ...
  GIVEN( "non-linearised data with multiple regions with a jump at the beginning" ) {
    ...
    WHEN( "the data is given explicitly" ) {
      ...
      THEN( "an TabulatedScatteringFunction can be constructed and members can be tested" ) {
        ...
        CHECK( 2 == chunk.boundaries().size() );
        CHECK( 2 == chunk.interpolants().size() );
        CHECK_THAT( 1., WithinRel( chunk.inverseLengths()[0] ) ); // <-- first point removed
        CHECK_THAT( 2., WithinRel( chunk.inverseLengths()[1] ) );
        CHECK_THAT( 3., WithinRel( chunk.inverseLengths()[2] ) );
        CHECK_THAT( 4., WithinRel( chunk.inverseLengths()[3] ) );
