...
SCENARIO( "TabulatedFormFactor" ) {
  ...
  GIVEN( "linearised data without boundaries and no jumps" ) {
    ...
    WHEN( "the data is given explicitly" ) {
      ...
      TabulatedFormFactor chunk( std::move( energies ), std::move( values ) );

      THEN( "a TabulatedFormFactor can be constructed and members can be tested" ) {
      ...
      THEN( "a TabulatedFormFactor can be evaluated" ) {
      ...
      THEN( "arithmetic operations can be performed" ) {
        ...
        TabulatedFormFactor same( { 1., 4. }, { 0., 3. } );
        TabulatedFormFactor threshold( { 2., 4. }, { 0., 2. } );
        TabulatedFormFactor nonzerothreshold( { 2., 4. }, { 1., 3. } );
        TabulatedFormFactor small( { 1., 3. }, { 0., 2. } );
      ...
      THEN( "a TabulatedFormFactor can be linearised" ) {

        TabulatedFormFactor linear = chunk.linearise();
  ...
  GIVEN( "linearised data without boundaries and a jump" ) {
    ...
    WHEN( "the data is given explicitly" ) {
      ...
      THEN( "arithmetic operations can be performed" ) {
        ...
        TabulatedFormFactor same( { 1., 4. }, { 0., 3. } );
        TabulatedFormFactor threshold( { 2., 4. }, { 0., 2. } );
        TabulatedFormFactor nonzerothreshold( { 3., 4. }, { 1., 2. } );
        TabulatedFormFactor small( { 1., 3. }, { 0., 2. } );
  ...
  GIVEN( "non-linearised data with multiple regions without a jump" ) {
    ...
    WHEN( "the data is given explicitly" ) {
      ...
      TabulatedFormFactor chunk( std::move( energies ),
                                   std::move( values ),
                                   std::move( boundaries ),
  ...
  GIVEN( "non-linearised data with multiple regions with a jump that consist of "
    ...
    WHEN( "the data is given explicitly" ) {
      ...
      TabulatedFormFactor chunk( std::move( x ), std::move( y ),
                                 std::move( boundaries ),
                                 std::move( interpolants ) );
  ...
  GIVEN( "non-linearised data with multiple regions with a jump and boundaries "
    ...
    //       the jump. As a result, the final data contained in this TabulatedFormFactor is the
  ...
  GIVEN( "non-linearised data with multiple regions with a jump at the end" ) {
    ...
    WHEN( "the data is given explicitly" ) {
      ...
      THEN( "an TabulatedFormFactor can be constructed and members can be tested" ) {
  ...
  GIVEN( "comparison operators" ) {
    ...
    WHEN( "two instances of TabulatedFormFactor are given" ) {
      ...
      TabulatedFormFactor left( { 1., 2., 3., 4. }, { 4., 3., 2., 1. } );
      TabulatedFormFactor equal( { 1., 2., 3., 4. }, { 4., 3., 2., 1. } );
      TabulatedFormFactor different( { 1., 4. }, { 4., 1. } );
  ...
  GIVEN( "invalid data for an TabulatedFormFactor object" ) {
    ...
    WHEN( "there are not enough values in the x or y grid" ) {
      ...
      THEN( "an exception is thrown" ) {
        ...
        CHECK_THROWS( TabulatedFormFactor( empty, empty ) );
        CHECK_THROWS( TabulatedFormFactor( one, one ) );
      } // THEN
    } // WHEN
    ...
    WHEN( "the x and y grid do not have the same number of points" ) {
      ...
      THEN( "an exception is thrown" ) {
        ...
        CHECK_THROWS( TabulatedFormFactor( std::move( x ), std::move( y ) ) );
      } // THEN
    } // WHEN
