  ...
  GIVEN( "ENDF complex breakup flag value" ) {
    ...
    WHEN( "a residual is given" ) {
      ...
      THEN( "it can be converted" ) {
        ...
        std::map< id::ParticleID, std::size_t > particles = format::endf::createComplexBreakUpParticles( residual, 22 );
        CHECK( 2 == particles.size() );
        CHECK( 1 == particles[ id::ParticleID( "a" ) ] );
        CHECK( 1 == particles[ id::ParticleID( "t" ) ] );

        residual = id::ParticleID( "C13" );
        particles = format::endf::createComplexBreakUpParticles( residual, 23 );
        CHECK( 2 == particles.size() );
        CHECK( 3 == particles[ id::ParticleID( "a" ) ] );
        CHECK( 1 == particles[ id::ParticleID( "n" ) ] );

        residual = id::ParticleID( "Be8" );
        particles = format::endf::createComplexBreakUpParticles( residual, 24 );
        ...
        particles = format::endf::createComplexBreakUpParticles( residual, 25 );
        CHECK( 3 == particles.size() );
        CHECK( 1 == particles[ id::ParticleID( "a" ) ] );
        ...
        particles = format::endf::createComplexBreakUpParticles( residual, 28 );
        CHECK( 2 == particles.size() );
        CHECK( 1 == particles[ id::ParticleID( "p" ) ] );
        CHECK( 1 == particles[ id::ParticleID( "Li8[all]" ) ] );

        residual = id::ParticleID( "Be8" );
        particles = format::endf::createComplexBreakUpParticles( residual, 29 );
        CHECK( 1 == particles.size() );
        CHECK( 2 == particles[ id::ParticleID( "a" ) ] );

        residual = id::ParticleID( "C14" );
        particles = format::endf::createComplexBreakUpParticles( residual, 30 );
        CHECK( 3 == particles.size() );
        CHECK( 2 == particles[ id::ParticleID( "a" ) ] );
        CHECK( 1 == particles[ id::ParticleID( "n" ) ] );
        ...
        residual = id::ParticleID( "C14" );
        particles = format::endf::createComplexBreakUpParticles( residual, 32 );
        CHECK( 2 == particles.size() );
        CHECK( 1 == particles[ id::ParticleID( "d" ) ] );
        CHECK( 1 == particles[ id::ParticleID( "B12[all]" ) ] );

        residual = id::ParticleID( "C14" );
        particles = format::endf::createComplexBreakUpParticles( residual, 33 );
        CHECK( 2 == particles.size() );
        CHECK( 1 == particles[ id::ParticleID( "t" ) ] );
        CHECK( 1 == particles[ id::ParticleID( "B11[all]" ) ] );

        residual = id::ParticleID( "C14" );
        particles = format::endf::createComplexBreakUpParticles( residual, 34 );
        CHECK( 2 == particles.size() );
        CHECK( 1 == particles[ id::ParticleID( "h" ) ] );
        CHECK( 1 == particles[ id::ParticleID( "Be11[all]" ) ] );

        residual = id::ParticleID( "C13" );
        particles = format::endf::createComplexBreakUpParticles( residual, 35 );
        CHECK( 3 == particles.size() );
        CHECK( 2 == particles[ id::ParticleID( "a" ) ] );
        CHECK( 1 == particles[ id::ParticleID( "d" ) ] );
        CHECK( 1 == particles[ id::ParticleID( "t" ) ] );
        ...
        residual = id::ParticleID( "C13" );
        particles = format::endf::createComplexBreakUpParticles( residual, 36 );
        CHECK( 3 == particles.size() );
        CHECK( 2 == particles[ id::ParticleID( "a" ) ] );
        CHECK( 1 == particles[ id::ParticleID( "d" ) ] );
        CHECK( 1 == particles[ id::ParticleID( "t" ) ] );
      ...
      THEN( "an exception is thrown for invalid breakup values" ) {
        ...
        id::ParticleID residual( "Li7" );
        CHECK_THROWS( format::endf::createComplexBreakUpParticles( residual, 1 ) );
      } // THEN

      THEN( "an exception is thrown when the residual is too small" ) {

        id::ParticleID residual( "H3" );
        CHECK_THROWS( format::endf::createComplexBreakUpParticles( residual, 22 ) );
      } // THEN
    } // WHEN
  } // GIVEN
} // SCENARIO
