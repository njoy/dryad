...
//    CHECK( 2 == matrices[0].covariances().rows() );
//    CHECK( 2 == matrices[0].covariances().cols() );
//    CHECK(  2.250000e-2 == matrices[0].covariances()(  0,  0) );
//    CHECK(  0.          == matrices[0].covariances()(  0,  1) );
//    CHECK(  0.          == matrices[0].covariances()(  1,  0) );
//    CHECK(  0.          == matrices[0].covariances()(  1,  1) );
//
...
//    CHECK( 14 == matrices[1].rowMetadata().energies().size() );
...
//    CHECK( 13 == matrices[1].covariances().rows() );
//    CHECK( 13 == matrices[1].covariances().cols() );
//    CHECK(  0.          == matrices[1].covariances()(  0,  0) );
//    CHECK(  0.          == matrices[1].covariances()(  0, 12) );
//    CHECK(  0.          == matrices[1].covariances()( 12,  0) );
//    CHECK(  1.000000e+2 == matrices[1].covariances()( 12, 12) );
