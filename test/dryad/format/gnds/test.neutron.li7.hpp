...
namespace li7 {
  ...
  void verifyTotalReaction( const Reaction& reaction ) {
    ...
    CHECK( id::ReactionID( "n,Li7->n,Li7" ) == partials[0] );
    CHECK( id::ReactionID( "n,Li7->n,Li7_e1" ) == partials[1] );
    CHECK( id::ReactionID( "n,Li7->n,Li7_e2" ) == partials[2] );
    CHECK( id::ReactionID( "n,Li7->n,Li7_e3" ) == partials[3] );
    CHECK( id::ReactionID( "n,Li7->n,Li7_e4" ) == partials[4] );
    CHECK( id::ReactionID( "n,Li7->n,Li7_e5" ) == partials[5] );
    CHECK( id::ReactionID( "n,Li7->n,Li7_e6" ) == partials[6] );
    CHECK( id::ReactionID( "n,Li7->n,Li7_e7" ) == partials[7] );
    CHECK( id::ReactionID( "n,Li7->n,Li7_e8" ) == partials[8] );
    CHECK( id::ReactionID( "n,Li7->n,Li7_e9" ) == partials[9] );
    CHECK( id::ReactionID( "n,Li7->n,Li7_e10" ) == partials[10] );
    CHECK( id::ReactionID( "n,Li7->n,Li7_e11" ) == partials[11] );
    CHECK( id::ReactionID( "n,Li7->n,Li7_e12" ) == partials[12] );
    CHECK( id::ReactionID( "n,Li7->n,Li7_e13" ) == partials[13] );
    CHECK( id::ReactionID( "n,Li7->n,Li7_e14" ) == partials[14] );
    CHECK( id::ReactionID( "n,Li7->n,Li7_e15" ) == partials[15] );
    CHECK( id::ReactionID( "n,Li7->n,Li7_e16" ) == partials[16] );
    CHECK( id::ReactionID( "n,Li7->n,Li7_e17" ) == partials[17] );
    CHECK( id::ReactionID( "n,Li7->n,Li7_e18" ) == partials[18] );
    CHECK( id::ReactionID( "n,Li7->n,Li7_e19" ) == partials[19] );
    CHECK( id::ReactionID( "n,Li7->n,Li7_e20" ) == partials[20] );
    CHECK( id::ReactionID( "n,Li7->n,Li7_e21" ) == partials[21] );
    CHECK( id::ReactionID( "n,Li7->n,Li7_e22" ) == partials[22] );
    CHECK( id::ReactionID( "n,Li7->n,Li7_e23" ) == partials[23] );
    CHECK( id::ReactionID( "n,Li7->n,Li7_e24" ) == partials[24] );
    CHECK( id::ReactionID( "n,Li7->n,Li7_e25" ) == partials[25] );
    CHECK( id::ReactionID( "n,Li7->n,Li7_e26" ) == partials[26] );
    CHECK( id::ReactionID( "n,Li7->n,Li7_e27" ) == partials[27] );
    CHECK( id::ReactionID( "n,Li7->n,Li7_e28" ) == partials[28] );
    CHECK( id::ReactionID( "n,Li7->n,Li7_e29" ) == partials[29] );
    CHECK( id::ReactionID( "n,Li7->n,Li7_e30" ) == partials[30] );
    CHECK( id::ReactionID( "n,Li7->n,Li7_e31" ) == partials[31] );
    CHECK( id::ReactionID( "n,Li7->n,Li7_e32" ) == partials[32] );
    CHECK( id::ReactionID( "n,Li7->2n,Li6[all]" ) == partials[33] );
    CHECK( id::ReactionID( "n,Li7->g,Li8[all]" ) == partials[34] );
    CHECK( id::ReactionID( "n,Li7->2n,a,H2[all]" ) == partials[35] );
    CHECK( id::ReactionID( "n,Li7->3n,a,H1[all]" ) == partials[36] );
    CHECK( id::ReactionID( "n,Li7->d,He6[all]" ) == partials[37] );
    CHECK( 50 == partials[0].reactionType().mt().value() );
    CHECK( 51 == partials[1].reactionType().mt().value() );
    CHECK( 52 == partials[2].reactionType().mt().value() );
    CHECK( 53 == partials[3].reactionType().mt().value() );
    CHECK( 54 == partials[4].reactionType().mt().value() );
    CHECK( 55 == partials[5].reactionType().mt().value() );
    CHECK( 56 == partials[6].reactionType().mt().value() );
    CHECK( 57 == partials[7].reactionType().mt().value() );
    CHECK( 58 == partials[8].reactionType().mt().value() );
    CHECK( 59 == partials[9].reactionType().mt().value() );
    CHECK( 60 == partials[10].reactionType().mt().value() );
    CHECK( 61 == partials[11].reactionType().mt().value() );
    CHECK( 62 == partials[12].reactionType().mt().value() );
    CHECK( 63 == partials[13].reactionType().mt().value() );
    CHECK( 64 == partials[14].reactionType().mt().value() );
    CHECK( 65 == partials[15].reactionType().mt().value() );
    CHECK( 66 == partials[16].reactionType().mt().value() );
    CHECK( 67 == partials[17].reactionType().mt().value() );
    CHECK( 68 == partials[18].reactionType().mt().value() );
    CHECK( 69 == partials[19].reactionType().mt().value() );
    CHECK( 70 == partials[20].reactionType().mt().value() );
    CHECK( 71 == partials[21].reactionType().mt().value() );
    CHECK( 72 == partials[22].reactionType().mt().value() );
    CHECK( 73 == partials[23].reactionType().mt().value() );
    CHECK( 74 == partials[24].reactionType().mt().value() );
    CHECK( 75 == partials[25].reactionType().mt().value() );
    CHECK( 76 == partials[26].reactionType().mt().value() );
    CHECK( 77 == partials[27].reactionType().mt().value() );
    CHECK( 78 == partials[28].reactionType().mt().value() );
    CHECK( 79 == partials[29].reactionType().mt().value() );
    CHECK( 80 == partials[30].reactionType().mt().value() );
    CHECK( 81 == partials[31].reactionType().mt().value() );
    CHECK( 82 == partials[32].reactionType().mt().value() );
    CHECK( 16 == partials[33].reactionType().mt().value() );
    CHECK( 102 == partials[34].reactionType().mt().value() );
    CHECK( 24 == partials[35].reactionType().mt().value() );
    CHECK( 25 == partials[36].reactionType().mt().value() );
  ...
  void verifyElasticReaction( const Reaction& reaction ) {
    ...
    CHECK( id::ReactionID( "n,Li7->n,Li7" ) == reaction.identifier() );
  ...
  void verifyLumpedReaction851( const Reaction& reaction ) {
    ...
    CHECK( id::ReactionID( "n,Li7->lumped1" ) == reaction.identifier() );
    ...
    CHECK( id::ReactionID( "n,Li7->2n,Li6[all]" ) == partials[0] );
    CHECK( id::ReactionID( "n,Li7->2n,a,H2[all]" ) == partials[1] );
  ...
  void verifyLumpedReaction852( const Reaction& reaction ) {
    ...
    CHECK( id::ReactionID( "n,Li7->lumped2" ) == reaction.identifier() );
    ...
    CHECK( id::ReactionID( "n,Li7->n,Li7_e1" ) == partials[0] );
  ...
  void verifyLumpedReaction853( const Reaction& reaction ) {
    ...
    CHECK( id::ReactionID( "n,Li7->lumped3" ) == reaction.identifier() );
    ...
    CHECK( id::ReactionID( "n,Li7->n,Li7_e2" ) == partials[0] );
    CHECK( id::ReactionID( "n,Li7->n,Li7_e3" ) == partials[1] );
    CHECK( id::ReactionID( "n,Li7->n,Li7_e4" ) == partials[2] );
    CHECK( id::ReactionID( "n,Li7->n,Li7_e5" ) == partials[3] );
  ...
  void verifyLumpedReaction854( const Reaction& reaction ) {
    ...
    CHECK( id::ReactionID( "n,Li7->lumped4" ) == reaction.identifier() );
    ...
    auto partials = reaction.partialReactionIdentifiers().value();
    CHECK( 1 == partials.size() );
    CHECK( id::ReactionID( "n,Li7->n,Li7_e6" ) == partials[0] );
  ...
  void verifyLumpedReaction855( const Reaction& reaction ) {
    ...
    CHECK( id::ReactionID( "n,Li7->lumped5" ) == reaction.identifier() );
    ...
    CHECK( id::ReactionID( "n,Li7->n,Li7_e7" ) == partials[0] );
    CHECK( id::ReactionID( "n,Li7->n,Li7_e8" ) == partials[1] );
    CHECK( id::ReactionID( "n,Li7->n,Li7_e9" ) == partials[2] );
    CHECK( id::ReactionID( "n,Li7->n,Li7_e10" ) == partials[3] );
    CHECK( id::ReactionID( "n,Li7->n,Li7_e11" ) == partials[4] );
  ...
  void verifyLumpedReaction856( const Reaction& reaction ) {
    ...
    CHECK( id::ReactionID( "n,Li7->lumped6" ) == reaction.identifier() );
    ...
    auto partials = reaction.partialReactionIdentifiers().value();
    CHECK( 5 == partials.size() );
    CHECK( id::ReactionID( "n,Li7->n,Li7_e12" ) == partials[0] );
    CHECK( id::ReactionID( "n,Li7->n,Li7_e13" ) == partials[1] );
    CHECK( id::ReactionID( "n,Li7->n,Li7_e14" ) == partials[2] );
    CHECK( id::ReactionID( "n,Li7->n,Li7_e15" ) == partials[3] );
    CHECK( id::ReactionID( "n,Li7->n,Li7_e16" ) == partials[4] );
  ...
  void verifyLumpedReaction857( const Reaction& reaction ) {
    ...
    CHECK( id::ReactionID( "n,Li7->lumped7" ) == reaction.identifier() );
    ...
    auto partials = reaction.partialReactionIdentifiers().value();
    CHECK( 5 == partials.size() );
    CHECK( id::ReactionID( "n,Li7->n,Li7_e17" ) == partials[0] );
    CHECK( id::ReactionID( "n,Li7->n,Li7_e18" ) == partials[1] );
    CHECK( id::ReactionID( "n,Li7->n,Li7_e19" ) == partials[2] );
    CHECK( id::ReactionID( "n,Li7->n,Li7_e20" ) == partials[3] );
    CHECK( id::ReactionID( "n,Li7->n,Li7_e21" ) == partials[4] );
  ...
  void verifyLumpedReaction858( const Reaction& reaction ) {
    ...
    CHECK( id::ReactionID( "n,Li7->lumped8" ) == reaction.identifier() );
    ...
    auto partials = reaction.partialReactionIdentifiers().value();
    CHECK( 5 == partials.size() );
    CHECK( id::ReactionID( "n,Li7->n,Li7_e22" ) == partials[0] );
    CHECK( id::ReactionID( "n,Li7->n,Li7_e23" ) == partials[1] );
    CHECK( id::ReactionID( "n,Li7->n,Li7_e24" ) == partials[2] );
    CHECK( id::ReactionID( "n,Li7->n,Li7_e25" ) == partials[3] );
    CHECK( id::ReactionID( "n,Li7->n,Li7_e26" ) == partials[4] );
  ...
  void verifyLumpedReaction859( const Reaction& reaction ) {
    ...
    CHECK( id::ReactionID( "n,Li7->lumped9" ) == reaction.identifier() );
    ...
    CHECK( id::ReactionID( "n,Li7->n,Li7_e27" ) == partials[0] );
    CHECK( id::ReactionID( "n,Li7->n,Li7_e28" ) == partials[1] );
    CHECK( id::ReactionID( "n,Li7->n,Li7_e29" ) == partials[2] );
    CHECK( id::ReactionID( "n,Li7->n,Li7_e30" ) == partials[3] );
    CHECK( id::ReactionID( "n,Li7->n,Li7_e31" ) == partials[4] );
    CHECK( id::ReactionID( "n,Li7->n,Li7_e32" ) == partials[5] );
  ...
  void verifyCrossSectionCovariances( const covariance::CrossSectionCovarianceData& xs ) {
    ...
    CHECK( true == xs.hasCovarianceMatrix( id::ReactionID( "n,Li7->total" ) ) );
    CHECK( true == xs.hasCovarianceMatrix( id::ReactionID( "n,Li7->capture" ) ) );
    CHECK( true == xs.hasCovarianceMatrix( id::ReactionID( "n,Li7->n,Li7" ) ) );

    CHECK( 15 == xs.numberReactions() );
    CHECK( 15 == xs.reactionIdentifiers().size() );
    CHECK( id::ReactionID( "n,Li7->capture" ) == xs.reactionIdentifiers()[0] );

    CHECK( 39 == xs.numberCovarianceMatrices() );
    CHECK( 39 == xs.covariances().size() );

    using CrossSectionCovarianceMatrix = njoy::dryad::covariance::CrossSectionCovarianceMatrix;
    auto variant = xs.covarianceMatrix( id::ReactionID( "n,Li7->total" ) );
    auto matrix = std::get< CrossSectionCovarianceMatrix >( variant );
    CHECK( 1 == matrix.rowMetadata().reactionIdentifiers().size() );
    CHECK( id::ReactionID( "n,Li7->total" ) == matrix.rowMetadata().reactionIdentifiers()[0] );
    CHECK( 50 == matrix.rowMetadata().energies().size() );
    CHECK_THAT( 1e-5, WithinRel( matrix.rowMetadata().energies().front() ) );
    CHECK_THAT( 2e+7, WithinRel( matrix.rowMetadata().energies().back() ) );
    CHECK( matrix.columnMetadata() == matrix.rowMetadata() );
    CHECK( 49 == matrix.covariances().rows() );
    CHECK( 49 == matrix.covariances().cols() );
    CHECK(  0.          == matrix.covariances()(  0,  0) );
    CHECK(  0.          == matrix.covariances()(  0, 48) );
    CHECK(  0.          == matrix.covariances()( 48,  0) );
    CHECK(  2.522100e-4 == matrix.covariances()( 48, 48) );

    variant = xs.covarianceMatrix( id::ReactionID( "n,Li7->total" ), id::ReactionID( "n,Li7->n,Li7" ) );
    ...
    CHECK( id::ReactionID( "n,Li7->n,Li7" ) == matrix.columnMetadata().reactionIdentifiers()[0] );
    CHECK( 50 == matrix.columnMetadata().energies().size() );
    CHECK_THAT( 1e-5, WithinRel( matrix.columnMetadata().energies().front() ) );
    CHECK_THAT( 2e+7, WithinRel( matrix.columnMetadata().energies().back() ) );
    CHECK( 49 == matrix.covariances().rows() );
    CHECK( 49 == matrix.covariances().cols() );
    CHECK(  0.          == matrix.covariances()(  0,  0) );
    CHECK(  0.          == matrix.covariances()(  0, 48) );
    CHECK(  0.          == matrix.covariances()( 48,  0) );
    CHECK(  2.024700e-5 == matrix.covariances()( 48, 48) );

    variant = xs.covarianceMatrix( id::ReactionID( "n,Li7->total" ), id::ReactionID( "n,Li7->n,Li7[all]" ) );
    matrix = std::get< CrossSectionCovarianceMatrix >( variant );
    CHECK( 1 == matrix.rowMetadata().reactionIdentifiers().size() );
    CHECK( id::ReactionID( "n,Li7->total" ) == matrix.rowMetadata().reactionIdentifiers()[0] );
    CHECK( 50 == matrix.rowMetadata().energies().size() );
    ...
    CHECK_THAT( 2e+7, WithinRel( matrix.rowMetadata().energies().back() ) );
    CHECK( 1 == matrix.columnMetadata().reactionIdentifiers().size() );
    CHECK( id::ReactionID( "n,Li7->n,Li7[all]" ) == matrix.columnMetadata().reactionIdentifiers()[0] );
    CHECK( 50 == matrix.columnMetadata().energies().size() );
    CHECK_THAT( 1e-5, WithinRel( matrix.columnMetadata().energies().front() ) );
    CHECK_THAT( 2e+7, WithinRel( matrix.columnMetadata().energies().back() ) );
    CHECK( 49 == matrix.covariances().rows() );
    ...
    CHECK(  0.          == matrix.covariances()(  0, 48) );
    CHECK(  0.          == matrix.covariances()( 48,  0) );
    CHECK(  7.943300e-4 == matrix.covariances()( 48, 48) );

    variant = xs.covarianceMatrix( id::ReactionID( "n,Li7->total" ), id::ReactionID( "n,Li7->lumped1" ) );
    matrix = std::get< CrossSectionCovarianceMatrix >( variant );
    CHECK( 1 == matrix.rowMetadata().reactionIdentifiers().size() );
    CHECK( id::ReactionID( "n,Li7->total" ) == matrix.rowMetadata().reactionIdentifiers()[0] );
    CHECK( 50 == matrix.rowMetadata().energies().size() );
    ...
    CHECK_THAT( 2e+7, WithinRel( matrix.rowMetadata().energies().back() ) );
    CHECK( 1 == matrix.columnMetadata().reactionIdentifiers().size() );
    CHECK( id::ReactionID( "n,Li7->lumped1" ) == matrix.columnMetadata().reactionIdentifiers()[0] );
    CHECK( 50 == matrix.columnMetadata().energies().size() );
    CHECK_THAT( 1e-5, WithinRel( matrix.columnMetadata().energies().front() ) );
    CHECK_THAT( 2e+7, WithinRel( matrix.columnMetadata().energies().back() ) );
    CHECK( 49 == matrix.covariances().rows() );
    ...
    CHECK(  0.          == matrix.covariances()(  0, 48) );
    CHECK(  0.          == matrix.covariances()( 48,  0) );
    CHECK(  9.908100e-4 == matrix.covariances()( 48, 48) );

    variant = xs.covarianceMatrix( id::ReactionID( "n,Li7->n,Li7" ) );
    matrix = std::get< CrossSectionCovarianceMatrix >( variant );
    CHECK( 1 == matrix.rowMetadata().reactionIdentifiers().size() );
    CHECK( id::ReactionID( "n,Li7->n,Li7" ) == matrix.rowMetadata().reactionIdentifiers()[0] );
    ...
    CHECK(  2.500000e-3 == matrix.covariances()(  0,  0) );
    CHECK(  0.          == matrix.covariances()(  0,  1) );
    CHECK(  0.          == matrix.covariances()(  1,  0) );
    CHECK(  0.          == matrix.covariances()(  1,  1) );

    variant = xs.covarianceMatrix( id::ReactionID( "n,Li7->n,Li7[all]" ) );
    matrix = std::get< CrossSectionCovarianceMatrix >( variant );
    CHECK( 1 == matrix.rowMetadata().reactionIdentifiers().size() );
    CHECK( id::ReactionID( "n,Li7->n,Li7[all]" ) == matrix.rowMetadata().reactionIdentifiers()[0] );
    CHECK( 40 == matrix.rowMetadata().energies().size() );
    CHECK_THAT( 1e-5, WithinRel( matrix.rowMetadata().energies().front() ) );
    CHECK_THAT( 2e+7, WithinRel( matrix.rowMetadata().energies().back() ) );
    CHECK( matrix.columnMetadata() == matrix.rowMetadata() );
    CHECK( 39 == matrix.covariances().rows() );
    CHECK( 39 == matrix.covariances().cols() );
    CHECK(  0.          == matrix.covariances()(  0,  0) );
    CHECK(  0.          == matrix.covariances()(  0, 38) );
    CHECK(  0.          == matrix.covariances()( 38,  0) );
    CHECK(  2.881192e-1 == matrix.covariances()( 38, 38) );

    variant = xs.covarianceMatrix( id::ReactionID( "n,Li7->n,Li7[all]" ), id::ReactionID( "n,Li7->lumped1" ) );
    matrix = std::get< CrossSectionCovarianceMatrix >( variant );
    CHECK( 1 == matrix.rowMetadata().reactionIdentifiers().size() );
    CHECK( id::ReactionID( "n,Li7->n,Li7[all]" ) == matrix.rowMetadata().reactionIdentifiers()[0] );
    ...
    CHECK( 1 == matrix.columnMetadata().reactionIdentifiers().size() );
    CHECK( id::ReactionID( "n,Li7->lumped1" ) == matrix.columnMetadata().reactionIdentifiers()[0] );
    CHECK( 31 == matrix.columnMetadata().energies().size() );
    CHECK_THAT( 1e-5, WithinRel( matrix.columnMetadata().energies().front() ) );
    CHECK_THAT( 2e+7, WithinRel( matrix.columnMetadata().energies().back() ) );
    CHECK( 30 == matrix.covariances().rows() );
    CHECK( 30 == matrix.covariances().cols() );
    CHECK(  0.          == matrix.covariances()(  0,  0) );
    CHECK(  0.          == matrix.covariances()(  0, 29) );
    CHECK(  0.          == matrix.covariances()( 29,  0) );
    CHECK( -7.097800e-1 == matrix.covariances()( 29, 29) );
    ...
    CHECK( 14 == matrices[0].rowMetadata().energies().size() );
    CHECK_THAT( 1e-5, WithinRel( matrices[0].rowMetadata().energies().front() ) );
    CHECK_THAT( 2e+7, WithinRel( matrices[0].rowMetadata().energies().back() ) );
    CHECK( matrices[0].columnMetadata() == matrices[0].rowMetadata() );
    CHECK( 13 == matrices[0].covariances().rows() );
    CHECK( 13 == matrices[0].covariances().cols() );
    CHECK(  0.          == matrices[0].covariances()(  0,  0) );
    CHECK(  0.          == matrices[0].covariances()(  0, 12) );
    CHECK(  0.          == matrices[0].covariances()( 12,  0) );
    CHECK(  1.000000e+2 == matrices[0].covariances()( 12, 12) );

    CHECK( 1 == matrices[1].rowMetadata().reactionIdentifiers().size() );
    CHECK( id::ReactionID( "n,Li7->capture" ) == matrices[1].rowMetadata().reactionIdentifiers()[0] );
    CHECK( 3 == matrices[1].rowMetadata().energies().size() );
    CHECK_THAT( 1e-5, WithinRel( matrices[1].rowMetadata().energies().front() ) );
    CHECK_THAT( 2e+7, WithinRel( matrices[1].rowMetadata().energies().back() ) );
    CHECK( matrices[1].columnMetadata() == matrices[1].rowMetadata() );
    CHECK( 2 == matrices[1].covariances().rows() );
    CHECK( 2 == matrices[1].covariances().cols() );
    CHECK(  2.250000e-2 == matrices[1].covariances()(  0,  0) );
    CHECK(  0.          == matrices[1].covariances()(  0,  1) );
    CHECK(  0.          == matrices[1].covariances()(  1,  0) );
    CHECK(  0.          == matrices[1].covariances()(  1,  1) );

    variant = xs.covarianceMatrix( id::ReactionID( "n,Li7->d,He6[all]" ) );
    matrix = std::get< CrossSectionCovarianceMatrix >( variant );
    CHECK( 1 == matrix.rowMetadata().reactionIdentifiers().size() );
    CHECK( id::ReactionID( "n,Li7->d,He6[all]" ) == matrix.rowMetadata().reactionIdentifiers()[0] );
    CHECK( 7 == matrix.rowMetadata().energies().size() );
    CHECK_THAT( 1e-5, WithinRel( matrix.rowMetadata().energies().front() ) );
    CHECK_THAT( 2e+7, WithinRel( matrix.rowMetadata().energies().back() ) );
    CHECK( matrix.columnMetadata() == matrix.rowMetadata() );
    CHECK( 6 == matrix.covariances().rows() );
    CHECK( 6 == matrix.covariances().cols() );
    CHECK(  0.          == matrix.covariances()(  0,  0) );
    CHECK(  0.          == matrix.covariances()(  0,  5) );
    CHECK(  0.          == matrix.covariances()(  5,  0) );
    CHECK(  4.900000e-1 == matrix.covariances()(  5,  5) );

    variant = xs.covarianceMatrix( id::ReactionID( "n,Li7->lumped1" ) );
    matrix = std::get< CrossSectionCovarianceMatrix >( variant );
    CHECK( 1 == matrix.rowMetadata().reactionIdentifiers().size() );
    CHECK( id::ReactionID( "n,Li7->lumped1" ) == matrix.rowMetadata().reactionIdentifiers()[0] );
    CHECK( 16 == matrix.rowMetadata().energies().size() );
    CHECK_THAT( 1e-5, WithinRel( matrix.rowMetadata().energies().front() ) );
    CHECK_THAT( 2e+7, WithinRel( matrix.rowMetadata().energies().back() ) );
    CHECK( matrix.columnMetadata() == matrix.rowMetadata() );
    CHECK( 15 == matrix.covariances().rows() );
    CHECK( 15 == matrix.covariances().cols() );
    CHECK(  0.          == matrix.covariances()(  0,  0) );
    CHECK(  0.          == matrix.covariances()(  0, 14) );
    CHECK(  0.          == matrix.covariances()( 14,  0) );
    CHECK(  1.627100e+0 == matrix.covariances()( 14, 14) );

    variant = xs.covarianceMatrix( id::ReactionID( "n,Li7->lumped2" ) );
    matrix = std::get< CrossSectionCovarianceMatrix >( variant );
    CHECK( 1 == matrix.rowMetadata().reactionIdentifiers().size() );
    CHECK( id::ReactionID( "n,Li7->lumped2" ) == matrix.rowMetadata().reactionIdentifiers()[0] );
    CHECK( 41 == matrix.rowMetadata().energies().size() );
    CHECK_THAT( 1e-5, WithinRel( matrix.rowMetadata().energies().front() ) );
    CHECK_THAT( 2e+7, WithinRel( matrix.rowMetadata().energies().back() ) );
    CHECK( matrix.columnMetadata() == matrix.rowMetadata() );
    CHECK( 40 == matrix.covariances().rows() );
    CHECK( 40 == matrix.covariances().cols() );
    CHECK(  0.          == matrix.covariances()(  0,  0) );
    CHECK(  0.          == matrix.covariances()(  0, 39) );
    CHECK(  0.          == matrix.covariances()( 39,  0) );
    CHECK(  1.780719e-1 == matrix.covariances()( 39, 39) );

    variant = xs.covarianceMatrix( id::ReactionID( "n,Li7->lumped3" ) );
    matrix = std::get< CrossSectionCovarianceMatrix >( variant );
    CHECK( 1 == matrix.rowMetadata().reactionIdentifiers().size() );
    CHECK( id::ReactionID( "n,Li7->lumped3" ) == matrix.rowMetadata().reactionIdentifiers()[0] );
    CHECK( 14 == matrix.rowMetadata().energies().size() );
    CHECK_THAT( 1e-5, WithinRel( matrix.rowMetadata().energies().front() ) );
    CHECK_THAT( 2e+7, WithinRel( matrix.rowMetadata().energies().back() ) );
    CHECK( matrix.columnMetadata() == matrix.rowMetadata() );
    CHECK( 13 == matrix.covariances().rows() );
    CHECK( 13 == matrix.covariances().cols() );
    CHECK(  0.          == matrix.covariances()(  0,  0) );
    CHECK(  0.          == matrix.covariances()(  0, 12) );
    CHECK(  0.          == matrix.covariances()( 12,  0) );
    CHECK(  7.367020e-1 == matrix.covariances()( 12, 12) );

    variant = xs.covarianceMatrix( id::ReactionID( "n,Li7->lumped3" ), id::ReactionID( "n,Li7->lumped5" ) );
    matrix = std::get< CrossSectionCovarianceMatrix >( variant );
    CHECK( 1 == matrix.rowMetadata().reactionIdentifiers().size() );
    CHECK( id::ReactionID( "n,Li7->lumped3" ) == matrix.rowMetadata().reactionIdentifiers()[0] );
    CHECK( 14 == matrix.rowMetadata().energies().size() );
    ...
    CHECK_THAT( 2e+7, WithinRel( matrix.rowMetadata().energies().back() ) );
    CHECK( 1 == matrix.columnMetadata().reactionIdentifiers().size() );
    CHECK( id::ReactionID( "n,Li7->lumped5" ) == matrix.columnMetadata().reactionIdentifiers()[0] );
    CHECK( 14 == matrix.columnMetadata().energies().size() );
    CHECK_THAT( 1e-5, WithinRel( matrix.columnMetadata().energies().front() ) );
    CHECK_THAT( 2e+7, WithinRel( matrix.columnMetadata().energies().back() ) );
    CHECK( 13 == matrix.covariances().rows() );
    CHECK( 13 == matrix.covariances().cols() );
    ...
    CHECK(  0.          == matrix.covariances()(  0, 12) );
    CHECK(  0.          == matrix.covariances()( 12,  0) );
    CHECK(  1.203809e-2 == matrix.covariances()( 12, 12) );

    variant = xs.covarianceMatrix( id::ReactionID( "n,Li7->lumped3" ), id::ReactionID( "n,Li7->lumped6" ) );
    matrix = std::get< CrossSectionCovarianceMatrix >( variant );
    CHECK( 1 == matrix.rowMetadata().reactionIdentifiers().size() );
    CHECK( id::ReactionID( "n,Li7->lumped3" ) == matrix.rowMetadata().reactionIdentifiers()[0] );
    CHECK( 14 == matrix.rowMetadata().energies().size() );
    ...
    CHECK_THAT( 2e+7, WithinRel( matrix.rowMetadata().energies().back() ) );
    CHECK( 1 == matrix.columnMetadata().reactionIdentifiers().size() );
    CHECK( id::ReactionID( "n,Li7->lumped6" ) == matrix.columnMetadata().reactionIdentifiers()[0] );
    CHECK( 14 == matrix.columnMetadata().energies().size() );
    CHECK_THAT( 1e-5, WithinRel( matrix.columnMetadata().energies().front() ) );
    CHECK_THAT( 2e+7, WithinRel( matrix.columnMetadata().energies().back() ) );
    CHECK( 13 == matrix.covariances().rows() );
    ...
    CHECK(  0.          == matrix.covariances()(  0, 12) );
    CHECK(  0.          == matrix.covariances()( 12,  0) );
    CHECK(  9.553663e-3 == matrix.covariances()( 12, 12) );

    variant = xs.covarianceMatrix( id::ReactionID( "n,Li7->lumped3" ), id::ReactionID( "n,Li7->lumped7" ) );
    matrix = std::get< CrossSectionCovarianceMatrix >( variant );
    CHECK( 1 == matrix.rowMetadata().reactionIdentifiers().size() );
    CHECK( id::ReactionID( "n,Li7->lumped3" ) == matrix.rowMetadata().reactionIdentifiers()[0] );
    CHECK( 14 == matrix.rowMetadata().energies().size() );
    ...
    CHECK_THAT( 2e+7, WithinRel( matrix.rowMetadata().energies().back() ) );
    CHECK( 1 == matrix.columnMetadata().reactionIdentifiers().size() );
    CHECK( id::ReactionID( "n,Li7->lumped7" ) == matrix.columnMetadata().reactionIdentifiers()[0] );
    CHECK( 14 == matrix.columnMetadata().energies().size() );
    CHECK_THAT( 1e-5, WithinRel( matrix.columnMetadata().energies().front() ) );
    CHECK_THAT( 2e+7, WithinRel( matrix.columnMetadata().energies().back() ) );
    CHECK( 13 == matrix.covariances().rows() );
    ...
    CHECK(  0.          == matrix.covariances()(  0, 12) );
    CHECK(  0.          == matrix.covariances()( 12,  0) );
    CHECK( -2.580731e-3 == matrix.covariances()( 12, 12) );

    variant = xs.covarianceMatrix( id::ReactionID( "n,Li7->lumped3" ), id::ReactionID( "n,Li7->lumped8" ) );
    matrix = std::get< CrossSectionCovarianceMatrix >( variant );
    CHECK( 1 == matrix.rowMetadata().reactionIdentifiers().size() );
    CHECK( id::ReactionID( "n,Li7->lumped3" ) == matrix.rowMetadata().reactionIdentifiers()[0] );
    CHECK( 14 == matrix.rowMetadata().energies().size() );
    ...
    CHECK_THAT( 2e+7, WithinRel( matrix.rowMetadata().energies().back() ) );
    CHECK( 1 == matrix.columnMetadata().reactionIdentifiers().size() );
    CHECK( id::ReactionID( "n,Li7->lumped8" ) == matrix.columnMetadata().reactionIdentifiers()[0] );
    CHECK( 14 == matrix.columnMetadata().energies().size() );
    CHECK_THAT( 1e-5, WithinRel( matrix.columnMetadata().energies().front() ) );
    CHECK_THAT( 2e+7, WithinRel( matrix.columnMetadata().energies().back() ) );
    CHECK( 13 == matrix.covariances().rows() );
    ...
    CHECK(  0.          == matrix.covariances()(  0, 12) );
    CHECK(  0.          == matrix.covariances()( 12,  0) );
    CHECK( -3.332968e-3 == matrix.covariances()( 12, 12) );

    variant = xs.covarianceMatrix( id::ReactionID( "n,Li7->lumped3" ), id::ReactionID( "n,Li7->lumped9" ) );
    matrix = std::get< CrossSectionCovarianceMatrix >( variant );
    CHECK( 1 == matrix.rowMetadata().reactionIdentifiers().size() );
    CHECK( id::ReactionID( "n,Li7->lumped3" ) == matrix.rowMetadata().reactionIdentifiers()[0] );
    CHECK( 14 == matrix.rowMetadata().energies().size() );
    ...
    CHECK_THAT( 2e+7, WithinRel( matrix.rowMetadata().energies().back() ) );
    CHECK( 1 == matrix.columnMetadata().reactionIdentifiers().size() );
    CHECK( id::ReactionID( "n,Li7->lumped9" ) == matrix.columnMetadata().reactionIdentifiers()[0] );
    CHECK( 14 == matrix.columnMetadata().energies().size() );
    CHECK_THAT( 1e-5, WithinRel( matrix.columnMetadata().energies().front() ) );
    CHECK_THAT( 2e+7, WithinRel( matrix.columnMetadata().energies().back() ) );
    CHECK( 13 == matrix.covariances().rows() );
    ...
    CHECK(  0.          == matrix.covariances()(  0, 12) );
    CHECK(  0.          == matrix.covariances()( 12,  0) );
    CHECK( -5.839272e-4 == matrix.covariances()( 12, 12) );

    variant = xs.covarianceMatrix( id::ReactionID( "n,Li7->lumped4" ) );
    matrix = std::get< CrossSectionCovarianceMatrix >( variant );
    CHECK( 1 == matrix.rowMetadata().reactionIdentifiers().size() );
    CHECK( id::ReactionID( "n,Li7->lumped4" ) == matrix.rowMetadata().reactionIdentifiers()[0] );
    CHECK( 12 == matrix.rowMetadata().energies().size() );
    CHECK_THAT( 1e-5, WithinRel( matrix.rowMetadata().energies().front() ) );
    CHECK_THAT( 2e+7, WithinRel( matrix.rowMetadata().energies().back() ) );
    CHECK( matrix.columnMetadata() == matrix.rowMetadata() );
    CHECK( 11 == matrix.covariances().rows() );
    CHECK( 11 == matrix.covariances().cols() );
    CHECK(  0.          == matrix.covariances()(  0,  0) );
    CHECK(  0.          == matrix.covariances()(  0, 10) );
    CHECK(  0.          == matrix.covariances()( 10,  0) );
    CHECK(  6.786415e-1 == matrix.covariances()( 10, 10) );

    variant = xs.covarianceMatrix( id::ReactionID( "n,Li7->lumped4" ), id::ReactionID( "n,Li7->lumped5" ) );
    matrix = std::get< CrossSectionCovarianceMatrix >( variant );
    CHECK( 1 == matrix.rowMetadata().reactionIdentifiers().size() );
    CHECK( id::ReactionID( "n,Li7->lumped4" ) == matrix.rowMetadata().reactionIdentifiers()[0] );
    CHECK( 12 == matrix.rowMetadata().energies().size() );
    ...
    CHECK( 1 == matrix.columnMetadata().reactionIdentifiers().size() );
    CHECK( id::ReactionID( "n,Li7->lumped5" ) == matrix.columnMetadata().reactionIdentifiers()[0] );
    CHECK( 12 == matrix.columnMetadata().energies().size() );
    CHECK_THAT( 1e-5, WithinRel( matrix.columnMetadata().energies().front() ) );
    CHECK_THAT( 2e+7, WithinRel( matrix.columnMetadata().energies().back() ) );
    CHECK( 11 == matrix.covariances().rows() );
    CHECK( 11 == matrix.covariances().cols() );
    ...
    CHECK(  0.          == matrix.covariances()(  0, 10) );
    CHECK(  0.          == matrix.covariances()( 10,  0) );
    CHECK( -1.245011e-2 == matrix.covariances()( 10, 10) );

    variant = xs.covarianceMatrix( id::ReactionID( "n,Li7->lumped4" ), id::ReactionID( "n,Li7->lumped6" ) );
    matrix = std::get< CrossSectionCovarianceMatrix >( variant );
    CHECK( 1 == matrix.rowMetadata().reactionIdentifiers().size() );
    CHECK( id::ReactionID( "n,Li7->lumped4" ) == matrix.rowMetadata().reactionIdentifiers()[0] );
    CHECK( 12 == matrix.rowMetadata().energies().size() );
    ...
    CHECK(  0.          == matrix.covariances()(  0, 10) );
    CHECK(  0.          == matrix.covariances()( 10,  0) );
    CHECK( -2.184916e-2 == matrix.covariances()( 10, 10) );

    variant = xs.covarianceMatrix( id::ReactionID( "n,Li7->lumped4" ), id::ReactionID( "n,Li7->lumped7" ) );
    matrix = std::get< CrossSectionCovarianceMatrix >( variant );
    CHECK( 1 == matrix.rowMetadata().reactionIdentifiers().size() );
    CHECK( id::ReactionID( "n,Li7->lumped4" ) == matrix.rowMetadata().reactionIdentifiers()[0] );
    CHECK( 12 == matrix.rowMetadata().energies().size() );
    ...
    CHECK(  0.          == matrix.covariances()(  0, 10) );
    CHECK(  0.          == matrix.covariances()( 10,  0) );
    CHECK( -2.609350e-2 == matrix.covariances()( 10, 10) );

    variant = xs.covarianceMatrix( id::ReactionID( "n,Li7->lumped4" ), id::ReactionID( "n,Li7->lumped8" ) );
    matrix = std::get< CrossSectionCovarianceMatrix >( variant );
    CHECK( 1 == matrix.rowMetadata().reactionIdentifiers().size() );
    CHECK( id::ReactionID( "n,Li7->lumped4" ) == matrix.rowMetadata().reactionIdentifiers()[0] );
    CHECK( 12 == matrix.rowMetadata().energies().size() );
    ...
    CHECK(  0.          == matrix.covariances()(  0, 10) );
    CHECK(  0.          == matrix.covariances()( 10,  0) );
    CHECK( -3.434450e-2 == matrix.covariances()( 10, 10) );

    variant = xs.covarianceMatrix( id::ReactionID( "n,Li7->lumped4" ), id::ReactionID( "n,Li7->lumped9" ) );
    matrix = std::get< CrossSectionCovarianceMatrix >( variant );
    CHECK( 1 == matrix.rowMetadata().reactionIdentifiers().size() );
    CHECK( id::ReactionID( "n,Li7->lumped4" ) == matrix.rowMetadata().reactionIdentifiers()[0] );
    CHECK( 12 == matrix.rowMetadata().energies().size() );
    ...
    CHECK(  0.          == matrix.covariances()(  0, 10) );
    CHECK(  0.          == matrix.covariances()( 10,  0) );
    CHECK( -1.723969e-3 == matrix.covariances()( 10, 10) );

    variant = xs.covarianceMatrix( id::ReactionID( "n,Li7->lumped5" ) );
    matrix = std::get< CrossSectionCovarianceMatrix >( variant );
    CHECK( 1 == matrix.rowMetadata().reactionIdentifiers().size() );
    CHECK( id::ReactionID( "n,Li7->lumped5" ) == matrix.rowMetadata().reactionIdentifiers()[0] );
    CHECK( 12 == matrix.rowMetadata().energies().size() );
    CHECK_THAT( 1e-5, WithinRel( matrix.rowMetadata().energies().front() ) );
    CHECK_THAT( 2e+7, WithinRel( matrix.rowMetadata().energies().back() ) );
    CHECK( matrix.columnMetadata() == matrix.rowMetadata() );
    ...
    CHECK(  0.          == matrix.covariances()(  0, 10) );
    CHECK(  0.          == matrix.covariances()( 10,  0) );
    CHECK(  7.369322e-1 == matrix.covariances()( 10, 10) );

    variant = xs.covarianceMatrix( id::ReactionID( "n,Li7->lumped5" ), id::ReactionID( "n,Li7->lumped6" ) );
    matrix = std::get< CrossSectionCovarianceMatrix >( variant );
    CHECK( 1 == matrix.rowMetadata().reactionIdentifiers().size() );
    CHECK( id::ReactionID( "n,Li7->lumped5" ) == matrix.rowMetadata().reactionIdentifiers()[0] );
    CHECK( 12 == matrix.rowMetadata().energies().size() );
    ...
    CHECK(  0.          == matrix.covariances()(  0, 10) );
    CHECK(  0.          == matrix.covariances()( 10,  0) );
    CHECK(  9.042961e-3 == matrix.covariances()( 10, 10) );

    variant = xs.covarianceMatrix( id::ReactionID( "n,Li7->lumped5" ), id::ReactionID( "n,Li7->lumped7" ) );
    matrix = std::get< CrossSectionCovarianceMatrix >( variant );
    CHECK( 1 == matrix.rowMetadata().reactionIdentifiers().size() );
    CHECK( id::ReactionID( "n,Li7->lumped5" ) == matrix.rowMetadata().reactionIdentifiers()[0] );
    CHECK( 12 == matrix.rowMetadata().energies().size() );
    ...
    CHECK(  0.          == matrix.covariances()(  0, 10) );
    CHECK(  0.          == matrix.covariances()( 10,  0) );
    CHECK( -5.300280e-3 == matrix.covariances()( 10, 10) );

    variant = xs.covarianceMatrix( id::ReactionID( "n,Li7->lumped5" ), id::ReactionID( "n,Li7->lumped8" ) );
    matrix = std::get< CrossSectionCovarianceMatrix >( variant );
    CHECK( 1 == matrix.rowMetadata().reactionIdentifiers().size() );
    CHECK( id::ReactionID( "n,Li7->lumped5" ) == matrix.rowMetadata().reactionIdentifiers()[0] );
    CHECK( 12 == matrix.rowMetadata().energies().size() );
    ...
    CHECK(  0.          == matrix.covariances()(  0, 10) );
    CHECK(  0.          == matrix.covariances()( 10,  0) );
    CHECK( -6.486573e-3 == matrix.covariances()( 10, 10) );

    variant = xs.covarianceMatrix( id::ReactionID( "n,Li7->lumped5" ), id::ReactionID( "n,Li7->lumped9" ) );
    matrix = std::get< CrossSectionCovarianceMatrix >( variant );
    CHECK( 1 == matrix.rowMetadata().reactionIdentifiers().size() );
    CHECK( id::ReactionID( "n,Li7->lumped5" ) == matrix.rowMetadata().reactionIdentifiers()[0] );
    CHECK( 12 == matrix.rowMetadata().energies().size() );
    ...
    CHECK(  0.          == matrix.covariances()(  0, 10) );
    CHECK(  0.          == matrix.covariances()( 10,  0) );
    CHECK( -3.471211e-4 == matrix.covariances()( 10, 10) );

    variant = xs.covarianceMatrix( id::ReactionID( "n,Li7->lumped6" ) );
    matrix = std::get< CrossSectionCovarianceMatrix >( variant );
    CHECK( 1 == matrix.rowMetadata().reactionIdentifiers().size() );
    CHECK( id::ReactionID( "n,Li7->lumped6" ) == matrix.rowMetadata().reactionIdentifiers()[0] );
    CHECK( 9 == matrix.rowMetadata().energies().size() );
    CHECK_THAT( 1e-5, WithinRel( matrix.rowMetadata().energies().front() ) );
    CHECK_THAT( 2e+7, WithinRel( matrix.rowMetadata().energies().back() ) );
    CHECK( matrix.columnMetadata() == matrix.rowMetadata() );
    CHECK( 8 == matrix.covariances().rows() );
    CHECK( 8 == matrix.covariances().cols() );
    CHECK(  0.          == matrix.covariances()(  0,  0) );
    CHECK(  0.          == matrix.covariances()(  0,  7) );
    CHECK(  0.          == matrix.covariances()(  7,  0) );
    CHECK(  7.285110e-1 == matrix.covariances()(  7,  7) );

    variant = xs.covarianceMatrix( id::ReactionID( "n,Li7->lumped6" ), id::ReactionID( "n,Li7->lumped7" ) );
    matrix = std::get< CrossSectionCovarianceMatrix >( variant );
    CHECK( 1 == matrix.rowMetadata().reactionIdentifiers().size() );
    CHECK( id::ReactionID( "n,Li7->lumped6" ) == matrix.rowMetadata().reactionIdentifiers()[0] );
    CHECK( 9 == matrix.rowMetadata().energies().size() );
    ...
    CHECK( 1 == matrix.columnMetadata().reactionIdentifiers().size() );
    CHECK( id::ReactionID( "n,Li7->lumped7" ) == matrix.columnMetadata().reactionIdentifiers()[0] );
    CHECK( 9 == matrix.columnMetadata().energies().size() );
    CHECK_THAT( 1e-5, WithinRel( matrix.columnMetadata().energies().front() ) );
    CHECK_THAT( 2e+7, WithinRel( matrix.columnMetadata().energies().back() ) );
    CHECK( 8 == matrix.covariances().rows() );
    CHECK( 8 == matrix.covariances().cols() );
    ...
    CHECK(  0.          == matrix.covariances()(  0,  7) );
    CHECK(  0.          == matrix.covariances()(  7,  0) );
    CHECK(  1.560889e-3 == matrix.covariances()(  7,  7) );

    variant = xs.covarianceMatrix( id::ReactionID( "n,Li7->lumped6" ), id::ReactionID( "n,Li7->lumped8" ) );
    matrix = std::get< CrossSectionCovarianceMatrix >( variant );
    CHECK( 1 == matrix.rowMetadata().reactionIdentifiers().size() );
    CHECK( id::ReactionID( "n,Li7->lumped6" ) == matrix.rowMetadata().reactionIdentifiers()[0] );
    CHECK( 9 == matrix.rowMetadata().energies().size() );
    ...
    CHECK(  0.          == matrix.covariances()(  0,  7) );
    CHECK(  0.          == matrix.covariances()(  7,  0) );
    CHECK( -1.174697e-2 == matrix.covariances()(  7,  7) );

    variant = xs.covarianceMatrix( id::ReactionID( "n,Li7->lumped6" ), id::ReactionID( "n,Li7->lumped9" ) );
    matrix = std::get< CrossSectionCovarianceMatrix >( variant );
    CHECK( 1 == matrix.rowMetadata().reactionIdentifiers().size() );
    CHECK( id::ReactionID( "n,Li7->lumped6" ) == matrix.rowMetadata().reactionIdentifiers()[0] );
    CHECK( 9 == matrix.rowMetadata().energies().size() );
    ...
    CHECK(  0.          == matrix.covariances()(  0,  7) );
    CHECK(  0.          == matrix.covariances()(  7,  0) );
    CHECK( -5.036459e-4 == matrix.covariances()(  7,  7) );

    variant = xs.covarianceMatrix( id::ReactionID( "n,Li7->lumped7" ) );
    matrix = std::get< CrossSectionCovarianceMatrix >( variant );
    CHECK( 1 == matrix.rowMetadata().reactionIdentifiers().size() );
    CHECK( id::ReactionID( "n,Li7->lumped7" ) == matrix.rowMetadata().reactionIdentifiers()[0] );
    CHECK( 6 == matrix.rowMetadata().energies().size() );
    CHECK_THAT( 1e-5, WithinRel( matrix.rowMetadata().energies().front() ) );
    CHECK_THAT( 2e+7, WithinRel( matrix.rowMetadata().energies().back() ) );
    CHECK( matrix.columnMetadata() == matrix.rowMetadata() );
    CHECK( 5 == matrix.covariances().rows() );
    CHECK( 5 == matrix.covariances().cols() );
    CHECK(  0.          == matrix.covariances()(  0,  0) );
    CHECK(  0.          == matrix.covariances()(  0,  4) );
    CHECK(  0.          == matrix.covariances()(  4,  0) );
    CHECK(  7.253366e-1 == matrix.covariances()(  4,  4) );

    variant = xs.covarianceMatrix( id::ReactionID( "n,Li7->lumped7" ), id::ReactionID( "n,Li7->lumped8" ) );
    matrix = std::get< CrossSectionCovarianceMatrix >( variant );
    CHECK( 1 == matrix.rowMetadata().reactionIdentifiers().size() );
    CHECK( id::ReactionID( "n,Li7->lumped7" ) == matrix.rowMetadata().reactionIdentifiers()[0] );
    CHECK( 6 == matrix.rowMetadata().energies().size() );
    ...
    CHECK( 1 == matrix.columnMetadata().reactionIdentifiers().size() );
    CHECK( id::ReactionID( "n,Li7->lumped8" ) == matrix.columnMetadata().reactionIdentifiers()[0] );
    CHECK( 6 == matrix.columnMetadata().energies().size() );
    CHECK_THAT( 1e-5, WithinRel( matrix.columnMetadata().energies().front() ) );
    CHECK_THAT( 2e+7, WithinRel( matrix.columnMetadata().energies().back() ) );
    CHECK( 5 == matrix.covariances().rows() );
    CHECK( 5 == matrix.covariances().cols() );
    ...
    CHECK(  0.          == matrix.covariances()(  0,  4) );
    CHECK(  0.          == matrix.covariances()(  4,  0) );
    CHECK( -1.809826e-3 == matrix.covariances()(  4,  4) );

    variant = xs.covarianceMatrix( id::ReactionID( "n,Li7->lumped7" ), id::ReactionID( "n,Li7->lumped9" ) );
    matrix = std::get< CrossSectionCovarianceMatrix >( variant );
    CHECK( 1 == matrix.rowMetadata().reactionIdentifiers().size() );
    CHECK( id::ReactionID( "n,Li7->lumped7" ) == matrix.rowMetadata().reactionIdentifiers()[0] );
    CHECK( 6 == matrix.rowMetadata().energies().size() );
    ...
    CHECK(  0.          == matrix.covariances()(  0,  4) );
    CHECK(  0.          == matrix.covariances()(  4,  0) );
    CHECK( -8.149520e-4 == matrix.covariances()(  4,  4) );

    variant = xs.covarianceMatrix( id::ReactionID( "n,Li7->lumped8" ) );
    matrix = std::get< CrossSectionCovarianceMatrix >( variant );
    CHECK( 1 == matrix.rowMetadata().reactionIdentifiers().size() );
    CHECK( id::ReactionID( "n,Li7->lumped8" ) == matrix.rowMetadata().reactionIdentifiers()[0] );
    CHECK( 5 == matrix.rowMetadata().energies().size() );
    CHECK_THAT( 1e-5, WithinRel( matrix.rowMetadata().energies().front() ) );
    CHECK_THAT( 2e+7, WithinRel( matrix.rowMetadata().energies().back() ) );
    CHECK( matrix.columnMetadata() == matrix.rowMetadata() );
    CHECK( 4 == matrix.covariances().rows() );
    CHECK( 4 == matrix.covariances().cols() );
    CHECK(  0.          == matrix.covariances()(  0,  0) );
    CHECK(  0.          == matrix.covariances()(  0,  3) );
    CHECK(  0.          == matrix.covariances()(  3,  0) );
    CHECK(  7.164219e-1 == matrix.covariances()(  3,  3) );

    variant = xs.covarianceMatrix( id::ReactionID( "n,Li7->lumped8" ), id::ReactionID( "n,Li7->lumped9" ) );
    matrix = std::get< CrossSectionCovarianceMatrix >( variant );
    CHECK( 1 == matrix.rowMetadata().reactionIdentifiers().size() );
    CHECK( id::ReactionID( "n,Li7->lumped8" ) == matrix.rowMetadata().reactionIdentifiers()[0] );
    CHECK( 5 == matrix.rowMetadata().energies().size() );
    ...
    CHECK( 1 == matrix.columnMetadata().reactionIdentifiers().size() );
    CHECK( id::ReactionID( "n,Li7->lumped9" ) == matrix.columnMetadata().reactionIdentifiers()[0] );
    CHECK( 5 == matrix.columnMetadata().energies().size() );
    CHECK_THAT( 1e-5, WithinRel( matrix.columnMetadata().energies().front() ) );
    CHECK_THAT( 2e+7, WithinRel( matrix.columnMetadata().energies().back() ) );
    CHECK( 4 == matrix.covariances().rows() );
    CHECK( 4 == matrix.covariances().cols() );
    ...
    CHECK(  0.          == matrix.covariances()(  0,  3) );
    CHECK(  0.          == matrix.covariances()(  3,  0) );
    CHECK(  1.068280e-2 == matrix.covariances()(  3,  3) );

    variant = xs.covarianceMatrix( id::ReactionID( "n,Li7->lumped9" ) );
    matrix = std::get< CrossSectionCovarianceMatrix >( variant );
    CHECK( 1 == matrix.rowMetadata().reactionIdentifiers().size() );
    CHECK( id::ReactionID( "n,Li7->lumped9" ) == matrix.rowMetadata().reactionIdentifiers()[0] );
    ...
    CHECK(  0.          == matrix.covariances()(  0,  0) );
    CHECK(  0.          == matrix.covariances()(  0,  2) );
    CHECK(  0.          == matrix.covariances()(  2,  0) );
  ...
  void verifyLi7( const ProjectileTarget& Li7, bool /* normalise */ ) {
    ...
    CHECK( true == Li7.hasReaction( id::ReactionID( "n,Li7->n,Li7[all]" ) ) );
    CHECK( true == Li7.hasReaction( id::ReactionID( "n,Li7->2n,Li6[all]" ) ) );
    CHECK( true == Li7.hasReaction( id::ReactionID( "n,Li7->2n,a,H2[all]" ) ) );
    CHECK( true == Li7.hasReaction( id::ReactionID( "n,Li7->3n,a,H1[all]" ) ) );
    CHECK( true == Li7.hasReaction( id::ReactionID( "n,Li7->n,Li7_e1" ) ) );
    CHECK( true == Li7.hasReaction( id::ReactionID( "n,Li7->n,Li7_e2" ) ) );
    CHECK( true == Li7.hasReaction( id::ReactionID( "n,Li7->n,Li7_e3" ) ) );
    CHECK( true == Li7.hasReaction( id::ReactionID( "n,Li7->n,Li7_e4" ) ) );
    CHECK( true == Li7.hasReaction( id::ReactionID( "n,Li7->n,Li7_e5" ) ) );
    CHECK( true == Li7.hasReaction( id::ReactionID( "n,Li7->n,Li7_e6" ) ) );
    CHECK( true == Li7.hasReaction( id::ReactionID( "n,Li7->n,Li7_e7" ) ) );
    CHECK( true == Li7.hasReaction( id::ReactionID( "n,Li7->n,Li7_e8" ) ) );
    CHECK( true == Li7.hasReaction( id::ReactionID( "n,Li7->n,Li7_e9" ) ) );
    CHECK( true == Li7.hasReaction( id::ReactionID( "n,Li7->n,Li7_e10" ) ) );
    CHECK( true == Li7.hasReaction( id::ReactionID( "n,Li7->n,Li7_e11" ) ) );
    CHECK( true == Li7.hasReaction( id::ReactionID( "n,Li7->n,Li7_e12" ) ) );
    CHECK( true == Li7.hasReaction( id::ReactionID( "n,Li7->n,Li7_e13" ) ) );
    CHECK( true == Li7.hasReaction( id::ReactionID( "n,Li7->n,Li7_e14" ) ) );
    CHECK( true == Li7.hasReaction( id::ReactionID( "n,Li7->n,Li7_e15" ) ) );
    CHECK( true == Li7.hasReaction( id::ReactionID( "n,Li7->n,Li7_e16" ) ) );
    CHECK( true == Li7.hasReaction( id::ReactionID( "n,Li7->n,Li7_e17" ) ) );
    CHECK( true == Li7.hasReaction( id::ReactionID( "n,Li7->n,Li7_e18" ) ) );
    CHECK( true == Li7.hasReaction( id::ReactionID( "n,Li7->n,Li7_e19" ) ) );
    CHECK( true == Li7.hasReaction( id::ReactionID( "n,Li7->n,Li7_e20" ) ) );
    CHECK( true == Li7.hasReaction( id::ReactionID( "n,Li7->n,Li7_e21" ) ) );
    CHECK( true == Li7.hasReaction( id::ReactionID( "n,Li7->n,Li7_e22" ) ) );
    CHECK( true == Li7.hasReaction( id::ReactionID( "n,Li7->n,Li7_e23" ) ) );
    CHECK( true == Li7.hasReaction( id::ReactionID( "n,Li7->n,Li7_e24" ) ) );
    CHECK( true == Li7.hasReaction( id::ReactionID( "n,Li7->n,Li7_e25" ) ) );
    CHECK( true == Li7.hasReaction( id::ReactionID( "n,Li7->n,Li7_e26" ) ) );
    CHECK( true == Li7.hasReaction( id::ReactionID( "n,Li7->n,Li7_e27" ) ) );
    CHECK( true == Li7.hasReaction( id::ReactionID( "n,Li7->n,Li7_e28" ) ) );
    CHECK( true == Li7.hasReaction( id::ReactionID( "n,Li7->n,Li7_e29" ) ) );
    CHECK( true == Li7.hasReaction( id::ReactionID( "n,Li7->n,Li7_e30" ) ) );
    CHECK( true == Li7.hasReaction( id::ReactionID( "n,Li7->n,Li7_e31" ) ) );
    CHECK( true == Li7.hasReaction( id::ReactionID( "n,Li7->n,Li7_e32" ) ) );
    CHECK( true == Li7.hasReaction( id::ReactionID( "n,Li7->g,Li8[all]" ) ) );
    CHECK( true == Li7.hasReaction( id::ReactionID( "n,Li7->d,He6[all]" ) ) );
    CHECK( true == Li7.hasReaction( id::ReactionID( "n,Li7->lumped1" ) ) );
    CHECK( true == Li7.hasReaction( id::ReactionID( "n,Li7->lumped2" ) ) );
    CHECK( true == Li7.hasReaction( id::ReactionID( "n,Li7->lumped3" ) ) );
    CHECK( true == Li7.hasReaction( id::ReactionID( "n,Li7->lumped4" ) ) );
    CHECK( true == Li7.hasReaction( id::ReactionID( "n,Li7->lumped5" ) ) );
    CHECK( true == Li7.hasReaction( id::ReactionID( "n,Li7->lumped6" ) ) );
    CHECK( true == Li7.hasReaction( id::ReactionID( "n,Li7->lumped7" ) ) );
    CHECK( true == Li7.hasReaction( id::ReactionID( "n,Li7->lumped8" ) ) );
    CHECK( true == Li7.hasReaction( id::ReactionID( "n,Li7->lumped9" ) ) );
//    CHECK( false == Li7.hasReaction( id::ReactionID( "some unknown reaction" ) ) );
    ...
    total = Li7.reaction( id::ReactionID( "n,Li7->total" ) );
    neutron::li7::verifyTotalReaction( total );
    ...
    lumped = Li7.reaction( id::ReactionID( "n,Li7->lumped1" ) );
    neutron::li7::verifyLumpedReaction851( lumped );

    lumped = Li7.reaction( id::ReactionID( "n,Li7->lumped2" ) );
    neutron::li7::verifyLumpedReaction852( lumped );

    lumped = Li7.reaction( id::ReactionID( "n,Li7->lumped3" ) );
    neutron::li7::verifyLumpedReaction853( lumped );

    lumped = Li7.reaction( id::ReactionID( "n,Li7->lumped4" ) );
    neutron::li7::verifyLumpedReaction854( lumped );

    lumped = Li7.reaction( id::ReactionID( "n,Li7->lumped5" ) );
    neutron::li7::verifyLumpedReaction855( lumped );

    lumped = Li7.reaction( id::ReactionID( "n,Li7->lumped6" ) );
    neutron::li7::verifyLumpedReaction856( lumped );

    lumped = Li7.reaction( id::ReactionID( "n,Li7->lumped7" ) );
    neutron::li7::verifyLumpedReaction857( lumped );

    lumped = Li7.reaction( id::ReactionID( "n,Li7->lumped8" ) );
    neutron::li7::verifyLumpedReaction858( lumped );
