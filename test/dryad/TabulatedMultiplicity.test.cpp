...
SCENARIO( "TabulatedMultiplicity" ) {
  ...
  GIVEN( "linearised data without boundaries and no jumps" ) {
    ...
    WHEN( "the data is given explicitly" ) {
      ...
      TabulatedMultiplicity chunk( std::move( energies ), std::move( values ) );
      ...
      THEN( "a TabulatedMultiplicity can be evaluated" ) {
      ...
      THEN( "arithmetic operations can be performed" ) {
        ...
        TabulatedMultiplicity result( { 1., 4. }, { 0., 0. } );
        TabulatedMultiplicity same( { 1., 4. }, { 0., 3. } );
        TabulatedMultiplicity threshold( { 2., 4. }, { 0., 2. } );
        TabulatedMultiplicity nonzerothreshold( { 2., 4. }, { 1., 3. } );
        TabulatedMultiplicity small( { 1., 3. }, { 0., 2. } );
      ...
      THEN( "a TabulatedMultiplicity can be linearised" ) {
  ...
  GIVEN( "linearised data without boundaries and a jump" ) {
    ...
    WHEN( "the data is given explicitly" ) {
      ...
      THEN( "arithmetic operations can be performed" ) {
        ...
        TabulatedMultiplicity same( { 1., 4. }, { 0., 3. } );
        TabulatedMultiplicity threshold( { 2., 4. }, { 0., 2. } );
        TabulatedMultiplicity nonzerothreshold( { 3., 4. }, { 1., 2. } );
        TabulatedMultiplicity small( { 1., 3. }, { 0., 2. } );
  ...
  GIVEN( "non-linearised data with multiple regions without a jump" ) {
    ...
    WHEN( "the data is given explicitly" ) {
      ...
      TabulatedMultiplicity chunk( std::move( energies ),
                                   std::move( values ),
                                   std::move( boundaries ),
      ...
      THEN( "some arithmetic operations cannot be performed" ) {
        ...
        TabulatedMultiplicity result( { 1., 4. }, { 0., 0. } );
        TabulatedMultiplicity right( { 1., 4. }, { 0., 0. } );
  ...
  GIVEN( "non-linearised data with multiple regions with a jump that consist of "
    ...
    WHEN( "the data is given explicitly" ) {
      ...
      TabulatedMultiplicity chunk( std::move( x ), std::move( y ),
                             std::move( boundaries ),
                             std::move( interpolants ) );
  ...
  GIVEN( "invalid data for an TabulatedMultiplicity object" ) {
    ...
    WHEN( "there are not enough values in the x or y grid" ) {
      ...
      THEN( "an exception is thrown" ) {
        ...
        CHECK_THROWS( TabulatedMultiplicity( empty, empty ) );
        CHECK_THROWS( TabulatedMultiplicity( one, one ) );
      } // THEN
    } // WHEN
    ...
    WHEN( "the x and y grid do not have the same number of points" ) {
      ...
      THEN( "an exception is thrown" ) {
        ...
        CHECK_THROWS( TabulatedMultiplicity( std::move( x ), std::move( y ) ) );
      } // THEN
    } // WHEN
