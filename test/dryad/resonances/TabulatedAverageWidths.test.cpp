...
SCENARIO( "TabulatedAverageWidths" ) {
  ...
  GIVEN( "linearised data without boundaries and no jumps" ) {
    ...
    WHEN( "the data is given explicitly" ) {
      ...
      TabulatedAverageWidths chunk( std::move( energies ), std::move( values ) );

      THEN( "a TabulatedAverageWidths can be constructed and members can be tested" ) {
      ...
      THEN( "a TabulatedAverageWidths can be evaluated" ) {
      ...
      THEN( "arithmetic operations can be performed" ) {
        ...
        TabulatedAverageWidths result( { 1., 4. }, { 0., 0. } );
        TabulatedAverageWidths same( { 1., 4. }, { 0., 3. } );
        TabulatedAverageWidths threshold( { 2., 4. }, { 0., 2. } );
        TabulatedAverageWidths nonzerothreshold( { 2., 4. }, { 1., 3. } );
        TabulatedAverageWidths small( { 1., 3. }, { 0., 2. } );
      ...
      THEN( "a TabulatedAverageWidths can be linearised" ) {

        TabulatedAverageWidths linear = chunk.linearise();
  ...
  GIVEN( "linearised data without boundaries and a jump" ) {
    ...
    WHEN( "the data is given explicitly" ) {
      ...
      THEN( "arithmetic operations can be performed" ) {
        ...
        TabulatedAverageWidths same( { 1., 4. }, { 0., 3. } );
        TabulatedAverageWidths threshold( { 2., 4. }, { 0., 2. } );
        TabulatedAverageWidths nonzerothreshold( { 3., 4. }, { 1., 2. } );
        TabulatedAverageWidths small( { 1., 3. }, { 0., 2. } );
  ...
  GIVEN( "non-linearised data with multiple regions without a jump" ) {
    ...
    WHEN( "the data is given explicitly" ) {
      ...
      TabulatedAverageWidths chunk( std::move( energies ),
                                   std::move( values ),
                                   std::move( boundaries ),
      ...
      THEN( "some arithmetic operations cannot be performed" ) {
        ...
        TabulatedAverageWidths result( { 1., 4. }, { 0., 0. } );
        TabulatedAverageWidths right( { 1., 4. }, { 0., 0. } );
  ...
  GIVEN( "non-linearised data with multiple regions with a jump that consist of "
    ...
    WHEN( "the data is given explicitly" ) {
      ...
      TabulatedAverageWidths chunk( std::move( x ), std::move( y ),
                                   std::move( boundaries ),
                                   std::move( interpolants ) );
  ...
  GIVEN( "non-linearised data with multiple regions with a jump and boundaries "
    ...
    //       the jump. As a result, the final data contained in this TabulatedAverageWidths is the
  ...
  GIVEN( "non-linearised data with multiple regions with a jump at the end" ) {
    ...
    WHEN( "the data is given explicitly" ) {
      ...
      THEN( "an TabulatedAverageWidths can be constructed and members can be tested" ) {
  ...
  GIVEN( "comparison operators" ) {
    ...
    WHEN( "two instances of TabulatedAverageWidths are given" ) {

      TabulatedAverageWidths left( { 1., 2., 3., 4. }, { 4., 3., 2., 1. } );
      TabulatedAverageWidths equal( { 1., 2., 3., 4. }, { 4., 3., 2., 1. } );
      TabulatedAverageWidths different( { 1., 4. }, { 4., 1. } );
  ...
  GIVEN( "invalid data for an TabulatedAverageWidths object" ) {
    ...
    WHEN( "there are not enough values in the x or y grid" ) {
      ...
      THEN( "an exception is thrown" ) {
        ...
        CHECK_THROWS( TabulatedAverageWidths( empty, empty ) );
        CHECK_THROWS( TabulatedAverageWidths( one, one ) );
      } // THEN
    } // WHEN
    ...
    WHEN( "the x and y grid do not have the same number of points" ) {
      ...
      THEN( "an exception is thrown" ) {
        ...
        CHECK_THROWS( TabulatedAverageWidths( std::move( x ), std::move( y ) ) );
      } // THEN
    } // WHEN
