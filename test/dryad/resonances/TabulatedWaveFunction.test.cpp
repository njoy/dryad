...
SCENARIO( "TabulatedWaveFunction" ) {

  GIVEN( "linearised data without boundaries and no jumps" ) {

    WHEN( "the data is given explicitly" ) {

      const std::vector< double > ratios = { 1., 2., 3., 4. };
      const std::vector< double > values = { 4., 3., 2., 1. };

      TabulatedWaveFunction chunk( std::move( ratios ), std::move( values ) );

      THEN( "a TabulatedWaveFunction can be constructed and members can be tested" ) {

        CHECK_THAT( 1., WithinRel( chunk.lowerRatioLimit() ) );
        CHECK_THAT( 4., WithinRel( chunk.upperRatioLimit() ) );
        CHECK( 4 == chunk.numberPoints() );
        CHECK( 1 == chunk.numberRegions() );
        CHECK( 4 == chunk.ratios().size() );
        CHECK( 4 == chunk.values().size() );
        CHECK( 1 == chunk.boundaries().size() );
        CHECK( 1 == chunk.interpolants().size() );
        CHECK_THAT( 1., WithinRel( chunk.ratios()[0] ) );
        CHECK_THAT( 2., WithinRel( chunk.ratios()[1] ) );
        CHECK_THAT( 3., WithinRel( chunk.ratios()[2] ) );
        CHECK_THAT( 4., WithinRel( chunk.ratios()[3] ) );
      ...
      THEN( "a TabulatedWaveFunction can be evaluated" ) {
      ...
      THEN( "arithmetic operations can be performed" ) {
        ...
        TabulatedWaveFunction result( { 1., 4. }, { 0., 0. } );
        TabulatedWaveFunction same( { 1., 4. }, { 0., 3. } );
        TabulatedWaveFunction threshold( { 2., 4. }, { 0., 2. } );
        TabulatedWaveFunction nonzerothreshold( { 2., 4. }, { 1., 3. } );
        TabulatedWaveFunction small( { 1., 3. }, { 0., 2. } );
        ...
        CHECK( 4 == result.ratios().size() );
        CHECK( 4 == result.values().size() );
        CHECK( 1 == result.boundaries().size() );
        CHECK( 1 == result.interpolants().size() );
        CHECK_THAT(  1., WithinRel( result.ratios()[0] ) );
        CHECK_THAT(  2., WithinRel( result.ratios()[1] ) );
        CHECK_THAT(  3., WithinRel( result.ratios()[2] ) );
        CHECK_THAT(  4., WithinRel( result.ratios()[3] ) );
        ...
        CHECK( 5 == chunk.ratios().size() );
        CHECK( 5 == chunk.values().size() );
        CHECK( 2 == chunk.boundaries().size() );
        CHECK( 2 == chunk.interpolants().size() );
        CHECK_THAT( 1., WithinRel( chunk.ratios()[0] ) );
        CHECK_THAT( 2., WithinRel( chunk.ratios()[1] ) );
        CHECK_THAT( 2., WithinRel( chunk.ratios()[2] ) );
        CHECK_THAT( 3., WithinRel( chunk.ratios()[3] ) );
        CHECK_THAT( 4., WithinRel( chunk.ratios()[4] ) );
        CHECK_THAT( 4., WithinRel( chunk.values()[0] ) );
        CHECK_THAT( 3., WithinRel( chunk.values()[1] ) );
        CHECK_THAT( 4., WithinRel( chunk.values()[2] ) );
        ...
        CHECK( 5 == result.ratios().size() );
        CHECK( 5 == result.values().size() );
        CHECK( 2 == result.boundaries().size() );
        CHECK( 2 == result.interpolants().size() );
        CHECK_THAT( 1., WithinRel( result.ratios()[0] ) );
        CHECK_THAT( 2., WithinRel( result.ratios()[1] ) );
        CHECK_THAT( 2., WithinRel( result.ratios()[2] ) );
        CHECK_THAT( 3., WithinRel( result.ratios()[3] ) );
        CHECK_THAT( 4., WithinRel( result.ratios()[4] ) );
        CHECK_THAT( 4., WithinRel( result.values()[0] ) );
        CHECK_THAT( 3., WithinRel( result.values()[1] ) );
        CHECK_THAT( 4., WithinRel( result.values()[2] ) );
      ...
      THEN( "a TabulatedWaveFunction can be linearised" ) {

        TabulatedWaveFunction linear = chunk.linearise();

        CHECK( 4 == linear.numberPoints() );
        CHECK( 1 == linear.numberRegions() );

        CHECK( 4 == linear.ratios().size() );
        ...
        CHECK_THAT( 1., WithinRel( linear.ratios()[0] ) );
        CHECK_THAT( 2., WithinRel( linear.ratios()[1] ) );
        CHECK_THAT( 3., WithinRel( linear.ratios()[2] ) );
        CHECK_THAT( 4., WithinRel( linear.ratios()[3] ) );
  ...
  GIVEN( "linearised data without boundaries and a jump" ) {
    ...
    WHEN( "the data is given explicitly" ) {
      ...
      const std::vector< double > ratios = { 1., 2., 2., 3., 4. };
      ...
      THEN( "arithmetic operations can be performed" ) {
        ...
        TabulatedWaveFunction same( { 1., 4. }, { 0., 3. } );
        TabulatedWaveFunction threshold( { 2., 4. }, { 0., 2. } );
        TabulatedWaveFunction nonzerothreshold( { 3., 4. }, { 1., 2. } );
        TabulatedWaveFunction small( { 1., 3. }, { 0., 2. } );
        ...
        CHECK_THAT( 2., WithinRel( chunk.ratios()[2] ) );
        CHECK_THAT( 3., WithinRel( chunk.ratios()[3] ) );
        CHECK_THAT( 3., WithinRel( chunk.ratios()[4] ) );
        CHECK_THAT( 4., WithinRel( chunk.ratios()[5] ) );
        CHECK_THAT( 4., WithinRel( chunk.values()[0] ) );
        CHECK_THAT( 3., WithinRel( chunk.values()[1] ) );
        CHECK_THAT( 4., WithinRel( chunk.values()[2] ) );
        CHECK_THAT( 3., WithinRel( chunk.values()[3] ) );
        ...
        CHECK_THAT( 2., WithinRel( result.ratios()[2] ) );
        CHECK_THAT( 3., WithinRel( result.ratios()[3] ) );
        CHECK_THAT( 3., WithinRel( result.ratios()[4] ) );
        CHECK_THAT( 4., WithinRel( result.ratios()[5] ) );
        CHECK_THAT( 4., WithinRel( result.values()[0] ) );
        CHECK_THAT( 3., WithinRel( result.values()[1] ) );
        CHECK_THAT( 4., WithinRel( result.values()[2] ) );
        CHECK_THAT( 3., WithinRel( result.values()[3] ) );
      ...
      THEN( "a TabulatedWaveFunction can be linearised" ) {
        ...
        CHECK_THAT( 1., WithinRel( linear.ratios()[0] ) );
        CHECK_THAT( 2., WithinRel( linear.ratios()[1] ) );
        CHECK_THAT( 2., WithinRel( linear.ratios()[2] ) );
        CHECK_THAT( 3., WithinRel( linear.ratios()[3] ) );
        CHECK_THAT( 4., WithinRel( linear.ratios()[4] ) );
  ...
  GIVEN( "non-linearised data with multiple regions without a jump" ) {
    ...
    WHEN( "the data is given explicitly" ) {
      ...
      TabulatedWaveFunction chunk( std::move( ratios ),
                                   std::move( values ),
                                   std::move( boundaries ),
      ...
      THEN( "some arithmetic operations cannot be performed" ) {
        ...
        TabulatedWaveFunction result( { 1., 4. }, { 0., 0. } );
        TabulatedWaveFunction right( { 1., 4. }, { 0., 0. } );
      ...
      THEN( "a TabulatedWaveFunction can be linearised" ) {
        ...
        CHECK_THAT( 1.   , WithinRel( linear.ratios()[0] ) );
        CHECK_THAT( 2.   , WithinRel( linear.ratios()[1] ) );
        CHECK_THAT( 2.125, WithinRel( linear.ratios()[2] ) );
        CHECK_THAT( 2.25 , WithinRel( linear.ratios()[3] ) );
        CHECK_THAT( 2.375, WithinRel( linear.ratios()[4] ) );
        CHECK_THAT( 2.5  , WithinRel( linear.ratios()[5] ) );
        CHECK_THAT( 2.625, WithinRel( linear.ratios()[6] ) );
        CHECK_THAT( 2.75 , WithinRel( linear.ratios()[7] ) );
        CHECK_THAT( 2.875, WithinRel( linear.ratios()[8] ) );
        CHECK_THAT( 3.   , WithinRel( linear.ratios()[9] ) );
        CHECK_THAT( 3.125, WithinRel( linear.ratios()[10] ) );
        CHECK_THAT( 3.25 , WithinRel( linear.ratios()[11] ) );
        CHECK_THAT( 3.375, WithinRel( linear.ratios()[12] ) );
        CHECK_THAT( 3.5  , WithinRel( linear.ratios()[13] ) );
        CHECK_THAT( 3.625, WithinRel( linear.ratios()[14] ) );
        CHECK_THAT( 3.75 , WithinRel( linear.ratios()[15] ) );
        CHECK_THAT( 3.875, WithinRel( linear.ratios()[16] ) );
        CHECK_THAT( 4.   , WithinRel( linear.ratios()[17] ) );
  ...
  GIVEN( "non-linearised data with multiple regions with a jump" ) {
    ...
    WHEN( "the data is given explicitly" ) {
      ...
      THEN( "a TabulatedWaveFunction can be linearised" ) {
        ...
        CHECK_THAT( 2.   , WithinRel( linear.ratios()[1] ) );
        CHECK_THAT( 2.   , WithinRel( linear.ratios()[2] ) );
        CHECK_THAT( 2.125, WithinRel( linear.ratios()[3] ) );
        CHECK_THAT( 2.25 , WithinRel( linear.ratios()[4] ) );
        CHECK_THAT( 2.5  , WithinRel( linear.ratios()[5] ) );
        CHECK_THAT( 2.75 , WithinRel( linear.ratios()[6] ) );
        CHECK_THAT( 3.   , WithinRel( linear.ratios()[7] ) );
        CHECK_THAT( 3.25 , WithinRel( linear.ratios()[8] ) );
        CHECK_THAT( 3.5  , WithinRel( linear.ratios()[9] ) );
        CHECK_THAT( 3.75 , WithinRel( linear.ratios()[10] ) );
        CHECK_THAT( 4.   , WithinRel( linear.ratios()[11] ) );
  ...
  GIVEN( "non-linearised data with multiple regions with a jump that consist of "
    ...
    WHEN( "the data is given explicitly" ) {
      ...
      TabulatedWaveFunction chunk( std::move( x ), std::move( y ),
                                   std::move( boundaries ),
                                   std::move( interpolants ) );
  ...
  GIVEN( "non-linearised data with multiple regions with a jump and boundaries "
    ...
    //       the jump. As a result, the final data contained in this TabulatedWaveFunction is the
  ...
  GIVEN( "non-linearised data with multiple regions with a jump at the end" ) {
    ...
    WHEN( "the data is given explicitly" ) {
      ...
      THEN( "an TabulatedWaveFunction can be constructed and members can be tested" ) {
        ...
        CHECK_THAT( 2., WithinRel( chunk.ratios()[1] ) );
        CHECK_THAT( 3., WithinRel( chunk.ratios()[2] ) );
        CHECK_THAT( 4., WithinRel( chunk.ratios()[3] ) ); // <-- last point removed
        CHECK_THAT( 4., WithinRel( chunk.values()[0] ) );
        CHECK_THAT( 3., WithinRel( chunk.values()[1] ) );
        CHECK_THAT( 2., WithinRel( chunk.values()[2] ) );
  ...
  GIVEN( "non-linearised data with multiple regions with a jump at the beginning" ) {
    ...
    WHEN( "the data is given explicitly" ) {
      ...
      THEN( "an TabulatedWaveFunction can be constructed and members can be tested" ) {
        ...
        CHECK( 2 == chunk.boundaries().size() );
        CHECK( 2 == chunk.interpolants().size() );
        CHECK_THAT( 1., WithinRel( chunk.ratios()[0] ) ); // <-- first point removed
        CHECK_THAT( 2., WithinRel( chunk.ratios()[1] ) );
        CHECK_THAT( 3., WithinRel( chunk.ratios()[2] ) );
        CHECK_THAT( 4., WithinRel( chunk.ratios()[3] ) );
  ...
  GIVEN( "comparison operators" ) {
    ...
    WHEN( "two instances of TabulatedWaveFunction are given" ) {

      TabulatedWaveFunction left( { 1., 2., 3., 4. }, { 4., 3., 2., 1. } );
      TabulatedWaveFunction equal( { 1., 2., 3., 4. }, { 4., 3., 2., 1. } );
      TabulatedWaveFunction different( { 1., 4. }, { 4., 1. } );
  ...
  GIVEN( "invalid data for an TabulatedWaveFunction object" ) {
    ...
    WHEN( "there are not enough values in the x or y grid" ) {
      ...
      THEN( "an exception is thrown" ) {
        ...
        CHECK_THROWS( TabulatedWaveFunction( empty, empty ) );
        CHECK_THROWS( TabulatedWaveFunction( one, one ) );
      } // THEN
    } // WHEN
    ...
    WHEN( "the x and y grid do not have the same number of points" ) {
      ...
      THEN( "an exception is thrown" ) {
        ...
        CHECK_THROWS( TabulatedWaveFunction( std::move( x ), std::move( y ) ) );
      } // THEN
    } // WHEN
