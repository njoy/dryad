...
SCENARIO( "TabulatedLevelSpacing" ) {
  ...
  GIVEN( "linearised data without boundaries and no jumps" ) {
    ...
    WHEN( "the data is given explicitly" ) {
      ...
      TabulatedLevelSpacing chunk( std::move( energies ), std::move( values ) );

      THEN( "a TabulatedLevelSpacing can be constructed and members can be tested" ) {
      ...
      THEN( "a TabulatedLevelSpacing can be evaluated" ) {
      ...
      THEN( "arithmetic operations can be performed" ) {
        ...
        TabulatedLevelSpacing result( { 1., 4. }, { 0., 0. } );
        TabulatedLevelSpacing same( { 1., 4. }, { 0., 3. } );
        TabulatedLevelSpacing threshold( { 2., 4. }, { 0., 2. } );
        TabulatedLevelSpacing nonzerothreshold( { 2., 4. }, { 1., 3. } );
        TabulatedLevelSpacing small( { 1., 3. }, { 0., 2. } );
      ...
      THEN( "a TabulatedLevelSpacing can be linearised" ) {

        TabulatedLevelSpacing linear = chunk.linearise();
  ...
  GIVEN( "linearised data without boundaries and a jump" ) {
    ...
    WHEN( "the data is given explicitly" ) {
      ...
      THEN( "arithmetic operations can be performed" ) {
        ...
        TabulatedLevelSpacing same( { 1., 4. }, { 0., 3. } );
        TabulatedLevelSpacing threshold( { 2., 4. }, { 0., 2. } );
        TabulatedLevelSpacing nonzerothreshold( { 3., 4. }, { 1., 2. } );
        TabulatedLevelSpacing small( { 1., 3. }, { 0., 2. } );
  ...
  GIVEN( "non-linearised data with multiple regions without a jump" ) {
    ...
    WHEN( "the data is given explicitly" ) {
      ...
      TabulatedLevelSpacing chunk( std::move( energies ),
                                   std::move( values ),
                                   std::move( boundaries ),
      ...
      THEN( "some arithmetic operations cannot be performed" ) {
        ...
        TabulatedLevelSpacing result( { 1., 4. }, { 0., 0. } );
        TabulatedLevelSpacing right( { 1., 4. }, { 0., 0. } );
  ...
  GIVEN( "non-linearised data with multiple regions with a jump that consist of "
    ...
    WHEN( "the data is given explicitly" ) {
      ...
      TabulatedLevelSpacing chunk( std::move( x ), std::move( y ),
                                   std::move( boundaries ),
                                   std::move( interpolants ) );
  ...
  GIVEN( "non-linearised data with multiple regions with a jump and boundaries "
    ...
    //       the jump. As a result, the final data contained in this TabulatedLevelSpacing is the
  ...
  GIVEN( "non-linearised data with multiple regions with a jump at the end" ) {
    ...
    WHEN( "the data is given explicitly" ) {
      ...
      THEN( "an TabulatedLevelSpacing can be constructed and members can be tested" ) {
  ...
  GIVEN( "comparison operators" ) {
    ...
    WHEN( "two instances of TabulatedLevelSpacing are given" ) {

      TabulatedLevelSpacing left( { 1., 2., 3., 4. }, { 4., 3., 2., 1. } );
      TabulatedLevelSpacing equal( { 1., 2., 3., 4. }, { 4., 3., 2., 1. } );
      TabulatedLevelSpacing different( { 1., 4. }, { 4., 1. } );
  ...
  GIVEN( "invalid data for an TabulatedLevelSpacing object" ) {
    ...
    WHEN( "there are not enough values in the x or y grid" ) {
      ...
      THEN( "an exception is thrown" ) {
        ...
        CHECK_THROWS( TabulatedLevelSpacing( empty, empty ) );
        CHECK_THROWS( TabulatedLevelSpacing( one, one ) );
      } // THEN
    } // WHEN
    ...
    WHEN( "the x and y grid do not have the same number of points" ) {
      ...
      THEN( "an exception is thrown" ) {
        ...
        CHECK_THROWS( TabulatedLevelSpacing( std::move( x ), std::move( y ) ) );
      } // THEN
    } // WHEN
