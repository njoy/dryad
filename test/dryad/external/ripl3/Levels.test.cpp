  ...
  GIVEN( "the Levels static repository" ) {
    ...
    THEN( "predefined particles can be retrieved" ) {
      ...
      if ( std::getenv( "NJOY_DATAPATH" ) ) {
        ...
        auto data = Levels::level( id::ParticleID( "H1" ) );
        ...
        data = Levels::level( id::ParticleID( "He4" ) );
        ...
        data = Levels::level( id::ParticleID( "Li6" ) );
        ...
        data = Levels::level( id::ParticleID( "Be9" ) );
        ...
        data = Levels::level( id::ParticleID( "B10" ) );
        ...
        data = Levels::level( id::ParticleID( "C12" ) );
        ...
        data = Levels::level( id::ParticleID( "N14" ) );
        ...
        data = Levels::level( id::ParticleID( "O16" ) );
        ...
        data = Levels::level( id::ParticleID( "F19" ) );
        CHECK(   2602 == Levels::size() );

        data = Levels::level( id::ParticleID( "Ne20" ) );
        CHECK(   3364 == Levels::size() );

        data = Levels::level( id::ParticleID( "Na23" ) );
        CHECK(   4229 == Levels::size() );

        data = Levels::level( id::ParticleID( "Mg24" ) );
        CHECK(   5176 == Levels::size() );

        data = Levels::level( id::ParticleID( "Al27" ) );
        CHECK(   6041 == Levels::size() );

        data = Levels::level( id::ParticleID( "Si28" ) );
        CHECK(   7043 == Levels::size() );

        data = Levels::level( id::ParticleID( "P31" ) );
        CHECK(   8138 == Levels::size() );

        data = Levels::level( id::ParticleID( "S32" ) );
        CHECK(   9609 == Levels::size() );

        data = Levels::level( id::ParticleID( "Cl35" ) );
        CHECK(  11430 == Levels::size() );

        data = Levels::level( id::ParticleID( "Ar36" ) );
        CHECK(  13136 == Levels::size() );

        data = Levels::level( id::ParticleID( "K39" ) );
        CHECK(  14495 == Levels::size() );

        data = Levels::level( id::ParticleID( "Ca40" ) );
        CHECK(  17476 == Levels::size() );

        data = Levels::level( id::ParticleID( "Sc45" ) );
        CHECK(  19711 == Levels::size() );

        data = Levels::level( id::ParticleID( "Ti46" ) );
        CHECK(  21261 == Levels::size() );

        data = Levels::level( id::ParticleID( "V50" ) );
        CHECK(  22962 == Levels::size() );

        data = Levels::level( id::ParticleID( "Cr50" ) );
        CHECK(  24572 == Levels::size() );

        data = Levels::level( id::ParticleID( "Mn55" ) );
        CHECK(  26373 == Levels::size() );

        data = Levels::level( id::ParticleID( "Fe54" ) );
        CHECK(  28138 == Levels::size() );

        data = Levels::level( id::ParticleID( "Co59" ) );
        CHECK(  30208 == Levels::size() );

        data = Levels::level( id::ParticleID( "Ni58" ) );
        CHECK(  33080 == Levels::size() );

        data = Levels::level( id::ParticleID( "Cu63" ) );
        CHECK(  35578 == Levels::size() );

        data = Levels::level( id::ParticleID( "Zn64" ) );
        CHECK(  37376 == Levels::size() );

        data = Levels::level( id::ParticleID( "Ga69" ) );
        CHECK(  38720 == Levels::size() );

        data = Levels::level( id::ParticleID( "Ge70" ) );
        CHECK(  40751 == Levels::size() );

        data = Levels::level( id::ParticleID( "As75" ) );
        CHECK(  42108 == Levels::size() );

        data = Levels::level( id::ParticleID( "Se74" ) );
        CHECK(  43779 == Levels::size() );

        data = Levels::level( id::ParticleID( "Br79" ) );
        CHECK(  45321 == Levels::size() );

        data = Levels::level( id::ParticleID( "Kr78" ) );
        CHECK(  47369 == Levels::size() );

        data = Levels::level( id::ParticleID( "Rb85" ) );
        CHECK(  48958 == Levels::size() );

        data = Levels::level( id::ParticleID( "Sr84" ) );
        CHECK(  51252 == Levels::size() );

        data = Levels::level( id::ParticleID( "Y89" ) );
        CHECK(  53237 == Levels::size() );

        data = Levels::level( id::ParticleID( "Zr90" ) );
        CHECK(  55638 == Levels::size() );

        data = Levels::level( id::ParticleID( "Nb93" ) );
        CHECK(  57390 == Levels::size() );

        data = Levels::level( id::ParticleID( "Mo92" ) );
        CHECK(  60225 == Levels::size() );

        data = Levels::level( id::ParticleID( "Tc99" ) );
        CHECK(  61923 == Levels::size() );

        data = Levels::level( id::ParticleID( "Ru96" ) );
        CHECK(  64028 == Levels::size() );

        data = Levels::level( id::ParticleID( "Rh103" ) );
        CHECK(  65843 == Levels::size() );

        data = Levels::level( id::ParticleID( "Pd102" ) );
        CHECK(  68066 == Levels::size() );

        data = Levels::level( id::ParticleID( "Ag107" ) );
        CHECK(  69629 == Levels::size() );

        data = Levels::level( id::ParticleID( "Cd106" ) );
        CHECK(  72785 == Levels::size() );

        data = Levels::level( id::ParticleID( "In113" ) );
        CHECK(  74813 == Levels::size() );

        data = Levels::level( id::ParticleID( "Sn112" ) );
        CHECK(  78060 == Levels::size() );

        data = Levels::level( id::ParticleID( "Sb121" ) );
        CHECK(  80520 == Levels::size() );

        data = Levels::level( id::ParticleID( "Te120" ) );
        CHECK(  84538 == Levels::size() );

        data = Levels::level( id::ParticleID( "I127" ) );
        CHECK(  87108 == Levels::size() );

        data = Levels::level( id::ParticleID( "Xe124" ) );
        CHECK(  90505 == Levels::size() );

        data = Levels::level( id::ParticleID( "Cs133" ) );
        CHECK(  92217 == Levels::size() );

        data = Levels::level( id::ParticleID( "Ba130" ) );
        CHECK(  95343 == Levels::size() );

        data = Levels::level( id::ParticleID( "La138" ) );
        CHECK(  97715 == Levels::size() );

        data = Levels::level( id::ParticleID( "Ce136" ) );
        CHECK( 100235 == Levels::size() );

        data = Levels::level( id::ParticleID( "Pr141" ) );
        CHECK( 102039 == Levels::size() );

        data = Levels::level( id::ParticleID( "Nd142" ) );
        CHECK( 105887 == Levels::size() );

        data = Levels::level( id::ParticleID( "Pm138" ) );
        CHECK( 107555 == Levels::size() );

        data = Levels::level( id::ParticleID( "Sm144" ) );
        CHECK( 110768 == Levels::size() );

        data = Levels::level( id::ParticleID( "Eu151" ) );
        CHECK( 112957 == Levels::size() );

        data = Levels::level( id::ParticleID( "Gd152" ) );
        CHECK( 116885 == Levels::size() );

        data = Levels::level( id::ParticleID( "Tb159" ) );
        CHECK( 118884 == Levels::size() );

        data = Levels::level( id::ParticleID( "Dy156" ) );
        CHECK( 122679 == Levels::size() );

        data = Levels::level( id::ParticleID( "Ho165" ) );
        CHECK( 124989 == Levels::size() );

        data = Levels::level( id::ParticleID( "Er162" ) );
        CHECK( 128473 == Levels::size() );

        data = Levels::level( id::ParticleID( "Tm169" ) );
        CHECK( 130861 == Levels::size() );

        data = Levels::level( id::ParticleID( "Yb168" ) );
        CHECK( 133796 == Levels::size() );

        data = Levels::level( id::ParticleID( "Lu175" ) );
        CHECK( 135947 == Levels::size() );

        data = Levels::level( id::ParticleID( "Hf174" ) );
        CHECK( 139416 == Levels::size() );

        data = Levels::level( id::ParticleID( "Ta180" ) );
        CHECK( 141726 == Levels::size() );

        data = Levels::level( id::ParticleID( "W180" ) );
        CHECK( 144837 == Levels::size() );

        data = Levels::level( id::ParticleID( "Re185" ) );
        CHECK( 147171 == Levels::size() );

        data = Levels::level( id::ParticleID( "Os184" ) );
        CHECK( 150318 == Levels::size() );

        data = Levels::level( id::ParticleID( "Ir191" ) );
        CHECK( 152373 == Levels::size() );

        data = Levels::level( id::ParticleID( "Pt190" ) );
        CHECK( 154972 == Levels::size() );

        data = Levels::level( id::ParticleID( "Au197" ) );
        CHECK( 157048 == Levels::size() );

        data = Levels::level( id::ParticleID( "Hg196" ) );
        CHECK( 159418 == Levels::size() );

        data = Levels::level( id::ParticleID( "Tl203" ) );
        CHECK( 160916 == Levels::size() );

        data = Levels::level( id::ParticleID( "Pb204" ) );
        CHECK( 164602 == Levels::size() );

        data = Levels::level( id::ParticleID( "Bi209" ) );
        CHECK( 166142 == Levels::size() );

        data = Levels::level( id::ParticleID( "Po210" ) );
        CHECK( 167353 == Levels::size() );

        data = Levels::level( id::ParticleID( "At210" ) );
        CHECK( 168086 == Levels::size() );

        data = Levels::level( id::ParticleID( "Rn222" ) );
        CHECK( 168815 == Levels::size() );

        data = Levels::level( id::ParticleID( "Fr223" ) );
        CHECK( 169480 == Levels::size() );

        data = Levels::level( id::ParticleID( "Ra226" ) );
        CHECK( 170437 == Levels::size() );

        data = Levels::level( id::ParticleID( "Ac227" ) );
        CHECK( 170886 == Levels::size() );

        data = Levels::level( id::ParticleID( "Th232" ) );
        CHECK( 172261 == Levels::size() );

        data = Levels::level( id::ParticleID( "Pa231" ) );
        CHECK( 172693 == Levels::size() );

        data = Levels::level( id::ParticleID(  "U238" ) );
        CHECK( 174093 == Levels::size() );

        data = Levels::level( id::ParticleID( "Np237" ) );
        CHECK( 174542 == Levels::size() );

        data = Levels::level( id::ParticleID( "Pu238" ) );
        CHECK( 175284 == Levels::size() );

        data = Levels::level( id::ParticleID( "Am242" ) );
        CHECK( 175803 == Levels::size() );

        data = Levels::level( id::ParticleID( "Cm246" ) );
        CHECK( 176256 == Levels::size() );

        data = Levels::level( id::ParticleID( "Bk239" ) );
        CHECK( 176462 == Levels::size() );

        data = Levels::level( id::ParticleID( "Cf255" ) );
        CHECK( 176764 == Levels::size() );

        data = Levels::level( id::ParticleID( "Es244" ) );
        CHECK( 176842 == Levels::size() );

        data = Levels::level( id::ParticleID( "Fm248" ) );
        CHECK( 176935 == Levels::size() );

        data = Levels::level( id::ParticleID( "Md252" ) );
        CHECK( 176991 == Levels::size() );

        data = Levels::level( id::ParticleID( "No251" ) );
        CHECK( 177101 == Levels::size() );

        data = Levels::level( id::ParticleID( "Lr255" ) );
        CHECK( 177156 == Levels::size() );

        data = Levels::level( id::ParticleID( "Rf256" ) );
        CHECK( 177208 == Levels::size() );

        data = Levels::level( id::ParticleID( "Db258" ) );
        CHECK( 177236 == Levels::size() );

        data = Levels::level( id::ParticleID( "Sg261" ) );
        CHECK( 177259 == Levels::size() );

        data = Levels::level( id::ParticleID( "Bh272" ) );
        CHECK( 177286 == Levels::size() );

        data = Levels::level( id::ParticleID( "Hs266" ) );
        CHECK( 177312 == Levels::size() );

        data = Levels::level( id::ParticleID( "Mt276" ) );
        CHECK( 177335 == Levels::size() );

        data = Levels::level( id::ParticleID( "Ds279" ) );
        CHECK( 177359 == Levels::size() );

        data = Levels::level( id::ParticleID( "Rg275" ) );
        CHECK( 177374 == Levels::size() );

        data = Levels::level( id::ParticleID( "Cn280" ) );
        CHECK( 177387 == Levels::size() );

        data = Levels::level( id::ParticleID( "Nh285" ) );
        CHECK( 177401 == Levels::size() );

        data = Levels::level( id::ParticleID( "Fl290" ) );
        CHECK( 177409 == Levels::size() );

        data = Levels::level( id::ParticleID( "Mc290" ) );
        CHECK( 177415 == Levels::size() );

        data = Levels::level( id::ParticleID( "Lv290" ) );
        CHECK( 177420 == Levels::size() );

        data = Levels::level( id::ParticleID( "Ts292" ) );
        CHECK( 177424 == Levels::size() );

        data = Levels::level( id::ParticleID( "Og294" ) );
