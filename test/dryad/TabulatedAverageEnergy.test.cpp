...
SCENARIO( "TabulatedAverageEnergy" ) {
  ...
  GIVEN( "non-linearised data with multiple regions with a jump and boundaries "
    ...
    //       the jump. As a result, the final data contained in this TabulatedAverageEnergy is the
  ...
  GIVEN( "non-linearised data with multiple regions with a jump at the end" ) {
    ...
    WHEN( "the data is given explicitly" ) {
      ...
      THEN( "an TabulatedAverageEnergy can be constructed and members can be tested" ) {
  ...
  GIVEN( "comparison operators" ) {
    ...
    WHEN( "two instances of TabulatedAverageEnergy are given" ) {
