...
SCENARIO( "TabulatedComptonProfileFunction" ) {
  ...
  GIVEN( "linearised data without boundaries and no jumps" ) {
    ...
    WHEN( "the data is given explicitly" ) {
      ...
      THEN( "a TabulatedComptonProfileFunction can be constructed and members can be tested" ) {
        ...
        CHECK_THAT(  0.  , WithinRel( chunk.momentum()[1] ) );
        CHECK_THAT(  0.5 , WithinRel( chunk.momentum()[2] ) );
        CHECK_THAT(  1.  , WithinRel( chunk.momentum()[3] ) );
      ...
      THEN( "arithmetic operations can be performed" ) {
        ...
        CHECK_THAT(  0.  , WithinRel( result.momentum()[1] ) );
        CHECK_THAT(  0.5 , WithinRel( result.momentum()[2] ) );
        CHECK_THAT(  1.  , WithinRel( result.momentum()[3] ) );
        ...
        CHECK_THAT( -1.  , WithinRel( chunk.momentum()[0] ) );
        CHECK_THAT(  0.  , WithinRel( chunk.momentum()[1] ) );
        CHECK_THAT(  0.  , WithinRel( chunk.momentum()[2] ) );
        CHECK_THAT(  0.5 , WithinRel( chunk.momentum()[3] ) );
        ...
        CHECK_THAT( -1.  , WithinRel( result.momentum()[0] ) );
        CHECK_THAT(  0.  , WithinRel( result.momentum()[1] ) );
        CHECK_THAT(  0.  , WithinRel( result.momentum()[2] ) );
        CHECK_THAT(  0.5 , WithinRel( result.momentum()[3] ) );
        CHECK_THAT(  1.  , WithinRel( result.momentum()[4] ) );
        CHECK_THAT(  0.  , WithinRel( result.values()[0] ) );
        CHECK_THAT(  0.5 , WithinRel( result.values()[1] ) );
        CHECK_THAT(  1.5 , WithinRel( result.values()[2] ) );
  ...
  GIVEN( "linearised data without boundaries and a jump" ) {
    ...
    WHEN( "the data is given explicitly" ) {
      ...
      const std::vector< double > momentum = { -1., 0., 0., 0.5, 1. };
      ...
      THEN( "arithmetic operations can be performed" ) {
        ...
        CHECK_THAT(  0. , WithinRel( chunk.momentum()[2] ) );
        CHECK_THAT(  0.5, WithinRel( chunk.momentum()[3] ) );
        CHECK_THAT(  0.5, WithinRel( chunk.momentum()[4] ) );
        CHECK_THAT(  1. , WithinRel( chunk.momentum()[5] ) );
        CHECK_THAT(  4. , WithinRel( chunk.values()[0] ) );
        CHECK_THAT(  3. , WithinRel( chunk.values()[1] ) );
        CHECK_THAT(  4. , WithinRel( chunk.values()[2] ) );
        CHECK_THAT(  3. , WithinRel( chunk.values()[3] ) );
        ...
        CHECK_THAT(  0. , WithinRel( result.momentum()[2] ) );
        CHECK_THAT(  0.5, WithinRel( result.momentum()[3] ) );
        CHECK_THAT(  0.5, WithinRel( result.momentum()[4] ) );
        CHECK_THAT(  1. , WithinRel( result.momentum()[5] ) );
        CHECK_THAT(  4. , WithinRel( result.values()[0] ) );
        CHECK_THAT(  3. , WithinRel( result.values()[1] ) );
        CHECK_THAT(  4. , WithinRel( result.values()[2] ) );
        CHECK_THAT(  3. , WithinRel( result.values()[3] ) );
      ...
      THEN( "a TabulatedComptonProfileFunction can be linearised" ) {
        ...
        CHECK_THAT(  0. , WithinRel( linear.momentum()[1] ) );
        CHECK_THAT(  0. , WithinRel( linear.momentum()[2] ) );
        CHECK_THAT(  0.5, WithinRel( linear.momentum()[3] ) );
        CHECK_THAT(  1. , WithinRel( linear.momentum()[4] ) );
  ...
  GIVEN( "non-linearised data with multiple regions without a jump" ) {
    ...
    WHEN( "the data is given explicitly" ) {
      ...
      THEN( "a TabulatedComptonProfileFunction can be linearised" ) {
        ...
        CHECK_THAT( -1.    , WithinRel( linear.momentum()[0] ) );
        CHECK_THAT(  0.    , WithinRel( linear.momentum()[1] ) );
        CHECK_THAT(  0.0625, WithinRel( linear.momentum()[2] ) );
        CHECK_THAT(  0.125 , WithinRel( linear.momentum()[3] ) );
        CHECK_THAT(  0.1875, WithinRel( linear.momentum()[4] ) );
        CHECK_THAT(  0.25  , WithinRel( linear.momentum()[5] ) );
        CHECK_THAT(  0.3125, WithinRel( linear.momentum()[6] ) );
        CHECK_THAT(  0.375 , WithinRel( linear.momentum()[7] ) );
        CHECK_THAT(  0.4375, WithinRel( linear.momentum()[8] ) );
        CHECK_THAT(  0.5   , WithinRel( linear.momentum()[9] ) );
        CHECK_THAT(  0.625 , WithinRel( linear.momentum()[10] ) );
        CHECK_THAT(  0.75  , WithinRel( linear.momentum()[11] ) );
        CHECK_THAT(  0.875 , WithinRel( linear.momentum()[12] ) );
        CHECK_THAT(  1.    , WithinRel( linear.momentum()[13] ) );
  ...
  GIVEN( "non-linearised data with multiple regions with a jump" ) {
    ...
    WHEN( "the data is given explicitly" ) {
      ...
      THEN( "a TabulatedComptonProfileFunction can be linearised" ) {
        ...
        CHECK_THAT(  0.   , WithinRel( linear.momentum()[2] ) );
        CHECK_THAT(  0.125, WithinRel( linear.momentum()[3] ) );
        CHECK_THAT(  0.25 , WithinRel( linear.momentum()[4] ) );
        CHECK_THAT(  0.375, WithinRel( linear.momentum()[5] ) );
        CHECK_THAT(  0.5  , WithinRel( linear.momentum()[6] ) );
        CHECK_THAT(  0.625, WithinRel( linear.momentum()[7] ) );
        CHECK_THAT(  0.75 , WithinRel( linear.momentum()[8] ) );
        CHECK_THAT(  0.875, WithinRel( linear.momentum()[9] ) );
        CHECK_THAT(  1.   , WithinRel( linear.momentum()[10] ) );
  ...
  GIVEN( "non-linearised data with multiple regions with a jump at the end that goes to zero" ) {
    ...
    WHEN( "the data is given explicitly" ) {
      ...
      THEN( "an TabulatedComptonProfileFunction can be constructed and members can be tested" ) {
        ...
        CHECK_THAT(  0.  , WithinRel( chunk.momentum()[1] ) );
        CHECK_THAT(  0.5 , WithinRel( chunk.momentum()[2] ) );
        CHECK_THAT(  1.  , WithinRel( chunk.momentum()[3] ) ); // <-- last point removed
        CHECK_THAT(  0.  , WithinRel( chunk.values()[0] ) );
        CHECK_THAT(  0.5 , WithinRel( chunk.values()[1] ) );
        CHECK_THAT(  0.75, WithinRel( chunk.values()[2] ) );
